...
var _sfc_main$23 = {
	...
	setup(__props) {
		...
		const mainClass = computed(() => {
			if (page.component === "Home" || page.component === "Profile/Show" || page.component === "Profile/Edit" || page.component === "Chat/Chats" || page.component === "Posts/Show" || page.component === "Admin/Index" || page.component === "Admin/Comments" || page.component === "Admin/Posts" || page.component === "Admin/Users" || page.component === "Profile/LikedPosts" || page.component === "Auth/Auth.vue" || page.component === "Settings/Index" || page.component === "Settings/Notifications" || page.component === "Balance/Index" || page.component === "Posts/Create" || page.component === "Disputes/Index" || page.component === "Disputes/Show") return "main-home";
			return "main-padded";
		});
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<div${ssrRenderAttrs(_attrs)} data-v-2e1d1e10><header class="${ssrRenderClass(headerClass.value)}" data-v-2e1d1e10>`);
			_push(ssrRenderComponent(unref(Link), {
				class: "logo",
				href: "/"
			}, {
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<p class="l1" data-v-2e1d1e10${_scopeId}>vis</p><p class="l2" data-v-2e1d1e10${_scopeId}>ket</p>`);
					else return [createVNode("p", { class: "l1" }, "vis"), createVNode("p", { class: "l2" }, "ket")];
				}),
				_: 1
			}, _parent));
			if (authUser.value) {
				_push(`<div class="menu-trigger" data-v-2e1d1e10>`);
				if (authUser.value.avatar && authUser.value.avatar.startsWith("http")) _push(`<img${ssrRenderAttr("src", authUser.value.avatar)} alt="avatar" class="header-avatar" data-v-2e1d1e10>`);
				else if (authUser.value.avatar) _push(`<img${ssrRenderAttr("src", "/storage/" + authUser.value.avatar)} alt="avatar" class="header-avatar" data-v-2e1d1e10>`);
				else _push(`<img src="/images/User-avatar.png" alt="avatar" class="header-avatar" data-v-2e1d1e10>`);
				_push(`<img class="burger-menu" src="/images/burger.svg" alt="burger-menu" data-v-2e1d1e10><div class="${ssrRenderClass([{ "dropdown-open": menuOpen.value }, "dropdown-menu"])}" data-v-2e1d1e10>`);
				if (authUser.value.is_admin) _push(ssrRenderComponent(unref(Link), {
					href: "/admin",
					onClick: closeMenu
				}, {
					default: withCtx((_, _push, _parent, _scopeId) => {
						if (_push) _push(`<img src="/images/database.svg" alt="" class="menu-icon" data-v-2e1d1e10${_scopeId}> Админ панель `);
				...
				_push(ssrRenderComponent(unref(Link), {
					...
					default: withCtx((_, _push, _parent, _scopeId) => {
						if (_push) {
							_push(`<img src="/images/speech-bubble.svg" alt="" class="menu-icon" data-v-2e1d1e10${_scopeId}> Чаты `);
							if (authUser.value.unreadChatsCount) _push(`<span class="counter-badge" data-v-2e1d1e10${_scopeId}>${ssrInterpolate(authUser.value.unreadChatsCount)}</span>`);
							else _push(`<!---->`);
						} else return [
							createVNode("img", {
				...
				_push(ssrRenderComponent(unref(Link), {
					...
					default: withCtx((_, _push, _parent, _scopeId) => {
						if (_push) _push(`<img src="/images/person.svg" alt="" class="menu-icon" data-v-2e1d1e10${_scopeId}> Профиль `);
						else return [createVNode("img", {
				...
				_push(ssrRenderComponent(unref(Link), {
					...
					default: withCtx((_, _push, _parent, _scopeId) => {
						if (_push) {
							_push(`<img src="/images/wallet.svg" alt="" class="menu-icon" data-v-2e1d1e10${_scopeId}> Баланс: ${ssrInterpolate(authUser.value.balance)} ₽ `);
							if (authUser.value.hasPendingTransactions) _push(`<span class="pending-badge" data-v-2e1d1e10${_scopeId}>Ожидание...</span>`);
							else _push(`<!---->`);
						} else return [
							createVNode("img", {
				...
				_push(ssrRenderComponent(unref(Link), {
					...
					default: withCtx((_, _push, _parent, _scopeId) => {
						if (_push) {
							_push(`<img src="/images/bell.svg" alt="" class="menu-icon" data-v-2e1d1e10${_scopeId}> Уведомления `);
							if (authUser.value.unreadNotificationsCount) _push(`<span class="counter-badge" data-v-2e1d1e10${_scopeId}>${ssrInterpolate(authUser.value.unreadNotificationsCount)}</span>`);
							else _push(`<!---->`);
						} else return [
							createVNode("img", {
								src: "/images/bell.svg",
				...
				_push(ssrRenderComponent(unref(Link), {
					...
					default: withCtx((_, _push, _parent, _scopeId) => {
						if (_push) _push(`<img src="/images/settings.svg" alt="" class="menu-icon" data-v-2e1d1e10${_scopeId}> Настройки `);
						else return [createVNode("img", {
				...
				_push(`<button type="button" data-v-2e1d1e10><img src="/images/exit.svg" alt="" class="menu-icon" data-v-2e1d1e10> Выйти </button></div></div>`);
			...
			_push(`</header><div class="${ssrRenderClass([{ "overlay-active": menuOpen.value }, "overlay overlay-active-mobile"])}" data-v-2e1d1e10></div><div class="${ssrRenderClass([{ "mobile-menu-open": menuOpen.value }, "mobile-menu"])}" data-v-2e1d1e10><button class="mobile-menu-close" data-v-2e1d1e10>✕</button>`);
			if (authUser.value) {
				_push(`<!--[-->`);
				if (authUser.value.is_admin) _push(ssrRenderComponent(unref(Link), {
					href: "/admin",
				...
				_push(`<div class="mobile-menu-footer" data-v-2e1d1e10><button type="button" data-v-2e1d1e10>Выйти</button></div><!--]-->`);
			} else _push(ssrRenderComponent(unref(Link), {
				href: "/login",
				onClick: closeMenu
			}, {
			...
			_push(`</div><main class="${ssrRenderClass(mainClass.value)}" data-v-2e1d1e10>`);
			ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
			_push(`</main><footer class="${ssrRenderClass(footerClass.value)}" data-v-2e1d1e10><div data-v-2e1d1e10><a data-v-2e1d1e10>Адрес компании</a><a data-v-2e1d1e10>Телефонный номер</a><a data-v-2e1d1e10>Электронная почта</a></div><div data-v-2e1d1e10><a data-v-2e1d1e10>О нас</a><a data-v-2e1d1e10>Услуги или продукты</a><a data-v-2e1d1e10>Часто задаваемые вопросы (FAQ)</a></div><div data-v-2e1d1e10><a data-v-2e1d1e10>Политика конфиденциальности</a><a data-v-2e1d1e10>Условия использования</a><a data-v-2e1d1e10>© 2025 Все права защищены.</a></div></footer></div>`);
		};
	}
};
...
var AppLayout_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$23, [["__scopeId", "data-v-2e1d1e10"]]);
//#endregion
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(ssrRenderComponent(AppLayout_default, _attrs, {
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(ssrRenderComponent(unref(Head), { title: mode.value === "reports" ? "Жалобы на комментарии" : "Управление комментариями" }, null, _parent, _scopeId));
						_push(`<div class="admin-container" data-v-86946b2b${_scopeId}><h1 data-v-86946b2b${_scopeId}>${ssrInterpolate(mode.value === "reports" ? "Жалобы на комментарии" : "Управление комментариями")}</h1><div class="admin-nav" data-v-86946b2b${_scopeId}>`);
						_push(ssrRenderComponent(unref(Link), {
							href: "/admin",
						...
						_push(`</div><div class="search-container" data-v-86946b2b${_scopeId}><input type="text" id="commentSearch"${ssrRenderAttr("value", searchQuery.value)} placeholder="Поиск комментария..." data-v-86946b2b${_scopeId}></div>`);
						if (loading.value) _push(`<div class="loading" data-v-86946b2b${_scopeId}> Загрузка... </div>`);
						else if (error.value) _push(`<div class="error" data-v-86946b2b${_scopeId}>${ssrInterpolate(error.value)}</div>`);
						else {
							_push(`<div class="comments-list" data-v-86946b2b${_scopeId}><!--[-->`);
							ssrRenderList(filteredComments.value, (comment) => {
								_push(`<div class="comment-item" data-v-86946b2b${_scopeId}><div class="comment-info" data-v-86946b2b${_scopeId}><div class="comment-header" data-v-86946b2b${_scopeId}><img${ssrRenderAttr("src", getUserAvatar(comment.user))}${ssrRenderAttr("alt", comment.user?.name)} class="comment-avatar" data-v-86946b2b${_scopeId}><div data-v-86946b2b${_scopeId}><h3 data-v-86946b2b${_scopeId}>${ssrInterpolate(comment.user?.name || "Неизвестный пользователь")}</h3><small data-v-86946b2b${_scopeId}>${ssrInterpolate(formatDate(comment.created_at))}</small></div></div><p data-v-86946b2b${_scopeId}>${ssrInterpolate(comment.text)}</p><small data-v-86946b2b${_scopeId}>К посту: ${ssrInterpolate(comment.post?.title || "Пост удален")}</small>`);
								if (mode.value === "reports" && comment.reports?.length) {
									_push(`<div class="reports-info" data-v-86946b2b${_scopeId}><p class="reports-count" data-v-86946b2b${_scopeId}>Жалоб: ${ssrInterpolate(comment.reports.length)}</p><button class="attempts-toggle" data-v-86946b2b${_scopeId}> Подробнее <span class="${ssrRenderClass([{ open: openReports.value[comment.id] }, "arrow"])}" data-v-86946b2b${_scopeId}>▼</span></button>`);
									if (openReports.value[comment.id]) {
										_push(`<div class="rejections-dropdown" data-v-86946b2b${_scopeId}><!--[-->`);
										ssrRenderList(comment.reports, (report) => {
											_push(`<div class="rejection-item" data-v-86946b2b${_scopeId}><div class="rejection-date" data-v-86946b2b${_scopeId}>${ssrInterpolate(formatReportDate(report.created_at))}</div><div class="rejection-reason" data-v-86946b2b${_scopeId}>${ssrInterpolate(report.reason)}</div><div class="reporter-info" data-v-86946b2b${_scopeId}>От: ${ssrInterpolate(report.reporter?.name || "Неизвестный")}</div></div>`);
										});
										_push(`<!--]--></div>`);
									} else _push(`<!---->`);
									_push(`</div>`);
								} else _push(`<!---->`);
								_push(`</div><div class="comment-actions" data-v-86946b2b${_scopeId}>`);
								...
								if (mode.value === "reports") _push(`<!--[--><button class="btn btn-dismiss"${ssrIncludeBooleanAttr(deleting.value === comment.id) ? " disabled" : ""} data-v-86946b2b${_scopeId}>${ssrInterpolate(deleting.value === comment.id ? "..." : "Игнорировать")}</button><button class="btn btn-danger"${ssrIncludeBooleanAttr(deleting.value === comment.id) ? " disabled" : ""} data-v-86946b2b${_scopeId}> Удалить </button><!--]-->`);
								else _push(`<button class="btn btn-danger"${ssrIncludeBooleanAttr(deleting.value === comment.id) ? " disabled" : ""} data-v-86946b2b${_scopeId}>${ssrInterpolate(deleting.value === comment.id ? "Удаление..." : "Удалить")}</button>`);
								_push(`</div></div>`);
							});
							_push(`<!--]-->`);
							if (filteredComments.value.length === 0) _push(`<div class="no-results" data-v-86946b2b${_scopeId}>${ssrInterpolate(mode.value === "reports" ? "Нет жалоб на комментарии" : "Комментарии не найдены")}</div>`);
							else _push(`<!---->`);
							_push(`</div>`);
						}
						_push(`</div>`);
					} else return [createVNode(unref(Head), { title: mode.value === "reports" ? "Жалобы на комментарии" : "Управление комментариями" }, null, 8, ["title"]), createVNode("div", { class: "admin-container" }, [
...
var Comments_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$22, [["__scopeId", "data-v-86946b2b"]]);
//#endregion
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(ssrRenderComponent(AppLayout_default, _attrs, {
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(ssrRenderComponent(unref(Head), { title: "Админ панель" }, null, _parent, _scopeId));
						_push(`<div class="admin-container" data-v-b156ef62${_scopeId}><h1 data-v-b156ef62${_scopeId}>Админ панель</h1><div class="admin-nav" data-v-b156ef62${_scopeId}>`);
						_push(ssrRenderComponent(unref(Link), {
							href: "/admin",
						...
						_push(ssrRenderComponent(unref(Link), {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) {
									_push(` Споры `);
									if (__props.disputesCount > 0) _push(`<span class="badge" data-v-b156ef62${_scopeId}>${ssrInterpolate(__props.disputesCount)}</span>`);
									else _push(`<!---->`);
						...
						_push(`</div><h2 data-v-b156ef62${_scopeId}>Заявки</h2><div class="banner" data-v-b156ef62${_scopeId}>`);
						_push(ssrRenderComponent(unref(Link), {
							href: "/admin/verification-requests",
							class: "link"
						}, {
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) _push(` Заявки на подтверждение аккаунта <span class="badge" data-v-b156ef62${_scopeId}>${ssrInterpolate(pendingCount.value)}</span>`);
						...
						_push(`</div><h2 data-v-b156ef62${_scopeId}>Репорты</h2><div class="banners" data-v-b156ef62${_scopeId}><div class="banner" data-v-b156ef62${_scopeId}>`);
						_push(ssrRenderComponent(unref(Link), {
							href: `/admin/users?mode=reports`,
							class: "link"
						}, {
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) _push(` Пользователи <span class="badge" data-v-b156ef62${_scopeId}>${ssrInterpolate(__props.usersReportCount)}</span>`);
								else return [createTextVNode(" Пользователи "), createVNode("span", { class: "badge" }, toDisplayString(__props.usersReportCount), 1)];
							}),
							_: 1
						}, _parent, _scopeId));
						_push(`</div><div class="banner" data-v-b156ef62${_scopeId}>`);
						_push(ssrRenderComponent(unref(Link), {
							href: `/admin/posts?mode=reports`,
							class: "link"
						}, {
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) _push(` Посты <span class="badge" data-v-b156ef62${_scopeId}>${ssrInterpolate(__props.postsReportCount)}</span>`);
						...
						_push(ssrRenderComponent(unref(Link), {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) _push(` Комментарии <span class="badge" data-v-b156ef62${_scopeId}>${ssrInterpolate(__props.commentsReportCount)}</span>`);
								else return [createTextVNode(" Комментарии "), createVNode("span", { class: "badge" }, toDisplayString(__props.commentsReportCount), 1)];
							}),
							_: 1
						}, _parent, _scopeId));
						_push(`</div></div></div>`);
					} else return [createVNode(unref(Head), { title: "Админ панель" }), createVNode("div", { class: "admin-container" }, [
...
var Index_default$3 = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$21, [["__scopeId", "data-v-b156ef62"]]);
//#endregion
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(ssrRenderComponent(AppLayout_default, _attrs, {
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(ssrRenderComponent(unref(Head), { title: mode.value === "reports" ? "Жалобы на посты" : "Управление постами" }, null, _parent, _scopeId));
						_push(`<div class="admin-container" data-v-efad09b6${_scopeId}><h1 data-v-efad09b6${_scopeId}>${ssrInterpolate(mode.value === "reports" ? "Жалобы на посты" : "Управление постами")}</h1><div class="admin-nav" data-v-efad09b6${_scopeId}>`);
						_push(ssrRenderComponent(unref(Link), {
							href: "/admin",
							class: "admin-nav-item"
						}, {
						...
						_push(`</div><div class="search-container" data-v-efad09b6${_scopeId}><input type="text" id="postSearch"${ssrRenderAttr("value", searchQuery.value)} placeholder="Поиск поста..." data-v-efad09b6${_scopeId}></div>`);
						if (loading.value) _push(`<div class="loading" data-v-efad09b6${_scopeId}> Загрузка... </div>`);
						else if (error.value) _push(`<div class="error" data-v-efad09b6${_scopeId}>${ssrInterpolate(error.value)}</div>`);
						else {
							_push(`<div class="posts-list" data-v-efad09b6${_scopeId}><!--[-->`);
							ssrRenderList(filteredPosts.value, (post) => {
								_push(`<div class="post-item" data-v-efad09b6${_scopeId}><img${ssrRenderAttr("src", `/storage/${post.image}`)}${ssrRenderAttr("alt", post.title)} class="post-image" data-v-efad09b6${_scopeId}><div class="post-info" data-v-efad09b6${_scopeId}><h3 data-v-efad09b6${_scopeId}>${ssrInterpolate(post.title)}</h3><p data-v-efad09b6${_scopeId}>${ssrInterpolate(post.description)}</p><small data-v-efad09b6${_scopeId}>Автор: ${ssrInterpolate(post.user?.name)}</small>`);
								if (mode.value === "reports" && post.reports?.length) {
									_push(`<div class="reports-info" data-v-efad09b6${_scopeId}><p class="reports-count" data-v-efad09b6${_scopeId}>Жалоб: ${ssrInterpolate(post.reports.length)}</p><button class="attempts-toggle" data-v-efad09b6${_scopeId}> Подробнее <span class="${ssrRenderClass([{ open: openReports.value[post.id] }, "arrow"])}" data-v-efad09b6${_scopeId}>▼</span></button>`);
									if (openReports.value[post.id]) {
										_push(`<div class="rejections-dropdown" data-v-efad09b6${_scopeId}><!--[-->`);
										ssrRenderList(post.reports, (report) => {
											_push(`<div class="rejection-item" data-v-efad09b6${_scopeId}><div class="rejection-date" data-v-efad09b6${_scopeId}>${ssrInterpolate(formatDate(report.created_at))}</div><div class="rejection-reason" data-v-efad09b6${_scopeId}>${ssrInterpolate(report.reason)}</div>`);
											...
											else _push(`<div class="reporter-info" data-v-efad09b6${_scopeId}>От: Неизвестный</div>`);
											_push(`</div>`);
										});
										_push(`<!--]--></div>`);
									} else _push(`<!---->`);
								...
								_push(`</div><div class="post-actions" data-v-efad09b6${_scopeId}>`);
								_push(ssrRenderComponent(unref(Link), {
									href: `/posts/${post.id}`,
									class: "btn"
								}, {
								...
								if (mode.value === "reports") _push(`<!--[--><button class="btn btn-dismiss"${ssrIncludeBooleanAttr(deleting.value === post.id) ? " disabled" : ""} data-v-efad09b6${_scopeId}>${ssrInterpolate(deleting.value === post.id ? "..." : "Игнорировать")}</button><button class="btn btn-warn"${ssrIncludeBooleanAttr(deleting.value === post.id) ? " disabled" : ""} data-v-efad09b6${_scopeId}> Предупреждение </button><button class="btn btn-danger"${ssrIncludeBooleanAttr(deleting.value === post.id) ? " disabled" : ""} data-v-efad09b6${_scopeId}> Скрыть </button><!--]-->`);
								else _push(`<button class="btn btn-danger"${ssrIncludeBooleanAttr(deleting.value === post.id) ? " disabled" : ""} data-v-efad09b6${_scopeId}>${ssrInterpolate(deleting.value === post.id ? "Удаление..." : "Удалить")}</button>`);
								_push(`</div></div>`);
							});
							_push(`<!--]-->`);
							if (filteredPosts.value.length === 0) _push(`<div class="no-results" data-v-efad09b6${_scopeId}>${ssrInterpolate(mode.value === "reports" ? "Нет жалоб на посты" : "Посты не найдены")}</div>`);
							else _push(`<!---->`);
							_push(`</div>`);
						}
						_push(`</div>`);
					} else return [createVNode(unref(Head), { title: mode.value === "reports" ? "Жалобы на посты" : "Управление постами" }, null, 8, ["title"]), createVNode("div", { class: "admin-container" }, [
...
var Posts_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$20, [["__scopeId", "data-v-efad09b6"]]);
//#endregion
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(ssrRenderComponent(AppLayout_default, _attrs, {
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(ssrRenderComponent(unref(Head), { title: getPageTitle() }, null, _parent, _scopeId));
						_push(`<div class="admin-container" data-v-9e7cba8c${_scopeId}><h1 data-v-9e7cba8c${_scopeId}>${ssrInterpolate(getPageTitle())}</h1><div class="admin-nav" data-v-9e7cba8c${_scopeId}>`);
						_push(ssrRenderComponent(unref(Link), {
							href: "/admin",
							class: "admin-nav-item"
						}, {
						...
						_push(`</div><div class="search-container" data-v-9e7cba8c${_scopeId}><input type="text" id="userSearch"${ssrRenderAttr("value", searchQuery.value)} placeholder="Поиск пользователя..." data-v-9e7cba8c${_scopeId}></div>`);
						if (loading.value) _push(`<div class="loading" data-v-9e7cba8c${_scopeId}> Загрузка... </div>`);
						else if (error.value) _push(`<div class="error" data-v-9e7cba8c${_scopeId}>${ssrInterpolate(error.value)}</div>`);
						else {
							_push(`<div class="users-list" data-v-9e7cba8c${_scopeId}><!--[-->`);
							ssrRenderList(filteredUsers.value, (user) => {
								_push(`<div class="user-item" data-v-9e7cba8c${_scopeId}><img${ssrRenderAttr("src", getUserAvatar(user))}${ssrRenderAttr("alt", user.name)} class="user-avatar" data-v-9e7cba8c${_scopeId}><div class="user-info" data-v-9e7cba8c${_scopeId}><h3 data-v-9e7cba8c${_scopeId}>${ssrInterpolate(user.name)}</h3><p data-v-9e7cba8c${_scopeId}>${ssrInterpolate(user.email)}</p>`);
								if (user.phone) _push(`<p class="user-phone" data-v-9e7cba8c${_scopeId}>${ssrInterpolate(user.phone)}</p>`);
								else _push(`<!---->`);
								if (mode.value === "verification") {
									_push(`<div class="verification-info" data-v-9e7cba8c${_scopeId}><button class="attempts-toggle" data-v-9e7cba8c${_scopeId}> Кол-во попыток получить верификацию: ${ssrInterpolate(user.verification_attempts || 0)} <span class="${ssrRenderClass([{ open: openRejections.value[user.id] }, "arrow"])}" data-v-9e7cba8c${_scopeId}>▼</span></button>`);
									if (openRejections.value[user.id] && user.verification_rejections?.length) {
										_push(`<div class="rejections-dropdown" data-v-9e7cba8c${_scopeId}><!--[-->`);
										ssrRenderList(user.verification_rejections, (rejection) => {
											_push(`<div class="rejection-item" data-v-9e7cba8c${_scopeId}><div class="rejection-date" data-v-9e7cba8c${_scopeId}>${ssrInterpolate(formatDate(rejection.rejected_at))}</div><div class="rejection-reason" data-v-9e7cba8c${_scopeId}>${ssrInterpolate(rejection.reason)}</div></div>`);
										});
										_push(`<!--]--></div>`);
									} else if (openRejections.value[user.id]) _push(`<div class="no-rejections" data-v-9e7cba8c${_scopeId}> История отказов пуста </div>`);
									else _push(`<!---->`);
									_push(`</div>`);
								} else _push(`<!---->`);
								if (mode.value === "reports" && user.reports?.length) {
									_push(`<div class="reports-info" data-v-9e7cba8c${_scopeId}><p class="reports-count" data-v-9e7cba8c${_scopeId}>Жалоб: ${ssrInterpolate(user.reports.length)}</p><button class="attempts-toggle" data-v-9e7cba8c${_scopeId}> Подробнее <span class="${ssrRenderClass([{ open: openReports.value[user.id] }, "arrow"])}" data-v-9e7cba8c${_scopeId}>▼</span></button>`);
									if (openReports.value[user.id]) {
										_push(`<div class="rejections-dropdown" data-v-9e7cba8c${_scopeId}><!--[-->`);
										ssrRenderList(user.reports, (report) => {
											_push(`<div class="rejection-item" data-v-9e7cba8c${_scopeId}><div class="rejection-date" data-v-9e7cba8c${_scopeId}>${ssrInterpolate(formatDate(report.created_at))}</div><div class="rejection-reason" data-v-9e7cba8c${_scopeId}>${ssrInterpolate(report.reason)}</div><div class="reporter-info" data-v-9e7cba8c${_scopeId}>От: ${ssrInterpolate(report.reporter?.name || "Неизвестный")}</div></div>`);
										});
										_push(`<!--]--></div>`);
									} else _push(`<!---->`);
									_push(`</div>`);
								} else _push(`<!---->`);
								_push(`</div><div class="user-actions" data-v-9e7cba8c${_scopeId}>`);
								_push(ssrRenderComponent(unref(Link), {
								...
								if (mode.value === "verification") _push(`<!--[--><button class="btn btn-approve"${ssrIncludeBooleanAttr(processingUser.value === user.id) ? " disabled" : ""} data-v-9e7cba8c${_scopeId}>${ssrInterpolate(processingUser.value === user.id ? "..." : "Одобрить")}</button><button class="btn btn-reject"${ssrIncludeBooleanAttr(processingUser.value === user.id) ? " disabled" : ""} data-v-9e7cba8c${_scopeId}> Отказать </button><!--]-->`);
								else if (mode.value === "reports") _push(`<!--[--><button class="btn btn-dismiss"${ssrIncludeBooleanAttr(processingUser.value === user.id) ? " disabled" : ""} data-v-9e7cba8c${_scopeId}>${ssrInterpolate(processingUser.value === user.id ? "..." : "Игнорировать")}</button><button class="btn btn-danger"${ssrIncludeBooleanAttr(processingUser.value === user.id) ? " disabled" : ""} data-v-9e7cba8c${_scopeId}> Заблокировать </button><!--]-->`);
								else _push(`<button class="btn"${ssrIncludeBooleanAttr(sendingMessage.value === user.id) ? " disabled" : ""} data-v-9e7cba8c${_scopeId}>${ssrInterpolate(sendingMessage.value === user.id ? "Отправка..." : "Сообщение")}</button>`);
								_push(`</div></div>`);
							});
							_push(`<!--]-->`);
							if (filteredUsers.value.length === 0) _push(`<div class="no-results" data-v-9e7cba8c${_scopeId}>${ssrInterpolate(mode.value === "verification" ? "Заявок на подтверждение нет" : mode.value === "reports" ? "Нет жалоб на пользователей" : "Пользователи не найдены")}</div>`);
							else _push(`<!---->`);
							_push(`</div>`);
						}
						if (rejectingUserId.value) _push(`<div class="modal-overlay" data-v-9e7cba8c${_scopeId}><div class="modal" data-v-9e7cba8c${_scopeId}><h3 data-v-9e7cba8c${_scopeId}>Укажите причину отказа</h3><textarea placeholder="Причина отказа..." rows="4" data-v-9e7cba8c${_scopeId}>${ssrInterpolate(rejectionReason.value)}</textarea><div class="modal-actions" data-v-9e7cba8c${_scopeId}><button class="btn btn-cancel" data-v-9e7cba8c${_scopeId}>Отмена</button><button class="btn btn-reject"${ssrIncludeBooleanAttr(!rejectionReason.value.trim()) ? " disabled" : ""} data-v-9e7cba8c${_scopeId}> Отправить </button></div></div></div>`);
						else _push(`<!---->`);
						_push(`</div>`);
					} else return [createVNode(unref(Head), { title: getPageTitle() }, null, 8, ["title"]), createVNode("div", { class: "admin-container" }, [
...
var Users_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$19, [["__scopeId", "data-v-9e7cba8c"]]);
//#endregion
...
var _sfc_main$18 = {
	...
	setup(__props, { emit: __emit }) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<div${ssrRenderAttrs(_attrs)} data-v-61534156><div class="form-row" data-v-61534156><div class="form-group" data-v-61534156><div class="multiselect-container" data-v-61534156><div class="multiselect-trigger" data-v-61534156>`);
			if (selectedSkills.value.length === 0) _push(`<span data-v-61534156>Выберите навыки</span>`);
			else _push(`<span data-v-61534156>Выбрано: ${ssrInterpolate(selectedSkills.value.length)}</span>`);
			_push(`<span class="arrow" data-v-61534156>▼</span></div>`);
			if (dropdownOpen.value) {
				_push(`<div class="multiselect-dropdown" data-v-61534156><!--[-->`);
				ssrRenderList(__props.skills, (skill) => {
					_push(`<div class="${ssrRenderClass([{ selected: isSkillSelected(skill.id) }, "multiselect-option"])}" data-v-61534156><span class="${ssrRenderClass([unref(getSkillClass)(skill.name), "skill-name"])}" data-v-61534156>${ssrInterpolate(skill.name)}</span>`);
					if (isSkillSelected(skill.id)) _push(`<span class="check" data-v-61534156>✓</span>`);
					else _push(`<!---->`);
					_push(`</div>`);
				});
				_push(`<!--]--></div>`);
			...
			if (selectedSkills.value.length > 0) {
				_push(`<div class="selected-skills" data-v-61534156><!--[-->`);
				ssrRenderList(selectedSkills.value, (skill) => {
					_push(`<div class="${ssrRenderClass([unref(getSkillClass)(skill.name), "skill-tag"])}" data-v-61534156><span class="skill-name" data-v-61534156>${ssrInterpolate(skill.name)}</span><div class="skill-level" data-v-61534156><select${ssrRenderAttr("value", skill.level)} data-v-61534156><option value="1" data-v-61534156>1</option><option value="2" data-v-61534156>2</option><option value="3" data-v-61534156>3</option><option value="4" data-v-61534156>4</option><option value="5" data-v-61534156>5</option></select></div><button type="button" class="remove-skill" data-v-61534156>×</button></div>`);
				});
				_push(`<!--]--></div>`);
			} else _push(`<!---->`);
			_push(`</div>`);
...
var SkillsSelector_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$18, [["__scopeId", "data-v-61534156"]]);
//#endregion
//#region resources/js/Pages/Auth/Auth.vue
var Auth_exports = /* @__PURE__ */ __exportAll({ default: () => Auth_default });
var _sfc_main$17 = /* @__PURE__ */ Object.assign({ layout: AppLayout_default }, {
	__name: "Auth",
	__ssrInlineRender: true,
	props: {
		errors: Object,
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(`<div class="${ssrRenderClass([{ "register-mode": mode.value === "register" }, "Authblock"])}" data-v-55ba52c5><div class="form-wrapper" data-v-55ba52c5>`);
			if (mode.value === "login") {
				_push(`<form data-v-55ba52c5><h1 data-v-55ba52c5>Вход</h1>`);
				if (_ctx.$page.props.errors.error) _push(`<div class="error-message global-error" data-v-55ba52c5>${ssrInterpolate(_ctx.$page.props.errors.error)}</div>`);
				else _push(`<!---->`);
				_push(`<div class="login-content" data-v-55ba52c5><div class="input-group" data-v-55ba52c5><label data-v-55ba52c5>Email</label><input type="email"${ssrRenderAttr("value", unref(loginForm).email)} placeholder="Введите email" required data-v-55ba52c5></div><div class="input-group" data-v-55ba52c5><label data-v-55ba52c5>Пароль</label><input type="password"${ssrRenderAttr("value", unref(loginForm).password)} placeholder="Введите пароль" required data-v-55ba52c5>`);
				if (loginError.value) _push(`<div class="field-error" data-v-55ba52c5>${ssrInterpolate(loginError.value)}</div>`);
				else _push(`<!---->`);
				_push(`</div></div><button type="submit"${ssrIncludeBooleanAttr(unref(loginForm).processing) ? " disabled" : ""} data-v-55ba52c5>${ssrInterpolate(unref(loginForm).processing ? "Вход..." : "Войти")}</button><button type="button" class="switch-mode" data-v-55ba52c5> Нет аккаунта? Зарегистрироваться </button><div class="oauth-divider" data-v-55ba52c5><span data-v-55ba52c5>Или</span></div><div class="oauth-buttons" data-v-55ba52c5><a href="/auth/google/redirect" class="oauth-btn oauth-google" data-inertia="false" data-v-55ba52c5><img src="/images/google.svg" alt="" data-v-55ba52c5> Войти через Google </a><a href="/auth/yandex/redirect" class="oauth-btn oauth-yandex" data-inertia="false" data-v-55ba52c5><img src="/images/yandex.svg" alt="" data-v-55ba52c5> Войти через Яндекс </a></div></form>`);
			} else {
				_push(`<form class="register-form" data-v-55ba52c5><h1 data-v-55ba52c5>Регистрация</h1><div class="step-indicator" data-v-55ba52c5><!--[-->`);
				ssrRenderList(3, (step) => {
					_push(`<div class="${ssrRenderClass([{
						active: currentStep.value === step,
						completed: currentStep.value > step
					}, "step-dot"])}" data-v-55ba52c5></div>`);
				});
				_push(`<!--]--></div><div class="step-content" data-v-55ba52c5>`);
				if (currentStep.value === 1) {
					_push(`<div class="step step-1" data-v-55ba52c5><div class="input-group" data-v-55ba52c5><label data-v-55ba52c5>Имя</label><input type="text"${ssrRenderAttr("value", registerData.name)} placeholder="Введите имя" required data-v-55ba52c5></div><div class="input-group" data-v-55ba52c5><label data-v-55ba52c5>Email</label><input type="email"${ssrRenderAttr("value", registerData.email)} placeholder="Введите email" required data-v-55ba52c5></div><div class="input-group" data-v-55ba52c5><label data-v-55ba52c5>Пароль</label><input type="password"${ssrRenderAttr("value", registerData.password)} placeholder="Минимум 8 символов" required data-v-55ba52c5></div><div class="input-group" data-v-55ba52c5><label data-v-55ba52c5>Подтверждение пароля</label><input type="password"${ssrRenderAttr("value", registerData.password_confirmation)} placeholder="Повторите пароль" required data-v-55ba52c5></div>`);
					if (validationErrors.step1) _push(`<div class="error-message" data-v-55ba52c5>${ssrInterpolate(validationErrors.step1)}</div>`);
					else _push(`<!---->`);
					if (registerErrors.value.length > 0) {
						_push(`<div class="error-message" data-v-55ba52c5><!--[-->`);
						ssrRenderList(registerErrors.value, (err) => {
							_push(`<div data-v-55ba52c5>${ssrInterpolate(err)}</div>`);
						});
						_push(`<!--]--></div>`);
					} else _push(`<!---->`);
					_push(`</div>`);
				} else if (currentStep.value === 2) {
					_push(`<div class="step step-2" data-v-55ba52c5><p class="optional-notice" data-v-55ba52c5>Опционально — вы сможете поменять данные в настройках личного кабинета</p><div class="avatar-upload" data-v-55ba52c5><label data-v-55ba52c5>Аватар</label><div class="avatar-preview" data-v-55ba52c5>`);
					if (avatarPreview.value) _push(`<img${ssrRenderAttr("src", avatarPreview.value)} alt="Avatar preview" data-v-55ba52c5>`);
					else _push(`<span class="avatar-placeholder" data-v-55ba52c5>Нажмите для загрузки</span>`);
					_push(`</div><input type="file" accept="image/*" hidden data-v-55ba52c5>`);
					if (avatarPreview.value) _push(`<button type="button" class="remove-avatar" data-v-55ba52c5>Удалить</button>`);
					else _push(`<!---->`);
					_push(`</div><div class="form-group" data-v-55ba52c5><label data-v-55ba52c5>О себе</label><textarea placeholder="Расскажите о себе..." rows="4" data-v-55ba52c5>${ssrInterpolate(registerData.bio)}</textarea></div><div class="form-group" data-v-55ba52c5><div class="label-with-tooltip" data-v-55ba52c5><label data-v-55ba52c5>Навыки</label><div class="tooltip-trigger" data-v-55ba52c5><span class="help-icon" data-v-55ba52c5>?</span><div class="tooltip-content" data-v-55ba52c5> Выберите навыки, которыми вы владеете. Это поможет работодателям найти вас по соответствующим вакансиям. </div></div></div>`);
					...
					_push(`<div class="step step-3" data-v-55ba52c5><p class="optional-notice" data-v-55ba52c5>Опционально — повысьте шансы на трудоустройство</p><div class="form-group" data-v-55ba52c5><label data-v-55ba52c5>Телефон</label><div class="phone-input-wrapper" data-v-55ba52c5><input type="tel"${ssrRenderAttr("value", registerData.phone)} placeholder="+7 (___) ___-__-__" data-v-55ba52c5><span class="phone-hint" data-v-55ba52c5>Пригодится для двухфакторной аутентификации</span></div></div><div class="form-group" data-v-55ba52c5><label data-v-55ba52c5>Резюме</label><div class="file-upload" data-v-55ba52c5>`);
					if (registerData.resume) _push(`<span data-v-55ba52c5>${ssrInterpolate(registerData.resume.name)}</span>`);
					else _push(`<span data-v-55ba52c5>Нажмите для загрузки PDF, DOC, DOCX</span>`);
					_push(`</div><input type="file" accept=".pdf,.doc,.docx" hidden data-v-55ba52c5></div><div class="form-group" data-v-55ba52c5><label data-v-55ba52c5>Паспорт</label><div class="file-upload" data-v-55ba52c5>`);
					if (registerData.passport) _push(`<span data-v-55ba52c5>${ssrInterpolate(registerData.passport.name)}</span>`);
					else _push(`<span data-v-55ba52c5>Загрузите скан паспорта или сфоткайте разворот</span>`);
					_push(`</div><input type="file" accept="image/*,.pdf" hidden data-v-55ba52c5></div><div class="form-group" data-v-55ba52c5><label data-v-55ba52c5>Диплом/Сертификаты</label><div class="file-upload" data-v-55ba52c5>`);
					if (registerData.certificates) _push(`<span data-v-55ba52c5>${ssrInterpolate(registerData.certificates.name)}</span>`);
					else _push(`<span data-v-55ba52c5>Загрузите документы об образовании</span>`);
					_push(`</div><input type="file" accept="image/*,.pdf" hidden data-v-55ba52c5><span class="phone-hint" data-v-55ba52c5>(Вы сможете найти их в настройках в вкладке Мои файлы) </span></div><div class="checkbox-group" data-v-55ba52c5><label class="checkbox-label" data-v-55ba52c5><input type="checkbox"${ssrIncludeBooleanAttr(Array.isArray(registerData.email_confirmed) ? ssrLooseContain(registerData.email_confirmed, null) : registerData.email_confirmed) ? " checked" : ""} data-v-55ba52c5><span data-v-55ba52c5>Подтвердить email</span></label></div><div class="checkbox-group" data-v-55ba52c5><label class="checkbox-label verification-label" data-v-55ba52c5><input type="checkbox"${ssrIncludeBooleanAttr(Array.isArray(registerData.request_verification) ? ssrLooseContain(registerData.request_verification, null) : registerData.request_verification) ? " checked" : ""} data-v-55ba52c5><span data-v-55ba52c5>Запросить верификацию аккаунта</span><div class="tooltip-trigger" data-v-55ba52c5><span class="help-icon" data-v-55ba52c5>?</span><div class="tooltip-content" data-v-55ba52c5> Верификация добавит галочку <img src="/images/verified.svg" alt="" data-v-55ba52c5> рядом с вашим именем, что повысит доверие работодателей. </div></div></label></div></div>`);
				} else _push(`<!---->`);
				_push(`</div><div class="form-actions" data-v-55ba52c5>`);
				if (currentStep.value > 1) _push(`<button type="button" class="btn-back" data-v-55ba52c5> Назад </button>`);
				else _push(`<!---->`);
				if (currentStep.value < 3) _push(`<button type="button" class="btn-next" data-v-55ba52c5> Далее </button>`);
				else _push(`<button type="submit"${ssrIncludeBooleanAttr(unref(registerForm).processing) ? " disabled" : ""} class="btn-submit" data-v-55ba52c5>${ssrInterpolate(unref(registerForm).processing ? "Регистрация..." : "Зарегистрироваться")}</button>`);
				_push(`</div><button type="button" class="switch-mode" data-v-55ba52c5> Уже есть аккаунт? Войти </button></form>`);
			}
			_push(`</div></div><!--]-->`);
		};
	}
...
var Auth_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$17, [["__scopeId", "data-v-55ba52c5"]]);
//#endregion
	...
	setup(__props) {
		...
		const submitBalance = () => {
			...
			form.post(url, {
				...
				onError: (errors) => {
					if (errors?.amount) form.setError("amount", errors.amount);
					if (errors?.card_number) form.setError("card_number", errors.card_number);
					if (errors?.error) form.setError("amount", errors.error);
				}
			});
		};
		...
		const hasPendingWithdrawals = computed(() => allTransactions.value.some((tx) => tx.type === "withdrawal" && tx.status === "pending"));
		let pollInterval = null;
		const startPolling = () => {
			if (pollInterval) return;
			pollInterval = setInterval(() => {
				if (hasPendingWithdrawals.value) router.reload({
		...
		const refreshPayout = (transactionId) => {
			router.post("/balance/refresh-payout", { transaction_id: transactionId }, {
				preserveScroll: true,
				onError: (errors) => {
			...
			_push(ssrRenderComponent(AppLayout_default, _attrs, {
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						_push(`<div class="balance-page" data-v-78b32d01${_scopeId}><div class="main" data-v-78b32d01${_scopeId}><section class="top-row" data-v-78b32d01${_scopeId}><div class="card" data-v-78b32d01${_scopeId}><h2 class="funding-card-title" data-v-78b32d01${_scopeId}>${ssrInterpolate(isWithdrawal.value ? "Снятие средств" : "Пополнение баланса")}</h2><div class="balance-row" data-v-78b32d01${_scopeId}><span class="balance-row-label" data-v-78b32d01${_scopeId}>Текущий баланс:</span><span class="balance-row-amount" data-v-78b32d01${_scopeId}>${ssrInterpolate(Number(__props.balance).toLocaleString("ru-RU"))} ₽</span></div><div class="toggle-row" data-v-78b32d01${_scopeId}><button type="button" class="${ssrRenderClass([{ active: !isWithdrawal.value }, "toggle-btn"])}" data-v-78b32d01${_scopeId}> Пополнение </button><button type="button" class="${ssrRenderClass([{ active: isWithdrawal.value }, "toggle-btn"])}"${ssrIncludeBooleanAttr(Number(__props.balance) <= 0) ? " disabled" : ""} data-v-78b32d01${_scopeId}> Снятие </button></div><label class="input-label" data-v-78b32d01${_scopeId}>${ssrInterpolate(isWithdrawal.value ? "Сумма снятия:" : "Сумма пополнения:")}</label><div class="input-wrapper" data-v-78b32d01${_scopeId}><input${ssrRenderAttr("value", formattedAmount.value)} type="text" inputmode="numeric" placeholder="Введите сумму" data-v-78b32d01${_scopeId}><span class="currency-suffix" data-v-78b32d01${_scopeId}>₽</span></div><div class="${ssrRenderClass([{ visible: unref(form).errors.amount || withdrawError.value || flashMessage.value }, "message-wrapper"])}" data-v-78b32d01${_scopeId}>`);
						if (unref(form).errors.amount) _push(`<p class="error-text" data-v-78b32d01${_scopeId}>${ssrInterpolate(unref(form).errors.amount)}</p>`);
						else _push(`<!---->`);
						if (withdrawError.value) _push(`<p class="error-text" data-v-78b32d01${_scopeId}>${ssrInterpolate(withdrawError.value)}</p>`);
						else _push(`<!---->`);
						if (flashMessage.value) _push(`<p class="success-text" data-v-78b32d01${_scopeId}>${ssrInterpolate(flashMessage.value)}</p>`);
						else _push(`<!---->`);
						_push(`</div><div class="quick-amounts" data-v-78b32d01${_scopeId}><!--[-->`);
						ssrRenderList(isWithdrawal.value ? withdrawalAmounts : quickAmounts, (amount) => {
							_push(`<button type="button" class="quick-amount-btn" data-v-78b32d01${_scopeId}>${ssrInterpolate(amount.toLocaleString("ru-RU"))} ₽ </button>`);
						});
						_push(`<!--]--></div>`);
						if (isWithdrawal.value) {
							_push(`<div class="payout-form" data-v-78b32d01${_scopeId}><label class="input-label" data-v-78b32d01${_scopeId}>Способ вывода:</label>`);
							if (__props.payoutMethods.length > 0) {
								_push(`<div class="saved-methods" data-v-78b32d01${_scopeId}><!--[-->`);
								ssrRenderList(__props.payoutMethods, (m) => {
									_push(`<button type="button" class="${ssrRenderClass([{ active: selectedMethodId.value === m.id }, "method-btn"])}" data-v-78b32d01${_scopeId}> Карта ${ssrInterpolate(m.masked_number)}</button>`);
								});
								_push(`<!--]--><button type="button" class="${ssrRenderClass([{ active: !selectedMethodId.value }, "method-btn"])}" data-v-78b32d01${_scopeId}> Новый способ </button></div>`);
							} else _push(`<!---->`);
							if (!selectedMethodId.value) {
								_push(`<div class="new-method" data-v-78b32d01${_scopeId}><div class="input-group" data-v-78b32d01${_scopeId}><label class="input-label" data-v-78b32d01${_scopeId}>Номер карты:</label><div class="input-wrapper" data-v-78b32d01${_scopeId}><input${ssrRenderAttr("value", unref(form).card_number)} type="text" inputmode="numeric" placeholder="0000 0000 0000 0000" maxlength="19" data-v-78b32d01${_scopeId}></div>`);
								if (unref(form).errors.card_number) _push(`<p class="error-text" data-v-78b32d01${_scopeId}>${ssrInterpolate(unref(form).errors.card_number)}</p>`);
								else _push(`<!---->`);
								_push(`</div><label class="save-method-label" data-v-78b32d01${_scopeId}><input${ssrIncludeBooleanAttr(Array.isArray(unref(form).save_method) ? ssrLooseContain(unref(form).save_method, null) : unref(form).save_method) ? " checked" : ""} type="checkbox" data-v-78b32d01${_scopeId}> Сохранить реквизиты для следующих выводов </label></div>`);
							} else _push(`<div class="saved-method-info" data-v-78b32d01${_scopeId}><p class="method-info" data-v-78b32d01${_scopeId}>Вывод на сохранённый реквизит</p><button type="button" class="remove-method-btn" data-v-78b32d01${_scopeId}> Нажмите сюда, чтобы убрать </button></div>`);
							_push(`</div>`);
						} else _push(`<!---->`);
						_push(`<button class="btn-cta"${ssrIncludeBooleanAttr(unref(form).processing) ? " disabled" : ""} data-v-78b32d01${_scopeId}>${ssrInterpolate(unref(form).processing ? isWithdrawal.value ? "Снятие..." : "Пополнение..." : isWithdrawal.value ? "Вывести средства" : "Пополнить баланс")}</button></div><div class="card chart-card" data-v-78b32d01${_scopeId}><div class="chart-header" data-v-78b32d01${_scopeId}><h2 class="chart-title" data-v-78b32d01${_scopeId}>Аналитика</h2><div class="toggle-row" data-v-78b32d01${_scopeId}><button type="button" class="${ssrRenderClass([{ active: chartView.value === "received" }, "toggle-btn"])}" data-v-78b32d01${_scopeId}> Получено </button><button type="button" class="${ssrRenderClass([{ active: chartView.value === "spent" }, "toggle-btn"])}" data-v-78b32d01${_scopeId}> Выведено </button></div></div><div class="chart-wrapper" data-v-78b32d01${_scopeId}><div class="chart-container" data-v-78b32d01${_scopeId}><div class="y-axis" data-v-78b32d01${_scopeId}><!--[-->`);
						ssrRenderList(yAxisValues.value, (val) => {
							_push(`<span data-v-78b32d01${_scopeId}>${ssrInterpolate(val.toLocaleString("ru-RU"))}</span>`);
						});
						_push(`<!--]--></div><div class="grid-lines" data-v-78b32d01${_scopeId}><!--[-->`);
						ssrRenderList(5, (i) => {
							_push(`<div class="grid-line" style="${ssrRenderStyle({ top: (i - 1) * 20 + "%" })}" data-v-78b32d01${_scopeId}></div>`);
						});
						_push(`<!--]--></div><div class="chart-bars" data-v-78b32d01${_scopeId}><!--[-->`);
						ssrRenderList(chartData.value, (val, i) => {
							_push(`<div class="bar-group" data-v-78b32d01${_scopeId}><div class="${ssrRenderClass([chartView.value, "bar"])}" style="${ssrRenderStyle({ height: val / chartMax.value * 100 + "%" })}" data-v-78b32d01${_scopeId}></div></div>`);
						});
						_push(`<!--]--></div></div><div class="x-axis" data-v-78b32d01${_scopeId}><!--[-->`);
						ssrRenderList(months, (m, i) => {
							_push(`<span data-v-78b32d01${_scopeId}>${ssrInterpolate(m)}</span>`);
						});
						_push(`<!--]--></div><div class="${ssrRenderClass([{ visible: tooltip.value.visible }, "chart-tooltip"])}" style="${ssrRenderStyle({
							left: tooltip.value.x + "px",
							top: tooltip.value.y + "px"
						})}" data-v-78b32d01${_scopeId}>${tooltip.value.text ?? ""}</div></div></div></section>`);
						if (__props.pendingTransactions && __props.pendingTransactions.length > 0) {
							_push(`<div class="card pending-section" data-v-78b32d01${_scopeId}><h2 class="funding-card-title" data-v-78b32d01${_scopeId}>Ожидающие зачисления</h2><div class="tx-list" data-v-78b32d01${_scopeId}><!--[-->`);
							ssrRenderList(__props.pendingTransactions, (tx) => {
								_push(`<div class="tx-item pending" data-v-78b32d01${_scopeId}><div class="tx-top" data-v-78b32d01${_scopeId}><span class="tx-amount positive" data-v-78b32d01${_scopeId}>+${ssrInterpolate(Number(tx.amount).toFixed(2))} ₽</span><span class="tx-status pending" data-v-78b32d01${_scopeId}>Ожидание</span></div><div class="tx-desc" data-v-78b32d01${_scopeId}>${ssrInterpolate(tx.type === "payment" ? "Оплата за работу" : tx.description)} `);
								if (tx.from_user) _push(`<span data-v-78b32d01${_scopeId}> — ${ssrInterpolate(tx.from_user.name)}</span>`);
								else _push(`<!---->`);
								_push(`</div><div class="tx-date" data-v-78b32d01${_scopeId}>Осталось: ${ssrInterpolate(getDaysRemaining(tx))} дн.</div></div>`);
							});
							_push(`<!--]--></div></div>`);
						} else _push(`<!---->`);
						_push(`<section class="history-section card" data-v-78b32d01${_scopeId}><div class="history-header" data-v-78b32d01${_scopeId}><h2 class="history-title" data-v-78b32d01${_scopeId}>История транзакций</h2></div><div class="history-tabs" data-v-78b32d01${_scopeId}><button class="${ssrRenderClass([{ active: historyTab.value === "received" }, "history-tab"])}" data-v-78b32d01${_scopeId}> Получено </button><button class="${ssrRenderClass([{ active: historyTab.value === "sent" }, "history-tab"])}" data-v-78b32d01${_scopeId}> Отправлено </button><button class="${ssrRenderClass([{ active: historyTab.value === "withdrawn" }, "history-tab"])}" data-v-78b32d01${_scopeId}> Вывод </button></div><div class="history-columns" data-v-78b32d01${_scopeId}><div class="${ssrRenderClass([{ active: historyTab.value === "received" }, "history-col"])}" data-v-78b32d01${_scopeId}><div class="history-column-title" data-v-78b32d01${_scopeId}><span class="dot dot-received" data-v-78b32d01${_scopeId}></span> Получено </div><div class="tx-list" data-v-78b32d01${_scopeId}><!--[-->`);
						ssrRenderList(receivedTransactions.value, (tx) => {
							_push(`<div class="tx-item" data-v-78b32d01${_scopeId}><div class="tx-top" data-v-78b32d01${_scopeId}><span class="tx-amount positive" data-v-78b32d01${_scopeId}>+${ssrInterpolate(Number(tx.amount).toFixed(2))} ₽</span><span class="${ssrRenderClass(["tx-status", tx.status])}" data-v-78b32d01${_scopeId}>${ssrInterpolate(getStatusLabel(tx.status))}</span></div><div class="tx-desc" data-v-78b32d01${_scopeId}>${ssrInterpolate(getTransactionType(tx))}</div><div class="tx-date" data-v-78b32d01${_scopeId}>${ssrInterpolate(formatDate(tx.created_at))}</div></div>`);
						});
						_push(`<!--]-->`);
						if (receivedTransactions.value.length === 0) _push(`<div class="tx-item empty" data-v-78b32d01${_scopeId}>Нет транзакций</div>`);
						else _push(`<!---->`);
						_push(`</div></div><div class="${ssrRenderClass([{ active: historyTab.value === "sent" }, "history-col"])}" data-v-78b32d01${_scopeId}><div class="history-column-title" data-v-78b32d01${_scopeId}><span class="dot dot-sent" data-v-78b32d01${_scopeId}></span> Отправлено </div><div class="tx-list" data-v-78b32d01${_scopeId}><!--[-->`);
						ssrRenderList(sentTransactions.value, (tx) => {
							_push(`<div class="tx-item" data-v-78b32d01${_scopeId}><div class="tx-top" data-v-78b32d01${_scopeId}><span class="tx-amount negative" data-v-78b32d01${_scopeId}>−${ssrInterpolate(Number(tx.amount).toFixed(2))} ₽</span><span class="${ssrRenderClass(["tx-status", tx.status])}" data-v-78b32d01${_scopeId}>${ssrInterpolate(getStatusLabel(tx.status))}</span></div><div class="tx-desc" data-v-78b32d01${_scopeId}>${ssrInterpolate(getTransactionType(tx))}</div><div class="tx-date" data-v-78b32d01${_scopeId}>${ssrInterpolate(formatDate(tx.created_at))}</div></div>`);
						});
						_push(`<!--]-->`);
						if (sentTransactions.value.length === 0) _push(`<div class="tx-item empty" data-v-78b32d01${_scopeId}>Нет транзакций</div>`);
						else _push(`<!---->`);
						_push(`</div></div><div class="${ssrRenderClass([{ active: historyTab.value === "withdrawn" }, "history-col"])}" data-v-78b32d01${_scopeId}><div class="history-column-title" data-v-78b32d01${_scopeId}><span class="dot dot-withdrawn" data-v-78b32d01${_scopeId}></span> Вывод средств </div><div class="tx-list" data-v-78b32d01${_scopeId}><!--[-->`);
						ssrRenderList(withdrawnTransactions.value, (tx) => {
							_push(`<div class="tx-item" data-v-78b32d01${_scopeId}><div class="tx-top" data-v-78b32d01${_scopeId}><span class="tx-amount withdrawn" data-v-78b32d01${_scopeId}>−${ssrInterpolate(Number(tx.amount).toFixed(2))} ₽</span><span class="${ssrRenderClass(["tx-status", tx.status])}" data-v-78b32d01${_scopeId}>${ssrInterpolate(getStatusLabel(tx.status))}</span></div><div class="tx-desc" data-v-78b32d01${_scopeId}>${ssrInterpolate(getTransactionType(tx))}</div><div class="tx-date" data-v-78b32d01${_scopeId}>${ssrInterpolate(formatDate(tx.created_at))}</div>`);
							if (tx.status === "pending" && tx.payout && tx.payout.yookassa_payout_id) _push(`<button type="button" class="refresh-btn" data-v-78b32d01${_scopeId}> Проверить статус </button>`);
							else _push(`<!---->`);
							_push(`</div>`);
						});
						_push(`<!--]-->`);
						if (withdrawnTransactions.value.length === 0) _push(`<div class="tx-item empty" data-v-78b32d01${_scopeId}>Нет транзакций</div>`);
						else _push(`<!---->`);
						_push(`</div></div></div>`);
						if (__props.transactions && __props.transactions.last_page > 1) {
							_push(`<div class="pagination" data-v-78b32d01${_scopeId}>`);
							if (__props.transactions.current_page > 1) _push(`<button class="pagination-btn" data-v-78b32d01${_scopeId}> ← Назад </button>`);
							else _push(`<!---->`);
							_push(`<span class="pagination-info" data-v-78b32d01${_scopeId}>Страница ${ssrInterpolate(__props.transactions.current_page)} из ${ssrInterpolate(__props.transactions.last_page)}</span>`);
							if (__props.transactions.current_page < __props.transactions.last_page) _push(`<button class="pagination-btn" data-v-78b32d01${_scopeId}> Вперёд → </button>`);
							else _push(`<!---->`);
							_push(`</div>`);
						} else _push(`<!---->`);
						...
						createVNode("section", { class: "top-row" }, [createVNode("div", { class: "card" }, [
							...
							createVNode("div", { class: ["message-wrapper", { visible: unref(form).errors.amount || withdrawError.value || flashMessage.value }] }, [
								unref(form).errors.amount ? (openBlock(), createBlock("p", {
									key: 0,
									class: "error-text"
								}, toDisplayString(unref(form).errors.amount), 1)) : createCommentVNode("", true),
								withdrawError.value ? (openBlock(), createBlock("p", {
									key: 1,
									class: "error-text"
								}, toDisplayString(withdrawError.value), 1)) : createCommentVNode("", true),
								flashMessage.value ? (openBlock(), createBlock("p", {
									key: 2,
									class: "success-text"
								}, toDisplayString(flashMessage.value), 1)) : createCommentVNode("", true)
							], 2),
							...
							isWithdrawal.value ? (openBlock(), createBlock("div", {
								...
								createVNode("label", { class: "input-label" }, "Способ вывода:"),
								__props.payoutMethods.length > 0 ? (openBlock(), createBlock("div", {
									key: 0,
									class: "saved-methods"
								}, [(openBlock(true), createBlock(Fragment, null, renderList(__props.payoutMethods, (m) => {
									return openBlock(), createBlock("button", {
										key: m.id,
										type: "button",
										class: ["method-btn", { active: selectedMethodId.value === m.id }],
										onClick: ($event) => {
											selectedMethodId.value = m.id;
											unref(form).card_number = "";
										}
									}, " Карта " + toDisplayString(m.masked_number), 11, ["onClick"]);
								}), 128)), createVNode("button", {
									type: "button",
									class: ["method-btn", { active: !selectedMethodId.value }],
									onClick: ($event) => selectedMethodId.value = null
								}, " Новый способ ", 10, ["onClick"])])) : createCommentVNode("", true),
								!selectedMethodId.value ? (openBlock(), createBlock("div", {
									key: 1,
									class: "new-method"
								}, [createVNode("div", { class: "input-group" }, [
									createVNode("label", { class: "input-label" }, "Номер карты:"),
									createVNode("div", { class: "input-wrapper" }, [withDirectives(createVNode("input", {
										...
										maxlength: "19",
										onInput: (e) => unref(form).card_number = formatCardNumber(e.target.value)
									}, null, 40, ["onUpdate:modelValue", "onInput"]), [[vModelText, unref(form).card_number]])]),
									unref(form).errors.card_number ? (openBlock(), createBlock("p", {
										key: 0,
										class: "error-text"
									}, toDisplayString(unref(form).errors.card_number), 1)) : createCommentVNode("", true)
								]), createVNode("label", { class: "save-method-label" }, [withDirectives(createVNode("input", {
									"onUpdate:modelValue": ($event) => unref(form).save_method = $event,
									type: "checkbox"
								}, null, 8, ["onUpdate:modelValue"]), [[vModelCheckbox, unref(form).save_method]]), createTextVNode(" Сохранить реквизиты для следующих выводов ")])])) : (openBlock(), createBlock("div", {
									key: 2,
									class: "saved-method-info"
								}, [createVNode("p", { class: "method-info" }, "Вывод на сохранённый реквизит"), createVNode("button", {
									type: "button",
									class: "remove-method-btn",
									onClick: removeSavedMethod
							...
							createVNode("div", { class: "history-columns" }, [
								createVNode("div", { class: ["history-col", { active: historyTab.value === "received" }] }, [createVNode("div", { class: "history-column-title" }, [createVNode("span", { class: "dot dot-received" }), createTextVNode(" Получено ")]), createVNode("div", { class: "tx-list" }, [(openBlock(true), createBlock(Fragment, null, renderList(receivedTransactions.value, (tx) => {
									return openBlock(), createBlock("div", {
										...
										createVNode("div", { class: "tx-top" }, [createVNode("span", { class: "tx-amount positive" }, "+" + toDisplayString(Number(tx.amount).toFixed(2)) + " ₽", 1), createVNode("span", { class: ["tx-status", tx.status] }, toDisplayString(getStatusLabel(tx.status)), 3)]),
								...
								createVNode("div", { class: ["history-col", { active: historyTab.value === "sent" }] }, [createVNode("div", { class: "history-column-title" }, [createVNode("span", { class: "dot dot-sent" }), createTextVNode(" Отправлено ")]), createVNode("div", { class: "tx-list" }, [(openBlock(true), createBlock(Fragment, null, renderList(sentTransactions.value, (tx) => {
									return openBlock(), createBlock("div", {
										...
										createVNode("div", { class: "tx-top" }, [createVNode("span", { class: "tx-amount negative" }, "−" + toDisplayString(Number(tx.amount).toFixed(2)) + " ₽", 1), createVNode("span", { class: ["tx-status", tx.status] }, toDisplayString(getStatusLabel(tx.status)), 3)]),
										createVNode("div", { class: "tx-desc" }, toDisplayString(getTransactionType(tx)), 1),
										createVNode("div", { class: "tx-date" }, toDisplayString(formatDate(tx.created_at)), 1)
									]);
								...
								createVNode("div", { class: ["history-col", { active: historyTab.value === "withdrawn" }] }, [createVNode("div", { class: "history-column-title" }, [createVNode("span", { class: "dot dot-withdrawn" }), createTextVNode(" Вывод средств ")]), createVNode("div", { class: "tx-list" }, [(openBlock(true), createBlock(Fragment, null, renderList(withdrawnTransactions.value, (tx) => {
									return openBlock(), createBlock("div", {
										...
										createVNode("div", { class: "tx-top" }, [createVNode("span", { class: "tx-amount withdrawn" }, "−" + toDisplayString(Number(tx.amount).toFixed(2)) + " ₽", 1), createVNode("span", { class: ["tx-status", tx.status] }, toDisplayString(getStatusLabel(tx.status)), 3)]),
										createVNode("div", { class: "tx-desc" }, toDisplayString(getTransactionType(tx)), 1),
										createVNode("div", { class: "tx-date" }, toDisplayString(formatDate(tx.created_at)), 1),
										tx.status === "pending" && tx.payout && tx.payout.yookassa_payout_id ? (openBlock(), createBlock("button", {
											key: 0,
											type: "button",
											class: "refresh-btn",
											onClick: ($event) => refreshPayout(tx.id)
										}, " Проверить статус ", 8, ["onClick"])) : createCommentVNode("", true)
									]);
...
var Index_default$2 = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$16, [["__scopeId", "data-v-78b32d01"]]);
//#endregion
...
var _sfc_main$15 = {
	...
	setup(__props) {
		...
		function renderContent(content) {
			if (!content) return "";
			let result = content.replace(/https?:\/\/[^\/\s]+\/posts\/(\d+)/g, (url, id) => `<a href="/posts/${id}" class="post-link" data-link="local">${url}</a>`);
		...
		const sendMessage = () => {
			...
			if (!editingMessage.value && currentUser) {
				const replyTo = replyingTo.value ? {
					...
					user: {
						id: replyingTo.value.user.id,
						name: replyingTo.value.user.name
					}
				} : null;
		...
		const deleteMessage = (message, mode) => {
			if (confirm(`Вы уверены, что хотите ${mode === "everyone" ? "удалить это сообщение у всех" : "скрыть это сообщение"}?`)) router.delete(`/chats/${props.activeChat.id}/messages/${message.id}`, {
				data: { mode },
				preserveScroll: true,
				onSuccess: () => {
					if (mode === "me") localMessages.value = localMessages.value.filter((m) => m.id !== message.id);
					hideContextMenu();
				}
			});
			...
			if (newChatId) window.Echo.private(`chat.${newChatId}`).listen(".message.sent", (e) => {
				if (e.message && e.message.id) {
					...
					const msg = {
						...e.message,
						is_mine: false,
						time: new Date(e.message.created_at).toLocaleTimeString("ru-RU", {
							hour: "2-digit",
							minute: "2-digit"
						}),
					...
					if (!localMessages.value.some((m) => m.id === msg.id)) {
						...
						scrollToBottom(true);
						extractPostIds(e.message.content).forEach((id) => fetchPostPreview(id));
					}
				}
			...
			_push(ssrRenderComponent(AppLayout_default, _attrs, {
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						_push(`<div class="chat-container" data-v-31f0d6d1${_scopeId}><div class="chat-list" data-v-31f0d6d1${_scopeId}>`);
						if (!isSearching.value) _push(`<div class="chat-list-header" data-v-31f0d6d1${_scopeId}><h2 data-v-31f0d6d1${_scopeId}>Чаты</h2><button type="button" class="search-btn" data-v-31f0d6d1${_scopeId}><img src="/images/search.svg" alt="Поиск" data-v-31f0d6d1${_scopeId}></button></div>`);
						else _push(`<div class="search-header" data-v-31f0d6d1${_scopeId}><input${ssrRenderAttr("value", searchQuery.value)} type="text"${ssrRenderAttr("placeholder", isGlobalSearch.value ? "Поиск чатов и сообщений..." : "Поиск в чате...")} class="search-input" data-v-31f0d6d1${_scopeId}><button type="button" class="search-close" data-v-31f0d6d1${_scopeId}><img src="/images/close.svg" alt="Закрыть" data-v-31f0d6d1${_scopeId}></button></div>`);
						if (!isSearching.value) {
							...
							ssrRenderList(__props.chats, (chat) => {
								...
								}, "chat-item"])}" tabindex="0" data-v-31f0d6d1${_scopeId}>`);
								if (chat.other_user) {
									_push(`<div class="chat-user-info" data-v-31f0d6d1${_scopeId}><div class="avatar-wrapper" data-v-31f0d6d1${_scopeId}><img${ssrRenderAttr("src", chat.other_user.avatar_url)} class="chat-avatar" data-v-31f0d6d1${_scopeId}>`);
									if (isUserOnline(chat.other_user.id)) _push(`<span class="online-indicator" data-v-31f0d6d1${_scopeId}></span>`);
									else _push(`<!---->`);
									_push(`</div><div data-v-31f0d6d1${_scopeId}><h3 data-v-31f0d6d1${_scopeId}>${ssrInterpolate(chat.other_user.name)}</h3>`);
									if (chat.latest_message) _push(`<p class="${ssrRenderClass([{ unread: chat.unread_count > 0 }, "chat-preview"])}" data-v-31f0d6d1${_scopeId}>${ssrInterpolate(getChatPreview(chat.latest_message))}</p>`);
									else _push(`<!---->`);
									_push(`</div></div>`);
								} else _push(`<!---->`);
								_push(`<div class="chat-meta" data-v-31f0d6d1${_scopeId}>`);
								if (chat.unread_count > 0) _push(`<span class="unread-badge" data-v-31f0d6d1${_scopeId}>${ssrInterpolate(chat.unread_count > 99 ? "99+" : chat.unread_count)}</span>`);
								else _push(`<!---->`);
								_push(`</div></div>`);
							});
							_push(`<!--]-->`);
						...
						if (isSearching.value) {
							_push(`<div class="search-results" data-v-31f0d6d1${_scopeId}>`);
							if (searchResults.value.length === 0) _push(`<div class="search-no-results" data-v-31f0d6d1${_scopeId}> Ничего не найдено </div>`);
							else _push(`<!---->`);
							_push(`<!--[-->`);
							ssrRenderList(searchResults.value, (result) => {
								_push(`<div class="search-result-item" data-v-31f0d6d1${_scopeId}><img${ssrRenderAttr("src", result.user.avatar_url)} class="chat-avatar" data-v-31f0d6d1${_scopeId}><div class="search-result-content" data-v-31f0d6d1${_scopeId}><div class="search-result-name" data-v-31f0d6d1${_scopeId}>${ssrInterpolate(result.user.name)}</div>`);
								if (result.type === "chat") _push(`<div class="search-result-type" data-v-31f0d6d1${_scopeId}>Чат</div>`);
								else _push(`<div class="search-result-text" data-v-31f0d6d1${_scopeId}>${highlight(result.content) ?? ""}</div>`);
								_push(`</div></div>`);
							});
							_push(`<!--]--></div>`);
						} else _push(`<!---->`);
						...
						}, "chat-area"])}" style="${ssrRenderStyle(slideOffset.value > 0 ? { transform: `translateX(${slideOffset.value}px)` } : {})}" data-v-31f0d6d1${_scopeId}>`);
						if (__props.activeChat) {
							_push(`<!--[--><div class="chat-header" data-v-31f0d6d1${_scopeId}><button type="button" class="back" data-v-31f0d6d1${_scopeId}><img src="/images/arrow-left.svg" alt="назад" data-v-31f0d6d1${_scopeId}></button><div class="chat-header-mid" data-v-31f0d6d1${_scopeId}>`);
							if (otherUsers.value.length > 0) _push(ssrRenderComponent(unref(Link), {
								...
								default: withCtx((_, _push, _parent, _scopeId) => {
									if (_push) {
										_push(`<div class="avatar-wrapper" data-v-31f0d6d1${_scopeId}><img${ssrRenderAttr("src", otherUsers.value[0].avatar_url)} class="chat-avatar" data-v-31f0d6d1${_scopeId}>`);
										if (isUserOnline(otherUsers.value[0].id)) _push(`<span class="online-indicator" data-v-31f0d6d1${_scopeId}></span>`);
										else _push(`<span class="offline-indicator" data-v-31f0d6d1${_scopeId}></span>`);
										_push(`</div><h2 data-v-31f0d6d1${_scopeId}>${ssrInterpolate(otherUsers.value[0].name)}</h2>`);
							...
							if (vacancyPostId.value) _push(`<span class="vacancy-link" data-v-31f0d6d1${_scopeId}>${ssrInterpolate(isVacancyAuthor.value ? "откликнулся на" : "автор вакансии")}</span>`);
							else _push(`<!---->`);
							_push(ssrRenderComponent(unref(Link), {
								...
								default: withCtx((_, _push, _parent, _scopeId) => {
									if (_push) _push(`<h2 data-v-31f0d6d1${_scopeId}>${ssrInterpolate(vacancyPosition.value)}</h2>`);
									else return [createVNode("h2", null, toDisplayString(vacancyPosition.value), 1)];
								}),
								_: 1
							}, _parent, _scopeId));
							_push(`</div><img class="chat-options" src="/images/dots.svg" alt="опции" data-v-31f0d6d1${_scopeId}></div>`);
							if (isSearching.value && !isGlobalSearch.value && __props.activeChat) _push(`<div class="search-navigation" data-v-31f0d6d1${_scopeId}><button type="button" class="search-nav-btn"${ssrIncludeBooleanAttr(currentMatchIndex.value <= 0) ? " disabled" : ""} data-v-31f0d6d1${_scopeId}><img src="/images/arrow-up.svg" alt="вверх" data-v-31f0d6d1${_scopeId}></button><span class="search-nav-counter" data-v-31f0d6d1${_scopeId}>${ssrInterpolate(searchResults.value.length > 0 ? currentMatchIndex.value + 1 : 0)} / ${ssrInterpolate(searchResults.value.length)}</span><button type="button" class="search-nav-btn"${ssrIncludeBooleanAttr(currentMatchIndex.value >= searchResults.value.length - 1) ? " disabled" : ""} data-v-31f0d6d1${_scopeId}><img src="/images/arrow-up.svg" alt="вниз" style="${ssrRenderStyle({ "transform": "rotate(180deg)" })}" data-v-31f0d6d1${_scopeId}></button></div>`);
							else _push(`<!---->`);
							...
							})}" data-v-31f0d6d1${_scopeId}><div class="options-menu-item" data-v-31f0d6d1${_scopeId}>Файлы чата</div><div class="options-menu-item" data-v-31f0d6d1${_scopeId}>Поиск по чату</div></div>`);
							else _push(`<!---->`);
							if (showApplicationBlock.value) {
								_push(`<div class="${ssrRenderClass([{ closed: isApplicationBlockClosed.value }, "application-block"])}" data-v-31f0d6d1${_scopeId}><div class="application-toggle" data-v-31f0d6d1${_scopeId}><button type="button" class="application-toggle-btn" data-v-31f0d6d1${_scopeId}><img src="/images/arrow-up.svg" alt="Toggle" class="${ssrRenderClass([{ flipped: isApplicationBlockClosed.value }, "toggle-arrow"])}" data-v-31f0d6d1${_scopeId}></button></div><div class="application-card" style="${ssrRenderStyle(!isApplicationBlockClosed.value ? null : { display: "none" })}" data-v-31f0d6d1${_scopeId}><img${ssrRenderAttr("src", __props.activeChat.application.user.avatar_url)} class="application-avatar" data-v-31f0d6d1${_scopeId}><div class="name" data-v-31f0d6d1${_scopeId}><h3 data-v-31f0d6d1${_scopeId}>${ssrInterpolate(__props.activeChat.application.user.name)}</h3><span class="${ssrRenderClass([{ online: isUserOnline(otherUsers.value[0].id) }, "user-status"])}" data-v-31f0d6d1${_scopeId}>${ssrInterpolate(isUserOnline(otherUsers.value[0].id) ? "онлайн" : "оффлайн")}</span></div><p class="account-age" data-v-31f0d6d1${_scopeId}>Аккаунт создан ${ssrInterpolate(formatAccountAge(__props.activeChat.application.user.created_at))}</p>`);
								if (__props.activeChat.application.user.rating) _push(`<div class="application-rating" data-v-31f0d6d1${_scopeId}><span data-v-31f0d6d1${_scopeId}>Рейтинг: ${ssrInterpolate(__props.activeChat.application.user.rating)}</span></div>`);
								else _push(`<!---->`);
								_push(`<div class="application-cover-letter" data-v-31f0d6d1${_scopeId}><h4 data-v-31f0d6d1${_scopeId}>Сопроводительное письмо:</h4><p data-v-31f0d6d1${_scopeId}>${ssrInterpolate(__props.activeChat.application.cover_letter)}</p></div>`);
								if (__props.activeChat.application.proposed_price) {
									_push(`<div class="application-price-row" data-v-31f0d6d1${_scopeId}><div class="application-price" data-v-31f0d6d1${_scopeId}><span class="label" data-v-31f0d6d1${_scopeId}>Предложенная цена:</span><span class="value" data-v-31f0d6d1${_scopeId}>${ssrInterpolate(__props.activeChat.application.proposed_price)} ₽</span></div>`);
									if (isVacancyAuthor.value && __props.activeChat.application.status === "pending") _push(`<button type="button" class="price-edit-btn" data-v-31f0d6d1${_scopeId}><img src="/images/edit.svg" alt="Изменить цену" data-v-31f0d6d1${_scopeId}></button>`);
									else _push(`<!---->`);
									_push(`</div>`);
								} else _push(`<!---->`);
								if (__props.activeChat.application.status === "completed") _push(`<div class="application-status" data-v-31f0d6d1${_scopeId}><span class="status-badge completed" data-v-31f0d6d1${_scopeId}>✅ Сделка завершена</span></div>`);
								else _push(`<!---->`);
								if (__props.activeChat.application.status === "cancelled") _push(`<div class="application-status" data-v-31f0d6d1${_scopeId}><span class="status-badge cancelled" data-v-31f0d6d1${_scopeId}>❌ Сделка отменена</span></div>`);
								else _push(`<!---->`);
								if (__props.activeChat.application.status === "disputed" || __props.activeChat.application.dispute && __props.activeChat.application.dispute.status === "open") _push(`<div class="application-status" data-v-31f0d6d1${_scopeId}><span class="status-badge dispute" data-v-31f0d6d1${_scopeId}>⚠️ Открыт спор</span></div>`);
								else _push(`<!---->`);
								if (isVacancyAuthor.value) {
									_push(`<div class="application-actions" data-v-31f0d6d1${_scopeId}>`);
									if (__props.activeChat.application.status === "pending") _push(`<!--[--><form data-v-31f0d6d1${_scopeId}><button type="submit" class="accept-btn" data-v-31f0d6d1${_scopeId}>Принять отклик</button></form><form data-v-31f0d6d1${_scopeId}><button type="submit" class="reject-btn" data-v-31f0d6d1${_scopeId}>Отклонить</button></form><!--]-->`);
									else if (__props.activeChat.application.status === "in_progress") {
										_push(`<!--[-->`);
										if (__props.activeChat.application.executor_marked_completed_at) _push(`<form data-v-31f0d6d1${_scopeId}><button type="submit" class="accept-btn" data-v-31f0d6d1${_scopeId}>Подтвердить завершение</button></form>`);
										else _push(`<!---->`);
										if (!__props.activeChat.application.executor_marked_completed_at) _push(`<button type="button" class="withdraw-btn" data-v-31f0d6d1${_scopeId}> Отменить </button>`);
										else _push(`<!---->`);
										_push(`<!--]-->`);
									} else if (__props.activeChat.application.status === "accepted") _push(`<button type="button" class="withdraw-btn" data-v-31f0d6d1${_scopeId}> Отменить </button>`);
									else _push(`<!---->`);
									_push(`</div>`);
								} else _push(`<!---->`);
								if (!isVacancyAuthor.value) {
									_push(`<div class="application-actions" data-v-31f0d6d1${_scopeId}>`);
									if (__props.activeChat.application.status === "in_progress" && !__props.activeChat.application.executor_marked_completed_at) _push(`<!--[--><form data-v-31f0d6d1${_scopeId}><button type="submit" class="accept-btn" data-v-31f0d6d1${_scopeId}>Отметить как выполненное</button></form><button type="button" class="withdraw-btn" data-v-31f0d6d1${_scopeId}> Отменить </button><!--]-->`);
									else _push(`<!---->`);
									if (__props.activeChat.application.status === "in_progress" && __props.activeChat.application.executor_marked_completed_at) _push(`<!--[--><button type="button" class="withdraw-btn" data-v-31f0d6d1${_scopeId}> Отменить </button><button type="button" class="dispute-btn" data-v-31f0d6d1${_scopeId}> Открыть спор </button><!--]-->`);
									else _push(`<!---->`);
									if (__props.activeChat.application.status === "accepted") _push(`<button type="button" class="dispute-btn" data-v-31f0d6d1${_scopeId}> Открыть спор </button>`);
									else _push(`<!---->`);
									_push(`</div>`);
								} else _push(`<!---->`);
								_push(`</div></div>`);
							} else _push(`<!---->`);
							_push(`<div class="chat-messages" data-v-31f0d6d1${_scopeId}><div class="chat-messages-inner" data-v-31f0d6d1${_scopeId}><div${ssrRenderAttrs({
								name: "messages",
							...
							ssrRenderList(localMessages.value, (message, index) => {
								...
								}, "message-container"])}" data-v-31f0d6d1${_scopeId}><img${ssrRenderAttr("src", message.user.avatar_url)} class="chat-avatar" data-v-31f0d6d1${_scopeId}><div class="${ssrRenderClass([{
									"my-message": message.is_mine,
									"shared-post": isOnlyPostUrl(message.content)
								}, "message"])}" data-v-31f0d6d1${_scopeId}>`);
								if (message.image_url) _push(`<img${ssrRenderAttr("src", message.image_url)} alt="Изображение" class="message-image" data-v-31f0d6d1${_scopeId}>`);
								else _push(`<!---->`);
								if (message.video_url) _push(`<video${ssrRenderAttr("src", message.video_url)} class="message-video" controls data-v-31f0d6d1${_scopeId}></video>`);
								else _push(`<!---->`);
								if (message.reply_to) _push(`<div class="reply-quote" data-v-31f0d6d1${_scopeId}><div class="reply-quote-author" data-v-31f0d6d1${_scopeId}>${ssrInterpolate(message.reply_to.user.name)}</div><div class="reply-quote-text" data-v-31f0d6d1${_scopeId}>${ssrInterpolate(message.reply_to.content?.slice(0, 100))}</div></div>`);
								else _push(`<!---->`);
								_push(`<div class="message-content" data-v-31f0d6d1${_scopeId}>`);
								if (message.content && !isOnlyPostUrl(message.content)) _push(`<span data-v-31f0d6d1${_scopeId}>${renderContent(message.content) ?? ""}</span>`);
								else _push(`<!---->`);
								_push(`<!--[-->`);
								ssrRenderList(getPostPreviewsFromContent(message.content), (preview) => {
									_push(`<div class="${ssrRenderClass([{ "shared-post-card": isOnlyPostUrl(message.content) }, "post-preview-card"])}" data-v-31f0d6d1${_scopeId}>`);
									if (preview.image_url) _push(`<img${ssrRenderAttr("src", preview.image_url)} class="post-preview-img" alt="" data-v-31f0d6d1${_scopeId}>`);
									else _push(`<!---->`);
									_push(`<div class="post-preview-body" data-v-31f0d6d1${_scopeId}><div class="post-preview-title" data-v-31f0d6d1${_scopeId}>${ssrInterpolate(preview.title)}</div>`);
									if (preview.description) _push(`<div class="post-preview-desc" data-v-31f0d6d1${_scopeId}>${ssrInterpolate(preview.description.slice(0, 80))}${ssrInterpolate(preview.description.length > 80 ? "…" : "")}</div>`);
									else _push(`<!---->`);
									_push(`</div></div>`);
								});
								_push(`<!--]-->`);
								if (message.file_url) {
									_push(`<div class="file-attachment" data-v-31f0d6d1${_scopeId}><button type="button" class="file-download-circle"${ssrRenderAttr("title", isFileDownloaded(message) ? "Скачано" : "Скачать")} data-v-31f0d6d1${_scopeId}>`);
									if (!isFileDownloaded(message)) _push(`<span data-v-31f0d6d1${_scopeId}><img src="/images/download.svg" alt="Скачать" data-v-31f0d6d1${_scopeId}></span>`);
									else _push(`<span data-v-31f0d6d1${_scopeId}><img src="/images/document.svg" alt="Файл" data-v-31f0d6d1${_scopeId}></span>`);
									_push(`</button><div class="file-meta" data-v-31f0d6d1${_scopeId}><div class="file-name" data-v-31f0d6d1${_scopeId}>${ssrInterpolate(message.file_name || "Файл")}</div>`);
									if (message.file_size) _push(`<div class="file-size" data-v-31f0d6d1${_scopeId}>${ssrInterpolate(formatSize(message.file_size))}</div>`);
									else _push(`<!---->`);
									_push(`</div></div>`);
								} else _push(`<!---->`);
								if (message.is_price_proposal && message.price_proposal_status === "pending" && !message.is_mine) _push(`<div class="price-proposal-actions" data-v-31f0d6d1${_scopeId}><form class="price-action-form" data-v-31f0d6d1${_scopeId}><button type="submit" class="accept-price-btn" data-v-31f0d6d1${_scopeId}>Принять</button></form><button type="button" class="change-price-btn" data-v-31f0d6d1${_scopeId}>Изменить</button></div>`);
								else _push(`<!---->`);
								_push(`</div><div class="message-time" data-v-31f0d6d1${_scopeId}><span data-v-31f0d6d1${_scopeId}>${ssrInterpolate(message.time)}</span>`);
								if (getMessageStatus(message)) {
									_push(`<span class="${ssrRenderClass([getMessageStatus(message), "message-status"])}" data-v-31f0d6d1${_scopeId}>`);
									if (getMessageStatus(message) === "sending") _push(`<img src="/images/loading.svg" alt="Отправляется" class="status-icon spinning" data-v-31f0d6d1${_scopeId}>`);
									else if (getMessageStatus(message) === "sent") _push(`<img src="/images/check-mark.svg" alt="Отправлено" class="status-icon" data-v-31f0d6d1${_scopeId}>`);
										...
										"width": "16px",
										"height": "16px"
									})}" data-v-31f0d6d1${_scopeId}>`);
									else if (getMessageStatus(message) === "failed") _push(`<img src="/images/exclamation-circle.svg" alt="Не отправлено" class="status-icon" data-v-31f0d6d1${_scopeId}>`);
									else _push(`<!---->`);
									_push(`</span>`);
								} else _push(`<!---->`);
								_push(`</div></div></div>`);
							...
							if (showSkeleton.value) {
								_push(`<div class="${ssrRenderClass([{ fading: isSkeletonFading.value }, "chat-skeleton"])}" data-v-31f0d6d1${_scopeId}><!--[-->`);
								ssrRenderList(skeletonItems.value, (item, index) => {
									_push(`<div class="${ssrRenderClass([{ right: item.side === "right" }, "skeleton-message"])}" data-v-31f0d6d1${_scopeId}><div class="skeleton-avatar" data-v-31f0d6d1${_scopeId}></div><div class="skeleton-bubble" data-v-31f0d6d1${_scopeId}><div class="skeleton-line" style="${ssrRenderStyle({ width: item.lines[0] })}" data-v-31f0d6d1${_scopeId}></div><div class="skeleton-line short" style="${ssrRenderStyle({ width: item.lines[1] })}" data-v-31f0d6d1${_scopeId}></div>`);
									if (item.hasThirdLine) _push(`<div class="skeleton-line tiny" style="${ssrRenderStyle({ width: item.lines[2] })}" data-v-31f0d6d1${_scopeId}></div>`);
									else _push(`<!---->`);
									_push(`</div></div>`);
								});
								_push(`<!--]--></div>`);
							} else _push(`<!---->`);
							_push(`</div></div><form class="message-form" enctype="multipart/form-data" data-v-31f0d6d1${_scopeId}>`);
							if (editingMessage.value) _push(`<div class="editing-indicator" data-v-31f0d6d1${_scopeId}><span data-v-31f0d6d1${_scopeId}>Редактирование сообщения</span><button type="button" class="cancel-edit-btn" data-v-31f0d6d1${_scopeId}>✕</button></div>`);
							else _push(`<!---->`);
							if (replyingTo.value) _push(`<div class="reply-indicator" data-v-31f0d6d1${_scopeId}><div class="reply-preview" data-v-31f0d6d1${_scopeId}><span class="reply-name" data-v-31f0d6d1${_scopeId}>${ssrInterpolate(replyingTo.value.user.name)}</span><span class="reply-text" data-v-31f0d6d1${_scopeId}>${ssrInterpolate(replyingTo.value.content?.slice(0, 100))}</span></div><button type="button" class="cancel-reply-btn" data-v-31f0d6d1${_scopeId}>✕</button></div>`);
							else _push(`<!---->`);
							if (photoPreviewUrl.value || videoPreviewUrl.value || documentPreviewName.value) {
								_push(`<div class="image-preview-container" style="${ssrRenderStyle({ "display": "flex" })}" data-v-31f0d6d1${_scopeId}>`);
								if (photoPreviewUrl.value) _push(`<img${ssrRenderAttr("src", photoPreviewUrl.value)} alt="Превью" class="image-preview" data-v-31f0d6d1${_scopeId}>`);
								else _push(`<!---->`);
								if (videoPreviewUrl.value) _push(`<video${ssrRenderAttr("src", videoPreviewUrl.value)} class="video-preview" controls data-v-31f0d6d1${_scopeId}></video>`);
								else _push(`<!---->`);
								if (documentPreviewName.value) _push(`<div class="file-preview" data-v-31f0d6d1${_scopeId}> 📎 ${ssrInterpolate(documentPreviewName.value)}</div>`);
								else _push(`<!---->`);
								_push(`<div class="preview-actions" data-v-31f0d6d1${_scopeId}><button type="button" class="select-other-btn" data-v-31f0d6d1${_scopeId}> Выбрать другое </button>`);
								if (!editingMessage.value) _push(`<button type="button" class="cancel-preview-btn" data-v-31f0d6d1${_scopeId}> Отмена </button>`);
								else _push(`<!---->`);
								_push(`</div></div>`);
							} else _push(`<!---->`);
							_push(`<div class="message-input-container" data-v-31f0d6d1${_scopeId}>`);
							if (!editingMessage.value) _push(`<div class="add" data-v-31f0d6d1${_scopeId}><img src="/images/clip.svg" alt="Добавить вложение" data-v-31f0d6d1${_scopeId}><div class="add-select" data-v-31f0d6d1${_scopeId}><label data-v-31f0d6d1${_scopeId}> Фото <input type="file" name="photo" accept="image/*" data-v-31f0d6d1${_scopeId}></label><label data-v-31f0d6d1${_scopeId}> Видео <input type="file" name="video" accept="video/*" data-v-31f0d6d1${_scopeId}></label><label data-v-31f0d6d1${_scopeId}> Документ <input type="file" name="document" data-v-31f0d6d1${_scopeId}></label></div></div>`);
							else _push(`<!---->`);
							_push(`<textarea${ssrRenderAttr("placeholder", editingMessage.value ? "Редактируйте сообщение..." : "Введите сообщение...")} data-v-31f0d6d1${_scopeId}>${ssrInterpolate(unref(form).content)}</textarea><button type="submit"${ssrIncludeBooleanAttr(unref(form).processing || !canSend.value) ? " disabled" : ""} data-v-31f0d6d1${_scopeId}>${ssrInterpolate(editingMessage.value ? "Сохранить" : "Отправить")}</button></div></form><!--]-->`);
						} else _push(`<div class="chat-placeholder" data-v-31f0d6d1${_scopeId}><p data-v-31f0d6d1${_scopeId}>Выберите чат для начала общения</p></div>`);
						_push(`</div>`);
						if (showChatFiles.value) {
							_push(`<div class="chat-files-panel" data-v-31f0d6d1${_scopeId}><div class="chat-files-header" data-v-31f0d6d1${_scopeId}><h3 data-v-31f0d6d1${_scopeId}>Файлы чата</h3><button type="button" class="chat-files-close" data-v-31f0d6d1${_scopeId}><img src="/images/close.svg" alt="Закрыть" data-v-31f0d6d1${_scopeId}></button></div><div class="chat-files-tabs" data-v-31f0d6d1${_scopeId}><button type="button" class="${ssrRenderClass([{ active: chatFilesTab.value === "media" }, "chat-files-tab"])}" data-v-31f0d6d1${_scopeId}> Медиа </button><button type="button" class="${ssrRenderClass([{ active: chatFilesTab.value === "files" }, "chat-files-tab"])}" data-v-31f0d6d1${_scopeId}> Файлы </button><button type="button" class="${ssrRenderClass([{ active: chatFilesTab.value === "links" }, "chat-files-tab"])}" data-v-31f0d6d1${_scopeId}> Ссылки </button></div><div class="chat-files-content" data-v-31f0d6d1${_scopeId}>`);
							if (chatFilesTab.value === "media") {
								_push(`<div class="chat-files-media" data-v-31f0d6d1${_scopeId}>`);
								if (chatMediaFiles.value.length === 0) _push(`<div class="chat-files-empty" data-v-31f0d6d1${_scopeId}> Нет медиафайлов </div>`);
								else {
									_push(`<div class="chat-files-grid" data-v-31f0d6d1${_scopeId}><!--[-->`);
									ssrRenderList(chatMediaFiles.value, (media) => {
										_push(`<div class="chat-files-media-item" data-v-31f0d6d1${_scopeId}>`);
										if (media.type === "image") _push(`<img${ssrRenderAttr("src", media.url)} alt="Медиа" data-v-31f0d6d1${_scopeId}>`);
										else _push(`<video${ssrRenderAttr("src", media.url)} data-v-31f0d6d1${_scopeId}></video>`);
										if (media.type === "video") _push(`<div class="play-icon" data-v-31f0d6d1${_scopeId}>▶</div>`);
										else _push(`<!---->`);
										_push(`</div>`);
									});
									_push(`<!--]--></div>`);
							...
							if (chatFilesTab.value === "files") {
								_push(`<div class="chat-files-list" data-v-31f0d6d1${_scopeId}>`);
								if (chatDocFiles.value.length === 0) _push(`<div class="chat-files-empty" data-v-31f0d6d1${_scopeId}> Нет файлов </div>`);
								else {
									_push(`<div data-v-31f0d6d1${_scopeId}><!--[-->`);
									ssrRenderList(chatDocFiles.value, (file) => {
										_push(`<div class="chat-files-item" data-v-31f0d6d1${_scopeId}><button type="button" class="file-download-circle" data-v-31f0d6d1${_scopeId}><img src="/images/download.svg" alt="Скачать" data-v-31f0d6d1${_scopeId}></button><div class="file-info" data-v-31f0d6d1${_scopeId}><div class="file-name" data-v-31f0d6d1${_scopeId}>${ssrInterpolate(file.file_name)}</div><div class="file-size" data-v-31f0d6d1${_scopeId}>${ssrInterpolate(formatSize(file.file_size))}</div></div></div>`);
									});
									_push(`<!--]--></div>`);
								}
								_push(`</div>`);
							...
							if (chatFilesTab.value === "links") {
								_push(`<div class="chat-files-list" data-v-31f0d6d1${_scopeId}>`);
								if (chatLinks.value.length === 0) _push(`<div class="chat-files-empty" data-v-31f0d6d1${_scopeId}> Нет ссылок </div>`);
								else {
									_push(`<div data-v-31f0d6d1${_scopeId}><!--[-->`);
									ssrRenderList(chatLinks.value, (link) => {
										_push(`<div class="chat-files-link" data-v-31f0d6d1${_scopeId}><span class="link-text" data-v-31f0d6d1${_scopeId}>${ssrInterpolate(link.content)}</span><span class="link-time" data-v-31f0d6d1${_scopeId}>${ssrInterpolate(link.time)}</span></div>`);
									});
									_push(`<!--]--></div>`);
								}
								_push(`</div>`);
						...
						_push(`</div>`);
						if (modalOpen.value && modalImage.value) _push(`<div class="modal-overlay" style="${ssrRenderStyle({ "display": "flex" })}" data-v-31f0d6d1${_scopeId}><div class="modal-content" data-v-31f0d6d1${_scopeId}><button class="modal-close" type="button" data-v-31f0d6d1${_scopeId}> × </button><img${ssrRenderAttr("src", modalImage.value)} alt="Предпросмотр" data-v-31f0d6d1${_scopeId}></div></div>`);
						else _push(`<!---->`);
						if (modalOpen.value && modalVideo.value) _push(`<div class="modal-overlay" style="${ssrRenderStyle({ "display": "flex" })}" data-v-31f0d6d1${_scopeId}><div class="modal-content modal-video-content" data-v-31f0d6d1${_scopeId}><button class="modal-close" type="button" data-v-31f0d6d1${_scopeId}> × </button><video${ssrRenderAttr("src", modalVideo.value)} controls autoplay class="modal-video" data-v-31f0d6d1${_scopeId}></video></div></div>`);
						else _push(`<!---->`);
						if (contextMenu.value.show) {
							...
							if (!contextMenu.value.message?.is_mine) _push(`<div class="context-menu-item" data-v-31f0d6d1${_scopeId}> Ответить </div>`);
							else _push(`<!---->`);
							if (contextMenu.value.message?.is_mine) _push(`<div class="context-menu-item" data-v-31f0d6d1${_scopeId}> Редактировать </div>`);
							else _push(`<!---->`);
							if (contextMenu.value.message?.is_mine) _push(`<div class="context-menu-item" data-v-31f0d6d1${_scopeId}> Удалить у меня </div>`);
							else _push(`<!---->`);
							if (contextMenu.value.message?.is_mine) _push(`<div class="context-menu-item delete" data-v-31f0d6d1${_scopeId}> Удалить у всех </div>`);
							else _push(`<!---->`);
							_push(`</div>`);
						} else _push(`<!---->`);
						if (selectedMessages.value.length > 0) {
							_push(`<div class="selection-toolbar" data-v-31f0d6d1${_scopeId}><span data-v-31f0d6d1${_scopeId}>${ssrInterpolate(selectedMessages.value.length)} выбрано</span>`);
							if (showReplyBtn.value) _push(`<button type="button" class="selection-reply-btn" data-v-31f0d6d1${_scopeId}> Ответить </button>`);
							else _push(`<!---->`);
							if (showDeleteForEveryone.value) _push(`<button type="button" class="selection-delete-btn" data-v-31f0d6d1${_scopeId}> Удалить </button>`);
							else _push(`<!---->`);
							if (showDeleteForMe.value) _push(`<button type="button" class="selection-delete-me-btn" data-v-31f0d6d1${_scopeId}> Удалить у меня </button>`);
							else _push(`<!---->`);
							_push(`<button type="button" class="selection-clear-btn" data-v-31f0d6d1${_scopeId}> Отмена </button></div>`);
						} else _push(`<!---->`);
						if (showPriceModal.value) _push(`<div class="modal-overlay" style="${ssrRenderStyle({ "display": "flex" })}" data-v-31f0d6d1${_scopeId}><div class="price-modal" data-v-31f0d6d1${_scopeId}><div class="price-modal-header" data-v-31f0d6d1${_scopeId}><h3 data-v-31f0d6d1${_scopeId}>Предложить новую цену</h3><button type="button" class="modal-close" data-v-31f0d6d1${_scopeId}><img src="/images/close.svg" alt="Закрыть" data-v-31f0d6d1${_scopeId}></button></div><form data-v-31f0d6d1${_scopeId}><div class="price-modal-body" data-v-31f0d6d1${_scopeId}><label for="new-price" data-v-31f0d6d1${_scopeId}>Новая цена (₽):</label><input id="new-price"${ssrRenderAttr("value", priceForm.value.proposed_price)} type="number" min="0" max="9999999999" placeholder="Введите сумму" required data-v-31f0d6d1${_scopeId}></div><div class="price-modal-footer" data-v-31f0d6d1${_scopeId}><button type="button" class="cancel-btn" data-v-31f0d6d1${_scopeId}>Отмена</button><button type="submit" class="submit-btn" data-v-31f0d6d1${_scopeId}>Предложить</button></div></form></div></div>`);
						else _push(`<!---->`);
						if (priceChangeModal.value.show) _push(`<div class="modal-overlay" style="${ssrRenderStyle({ "display": "flex" })}" data-v-31f0d6d1${_scopeId}><div class="price-modal" data-v-31f0d6d1${_scopeId}><div class="price-modal-header" data-v-31f0d6d1${_scopeId}><h3 data-v-31f0d6d1${_scopeId}>Предложить новую цену</h3><button type="button" class="modal-close" data-v-31f0d6d1${_scopeId}><img src="/images/close.svg" alt="Закрыть" data-v-31f0d6d1${_scopeId}></button></div><form data-v-31f0d6d1${_scopeId}><div class="price-modal-body" data-v-31f0d6d1${_scopeId}><p class="price-modal-info" data-v-31f0d6d1${_scopeId}>Текущее предложение: ${ssrInterpolate(priceChangeModal.value.message?.proposed_price)} ₽</p><label for="new-price-change" data-v-31f0d6d1${_scopeId}>Новая цена (₽):</label><input id="new-price-change"${ssrRenderAttr("value", priceChangeModal.value.newPrice)} type="number" min="0" max="9999999999" placeholder="Введите сумму" required data-v-31f0d6d1${_scopeId}></div><div class="price-modal-footer" data-v-31f0d6d1${_scopeId}><button type="button" class="cancel-btn" data-v-31f0d6d1${_scopeId}>Отмена</button><button type="submit" class="submit-btn" data-v-31f0d6d1${_scopeId}>Предложить</button></div></form></div></div>`);
						else _push(`<!---->`);
						if (openDisputeModal.value) _push(`<div class="modal-overlay" style="${ssrRenderStyle({ "display": "flex" })}" data-v-31f0d6d1${_scopeId}><div class="price-modal" data-v-31f0d6d1${_scopeId}><div class="price-modal-header" data-v-31f0d6d1${_scopeId}><h3 data-v-31f0d6d1${_scopeId}>Открыть спор</h3><button type="button" class="modal-close" data-v-31f0d6d1${_scopeId}><img src="/images/close.svg" alt="Закрыть" data-v-31f0d6d1${_scopeId}></button></div><form data-v-31f0d6d1${_scopeId}><div class="price-modal-body" data-v-31f0d6d1${_scopeId}><label for="dispute-reason" data-v-31f0d6d1${_scopeId}>Причина спора:</label><textarea id="dispute-reason" rows="5" minlength="10" maxlength="5000" placeholder="Опишите причину спора (минимум 10 символов)" required data-v-31f0d6d1${_scopeId}>${ssrInterpolate(disputeForm.value.reason)}</textarea></div><div class="price-modal-footer" data-v-31f0d6d1${_scopeId}><button type="button" class="cancel-btn" data-v-31f0d6d1${_scopeId}>Отмена</button><button type="submit" class="submit-btn" data-v-31f0d6d1${_scopeId}>Отправить</button></div></form></div></div>`);
						else _push(`<!---->`);
						if (openCancelModal.value) _push(`<div class="modal-overlay" style="${ssrRenderStyle({ "display": "flex" })}" data-v-31f0d6d1${_scopeId}><div class="price-modal" data-v-31f0d6d1${_scopeId}><div class="price-modal-header" data-v-31f0d6d1${_scopeId}><h3 data-v-31f0d6d1${_scopeId}>Отмена сделки</h3><button type="button" class="modal-close" data-v-31f0d6d1${_scopeId}><img src="/images/close.svg" alt="Закрыть" data-v-31f0d6d1${_scopeId}></button></div><form data-v-31f0d6d1${_scopeId}><div class="price-modal-body" data-v-31f0d6d1${_scopeId}><label for="cancel-reason" data-v-31f0d6d1${_scopeId}>Причина отмены:</label><textarea id="cancel-reason" rows="5" minlength="5" maxlength="5000" placeholder="Опишите причину отмены (минимум 5 символов)" required data-v-31f0d6d1${_scopeId}>${ssrInterpolate(cancelForm.value.reason)}</textarea></div><div class="price-modal-footer" data-v-31f0d6d1${_scopeId}><button type="button" class="cancel-btn" data-v-31f0d6d1${_scopeId}>Назад</button><button type="submit" class="reject-btn" data-v-31f0d6d1${_scopeId}>Подтвердить отмену</button></div></form></div></div>`);
						else _push(`<!---->`);
					} else return [
							...
							createVNode("div", {
								...
								createVNode("div", { class: "chat-header" }, [
									...
									createVNode("img", {
										...
										src: "/images/dots.svg",
										alt: "опции",
										onClick: withModifiers(($event) => toggleOptionsMenu($event), ["stop"])
									}, null, 8, ["onClick"])
								]),
								...
								}, "Файлы чата"), createVNode("div", {
									class: "options-menu-item",
									onClick: handleSearchChat
								}, "Поиск по чату")], 4)) : createCommentVNode("", true),
								...
								createVNode("div", {
									...
									default: withCtx(() => [(openBlock(true), createBlock(Fragment, null, renderList(localMessages.value, (message, index) => {
										return openBlock(), createBlock("div", {
											...
											message.reply_to ? (openBlock(), createBlock("div", {
												key: 2,
												class: "reply-quote"
											}, [createVNode("div", { class: "reply-quote-author" }, toDisplayString(message.reply_to.user.name), 1), createVNode("div", { class: "reply-quote-text" }, toDisplayString(message.reply_to.content?.slice(0, 100)), 1)])) : createCommentVNode("", true),
											createVNode("div", {
								...
								createVNode("form", {
									...
									replyingTo.value ? (openBlock(), createBlock("div", {
										key: 1,
										class: "reply-indicator"
									}, [createVNode("div", { class: "reply-preview" }, [createVNode("span", { class: "reply-name" }, toDisplayString(replyingTo.value.user.name), 1), createVNode("span", { class: "reply-text" }, toDisplayString(replyingTo.value.content?.slice(0, 100)), 1)]), createVNode("button", {
										type: "button",
						...
						contextMenu.value.show ? (openBlock(), createBlock("div", {
							...
							contextMenu.value.message?.is_mine ? (openBlock(), createBlock("div", {
								key: 2,
								class: "context-menu-item",
								onClick: ($event) => deleteMessage(contextMenu.value.message, "me")
							}, " Удалить у меня ", 8, ["onClick"])) : createCommentVNode("", true),
							contextMenu.value.message?.is_mine ? (openBlock(), createBlock("div", {
								key: 3,
								class: "context-menu-item delete",
								onClick: ($event) => deleteMessage(contextMenu.value.message, "everyone")
							}, " Удалить у всех ", 8, ["onClick"])) : createCommentVNode("", true)
						...
						selectedMessages.value.length > 0 ? (openBlock(), createBlock("div", {
							...
							showReplyBtn.value ? (openBlock(), createBlock("button", {
								key: 0,
								type: "button",
								class: "selection-reply-btn",
								onClick: replyToSelected
							}, " Ответить ")) : createCommentVNode("", true),
							showDeleteForEveryone.value ? (openBlock(), createBlock("button", {
								key: 1,
								type: "button",
								class: "selection-delete-btn",
								onClick: deleteSelectedMessages
							}, " Удалить ")) : createCommentVNode("", true),
							showDeleteForMe.value ? (openBlock(), createBlock("button", {
								key: 2,
								type: "button",
								class: "selection-delete-me-btn",
								onClick: deleteForMe
							}, " Удалить у меня ")) : createCommentVNode("", true),
							createVNode("button", {
								type: "button",
...
var Chats_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$15, [["__scopeId", "data-v-31f0d6d1"]]);
//#endregion
			...
			_push(ssrRenderComponent(AppLayout_default, _attrs, {
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						_push(`<div class="disputes-page" data-v-043f1faa${_scopeId}><div class="page-header" data-v-043f1faa${_scopeId}><h1 data-v-043f1faa${_scopeId}>Управление спорами</h1></div>`);
						if (__props.disputes && __props.disputes.data && __props.disputes.data.length > 0) {
							_push(`<div class="disputes-list" data-v-043f1faa${_scopeId}><!--[-->`);
							ssrRenderList(__props.disputes.data, (dispute) => {
								_push(`<div class="dispute-card" data-v-043f1faa${_scopeId}><div class="dispute-header" data-v-043f1faa${_scopeId}><div class="${ssrRenderClass([dispute.status, "dispute-status"])}" data-v-043f1faa${_scopeId}>${ssrInterpolate(getStatusLabel(dispute.status))}</div><div class="dispute-date" data-v-043f1faa${_scopeId}>${ssrInterpolate(formatDate(dispute.created_at))}</div></div><div class="dispute-body" data-v-043f1faa${_scopeId}><div class="dispute-initiator" data-v-043f1faa${_scopeId}><strong data-v-043f1faa${_scopeId}>Инициатор:</strong> ${ssrInterpolate(dispute.initiator?.name || "Неизвестно")}</div>`);
								if (dispute.application) _push(`<div class="dispute-application" data-v-043f1faa${_scopeId}><strong data-v-043f1faa${_scopeId}>Вакансия:</strong> ${ssrInterpolate(dispute.application.vacancy?.position || "Неизвестно")}</div>`);
								else _push(`<!---->`);
								_push(`<div class="dispute-reason" data-v-043f1faa${_scopeId}><strong data-v-043f1faa${_scopeId}>Причина:</strong><p data-v-043f1faa${_scopeId}>${ssrInterpolate(dispute.reason)}</p></div>`);
								if (dispute.admin) _push(`<div class="dispute-admin" data-v-043f1faa${_scopeId}><strong data-v-043f1faa${_scopeId}>Администратор:</strong> ${ssrInterpolate(dispute.admin.name)}</div>`);
								else _push(`<!---->`);
								if (dispute.resolution) _push(`<div class="dispute-resolution" data-v-043f1faa${_scopeId}><strong data-v-043f1faa${_scopeId}>Решение:</strong><p data-v-043f1faa${_scopeId}>${ssrInterpolate(dispute.resolution)}</p></div>`);
								else _push(`<!---->`);
								_push(`</div><div class="dispute-actions" data-v-043f1faa${_scopeId}>`);
								if (dispute.status === "open") {
									_push(`<!--[-->`);
									if (!dispute.admin_id) _push(`<button class="btn-take"${ssrIncludeBooleanAttr(processing.value === dispute.id) ? " disabled" : ""} data-v-043f1faa${_scopeId}>${ssrInterpolate(processing.value === dispute.id ? "Принимаем..." : "Взять в работу")}</button>`);
									else _push(`<button class="btn-resolve" data-v-043f1faa${_scopeId}> Вынести решение </button>`);
									_push(`<!--]-->`);
								} else _push(`<!---->`);
								_push(`<button class="btn-chat" data-v-043f1faa${_scopeId}> Перейти в чат </button></div></div>`);
							});
							_push(`<!--]--></div>`);
						} else _push(`<div class="no-disputes" data-v-043f1faa${_scopeId}><p data-v-043f1faa${_scopeId}>Нет открытых споров</p></div>`);
						if (__props.disputes && __props.disputes.last_page > 1) {
							_push(`<div class="pagination" data-v-043f1faa${_scopeId}>`);
							if (__props.disputes.current_page > 1) _push(`<button class="pagination-btn" data-v-043f1faa${_scopeId}> ← Назад </button>`);
							else _push(`<!---->`);
							_push(`<span class="pagination-info" data-v-043f1faa${_scopeId}> Страница ${ssrInterpolate(__props.disputes.current_page)} из ${ssrInterpolate(__props.disputes.last_page)}</span>`);
							if (__props.disputes.current_page < __props.disputes.last_page) _push(`<button class="pagination-btn" data-v-043f1faa${_scopeId}> Вперёд → </button>`);
							else _push(`<!---->`);
							_push(`</div>`);
						} else _push(`<!---->`);
						if (resolveModal.value.show) {
							_push(`<div class="modal-overlay" data-v-043f1faa${_scopeId}><div class="resolve-modal" data-v-043f1faa${_scopeId}><div class="modal-header" data-v-043f1faa${_scopeId}><h3 data-v-043f1faa${_scopeId}>Вынести решение по спору</h3><button class="modal-close" data-v-043f1faa${_scopeId}>×</button></div><form data-v-043f1faa${_scopeId}><div class="modal-body" data-v-043f1faa${_scopeId}><label for="resolution" data-v-043f1faa${_scopeId}>Решение:</label><textarea id="resolution" rows="5" minlength="10" required placeholder="Опишите ваше решение (минимум 10 символов)" data-v-043f1faa${_scopeId}>${ssrInterpolate(resolveModal.value.resolution)}</textarea><label for="outcome" style="${ssrRenderStyle({
								"margin-top": "16px",
								"display": "block"
							})}" data-v-043f1faa${_scopeId}>Исход:</label><select id="outcome" required style="${ssrRenderStyle({
								"width": "100%",
								"padding": "10px",
								"border-radius": "8px",
								"border": "1px solid #ddd"
							})}" data-v-043f1faa${_scopeId}><option value="completed" data-v-043f1faa${ssrIncludeBooleanAttr(Array.isArray(resolveModal.value.outcome) ? ssrLooseContain(resolveModal.value.outcome, "completed") : ssrLooseEqual(resolveModal.value.outcome, "completed")) ? " selected" : ""}${_scopeId}>Завершить сделку (перевести средства исполнителю)</option><option value="cancelled" data-v-043f1faa${ssrIncludeBooleanAttr(Array.isArray(resolveModal.value.outcome) ? ssrLooseContain(resolveModal.value.outcome, "cancelled") : ssrLooseEqual(resolveModal.value.outcome, "cancelled")) ? " selected" : ""}${_scopeId}>Отменить сделку (возврат заказчику)</option></select>`);
							if (resolveModal.value.outcome === "cancelled") _push(`<div style="${ssrRenderStyle({ "margin-top": "16px" })}" data-v-043f1faa${_scopeId}><label for="refund_amount" data-v-043f1faa${_scopeId}>Сумма возврата заказчику (оставьте пустым для полного возврата):</label><input id="refund_amount"${ssrRenderAttr("value", resolveModal.value.refundAmount)} type="number" min="0" placeholder="Введите сумму возврата" style="${ssrRenderStyle({
								"width": "100%",
								"padding": "10px",
								"border-radius": "8px",
								"border": "1px solid #ddd",
								"margin-top": "8px"
							})}" data-v-043f1faa${_scopeId}><small data-v-043f1faa${_scopeId}>Остаток будет переведён исполнителю как частичная оплата.</small></div>`);
							else _push(`<!---->`);
							_push(`</div><div class="modal-footer" data-v-043f1faa${_scopeId}><button type="button" class="btn-cancel" data-v-043f1faa${_scopeId}>Отмена</button><button type="submit" class="btn-submit" data-v-043f1faa${_scopeId}>Отправить решение</button></div></form></div></div>`);
						} else _push(`<!---->`);
						_push(`</div>`);
...
var Index_default$1 = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$14, [["__scopeId", "data-v-043f1faa"]]);
//#endregion
...
var _sfc_main$13 = {
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<div${ssrRenderAttrs(mergeProps({ class: "post" }, _attrs))} data-v-011c0421><div class="badges" data-v-011c0421>`);
			if (__props.post.is_vacancy) _push(`<div class="vacancy-badge" data-v-011c0421>Вакансия</div>`);
			else _push(`<!---->`);
			if (__props.post.active === false && __props.post.status !== "closed") _push(`<div class="hidden-badge" title="Этот пост видите только вы" data-v-011c0421><img src="/images/blind.svg" alt="Скрыто" data-v-011c0421></div>`);
			else _push(`<!---->`);
			if (__props.post.status === "closed") _push(`<div class="closed-badge" data-v-011c0421>Завершено</div>`);
			else _push(`<!---->`);
			_push(`</div>`);
			_push(ssrRenderComponent(unref(Link), { href: __props.post.show_url }, {
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) if (__props.post.image_url) _push(`<img${ssrRenderAttr("src", __props.post.image_url)}${ssrRenderAttr("alt", __props.post.title)} data-v-011c0421${_scopeId}>`);
					else _push(`<!---->`);
			...
			_push(`<div class="post-content" data-v-011c0421><div class="post-body" data-v-011c0421>`);
			_push(ssrRenderComponent(unref(Link), { href: __props.post.show_url }, {
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<h3 class="title" data-v-011c0421${_scopeId}>${ssrInterpolate(__props.post.is_vacancy && __props.post.vacancy?.position ? __props.post.vacancy.position : __props.post.title)}</h3>`);
					else return [createVNode("h3", { class: "title" }, toDisplayString(__props.post.is_vacancy && __props.post.vacancy?.position ? __props.post.vacancy.position : __props.post.title), 1)];
				}),
				_: 1
			}, _parent));
			_push(`<p class="description" data-v-011c0421>${ssrInterpolate(__props.post.is_vacancy && __props.post.vacancy?.requirements ? __props.post.vacancy.requirements : __props.post.description)}</p>`);
			if (__props.post.is_vacancy && __props.post.vacancy?.skills?.length) {
				_push(`<div class="post-skills" data-v-011c0421><!--[-->`);
				ssrRenderList(__props.post.vacancy.skills, (skill) => {
					_push(`<span class="${ssrRenderClass([unref(getSkillClass)(skill.name), "skill-tag"])}" data-v-011c0421><span class="skill-name" data-v-011c0421>${ssrInterpolate(skill.name)}</span></span>`);
				});
				_push(`<!--]--></div>`);
			} else _push(`<!---->`);
			_push(`</div><div class="post-footer" data-v-011c0421><small data-v-011c0421> Автор: `);
			_push(ssrRenderComponent(unref(Link), {
			...
			_push(`</small><div class="post-actions" data-v-011c0421><button type="button" class="${ssrRenderClass({ liked: isLiked.value })}" id="like" data-v-011c0421>${ssrInterpolate(isLiked.value ? "❤️" : "🤍")} ${ssrInterpolate(localLikes.value)}</button></div></div></div></div>`);
		};
	}
};
...
var Post_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$13, [["__scopeId", "data-v-011c0421"]]);
//#endregion
//#region resources/js/Pages/Home.vue
var Home_exports = /* @__PURE__ */ __exportAll({ default: () => Home_default });
var _sfc_main$12 = /* @__PURE__ */ Object.assign({ layout: AppLayout_default }, {
	__name: "Home",
	__ssrInlineRender: true,
	props: {
		posts: {
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(`<div class="block1" data-v-e3e8f474><img${ssrRenderAttr("src", unref(isDark) ? "/images/nightEarth.png" : "/images/Earth.png")} alt="Earth" class="hero-image" data-v-e3e8f474><h1 class="hero-title" data-v-e3e8f474><span class="visket-text" data-v-e3e8f474> V<span class="letter-i"${ssrRenderAttr("title", unref(isDark) ? "переключить на светлую тему" : "переключить на темную тему")} data-v-e3e8f474> I <svg class="sun-svg" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-e3e8f474><circle cx="12" cy="12" r="5" fill="currentColor" data-v-e3e8f474></circle><path d="M12 2V4M12 20V22M4.93 4.93L6.34 6.34M17.66 17.66L19.07 19.07M2 12H4M20 12H22M4.93 19.07L6.34 17.66M17.66 6.34L19.07 4.93" stroke="currentColor" stroke-width="2" stroke-linecap="round" data-v-e3e8f474></path></svg></span>SKET </span> — место, где работа находит работника<br data-v-e3e8f474>и наоборот. </h1></div><div class="block2" data-v-e3e8f474><button class="filter-toggle" data-v-e3e8f474> Фильтры <span data-v-e3e8f474>${ssrInterpolate(filtersVisible.value ? "▼" : "▶")}</span></button><div class="search-container" data-v-e3e8f474><input class="searchbar"${ssrRenderAttr("value", query.value)} type="text" placeholder="Поиск по постам" data-v-e3e8f474><div class="view-mode-toggle" data-v-e3e8f474><button class="${ssrRenderClass([{ active: viewMode.value === "grid" }, "view-mode-btn"])}" type="button" data-v-e3e8f474><img src="/images/grid-view.svg" alt="Сетка" data-v-e3e8f474></button><button class="${ssrRenderClass([{ active: viewMode.value === "list" }, "view-mode-btn"])}" type="button" data-v-e3e8f474><img src="/images/list-view.svg" alt="Список" data-v-e3e8f474></button></div></div></div><div class="${ssrRenderClass([{ filtersOpen: filtersVisible.value }, "content-wrapper"])}" data-v-e3e8f474>`);
			if (filtersVisible.value) _push(`<div class="filters-overlay-mobile" data-v-e3e8f474></div>`);
			else _push(`<!---->`);
			_push(`<div class="filterscontainer" data-v-e3e8f474><div class="filters" data-v-e3e8f474><div class="filter-group" data-v-e3e8f474><label data-v-e3e8f474>Тип:</label><div class="type-selector" data-v-e3e8f474><button class="${ssrRenderClass({ active: typeFilter.value === "" })}" data-v-e3e8f474> Все </button><button class="${ssrRenderClass({ active: typeFilter.value === "vacancy" })}" data-v-e3e8f474> Вакансии </button><button class="${ssrRenderClass({ active: typeFilter.value === "post" })}" data-v-e3e8f474> Посты </button></div></div><div class="filter-group" data-v-e3e8f474><label data-v-e3e8f474>Бюджет:</label><div class="budget-inputs" data-v-e3e8f474><input type="number"${ssrRenderAttr("value", budgetFrom.value)} placeholder="От" class="budget-input" min="0" data-v-e3e8f474><input type="number"${ssrRenderAttr("value", budgetTo.value)} placeholder="До" class="budget-input" min="0" data-v-e3e8f474></div></div><div class="filter-group" data-v-e3e8f474><label data-v-e3e8f474>Навыки:</label>`);
			_push(ssrRenderComponent(SkillsSelector_default, {
				modelValue: selectedSkills.value,
				"onUpdate:modelValue": ($event) => selectedSkills.value = $event,
				skills: __props.skills
			}, null, _parent));
			_push(`</div></div></div><div class="main-wrapper" data-v-e3e8f474><div class="tabs" data-v-e3e8f474><button class="${ssrRenderClass({ active: activeTab.value === "all" })}" data-v-e3e8f474> Все посты </button><button class="${ssrRenderClass({ active: activeTab.value === "foryou" })}" data-v-e3e8f474> Для вас </button></div><div class="${ssrRenderClass([{ "list-mode": viewMode.value === "list" }, "posts"])}" data-v-e3e8f474>`);
			if (displayedPosts.value.length > 0) {
				...
				if (activeTab.value === "foryou" && !authUser.value) {
					_push(`<p class="empty-message" data-v-e3e8f474> Чтобы подобрать для вас лучшую работу — `);
					...
					_push(`</p>`);
				} else _push(`<p class="empty-message" data-v-e3e8f474>Пока ничего нет</p>`);
				_push(`<!--]-->`);
			}
			_push(`</div></div></div><!--]-->`);
		};
...
var Home_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$12, [["__scopeId", "data-v-e3e8f474"]]);
//#endregion
...
var _sfc_main$11 = {
	...
	setup(__props) {
		...
		const title = computed(() => {
			if (props.status === "success") return "Оплата прошла успешно!";
			if (props.status === "pending") return "Платёж обрабатывается";
			return "Ошибка оплаты";
		});
		const message = computed(() => {
			if (props.status === "success") return "Средства будут зачислены на ваш баланс в ближайшее время.";
			if (props.status === "pending") return "Платёж ещё не подтверждён. Проверьте статус в истории транзакций.";
			return "Что-то пошло не так. Пожалуйста, попробуйте ещё раз.";
		});
		const linkHref = computed(() => "/balance");
		const linkText = computed(() => "Вернуться к балансу");
		return (_ctx, _push, _parent, _attrs) => {
			_push(ssrRenderComponent(AppLayout_default, _attrs, {
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(ssrRenderComponent(unref(Head), { title: title.value }, null, _parent, _scopeId));
						_push(`<div class="payment-result-page" data-v-5e9ad132${_scopeId}><div class="result-card" data-v-5e9ad132${_scopeId}><div class="${ssrRenderClass([__props.status, "icon"])}" data-v-5e9ad132${_scopeId}>`);
						if (__props.status === "success") _push(`<!--[-->✓<!--]-->`);
						else if (__props.status === "pending") _push(`<!--[-->⌛<!--]-->`);
						else _push(`<!--[-->✗<!--]-->`);
						_push(`</div><h1 class="title" data-v-5e9ad132${_scopeId}>${ssrInterpolate(title.value)}</h1><p class="message" data-v-5e9ad132${_scopeId}>${ssrInterpolate(message.value)}</p>`);
						if (__props.amount) _push(`<p class="amount" data-v-5e9ad132${_scopeId}>${ssrInterpolate(Number(__props.amount).toLocaleString("ru-RU"))} ₽</p>`);
						else _push(`<!---->`);
						_push(ssrRenderComponent(unref(Link), {
							href: linkHref.value,
							class: "btn-back"
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) _push(`${ssrInterpolate(linkText.value)}`);
								else return [createTextVNode(toDisplayString(linkText.value), 1)];
							}),
							_: 1
						}, _parent, _scopeId));
						_push(`</div></div>`);
					} else return [createVNode(unref(Head), { title: title.value }, null, 8, ["title"]), createVNode("div", { class: "payment-result-page" }, [createVNode("div", { class: "result-card" }, [
						createVNode("div", { class: ["icon", __props.status] }, [__props.status === "success" ? (openBlock(), createBlock(Fragment, { key: 0 }, [createTextVNode("✓")], 64)) : __props.status === "pending" ? (openBlock(), createBlock(Fragment, { key: 1 }, [createTextVNode("⌛")], 64)) : (openBlock(), createBlock(Fragment, { key: 2 }, [createTextVNode("✗")], 64))], 2),
						createVNode("h1", { class: "title" }, toDisplayString(title.value), 1),
						createVNode("p", { class: "message" }, toDisplayString(message.value), 1),
						__props.amount ? (openBlock(), createBlock("p", {
							key: 0,
							class: "amount"
						}, toDisplayString(Number(__props.amount).toLocaleString("ru-RU")) + " ₽", 1)) : createCommentVNode("", true),
						createVNode(unref(Link), {
							href: linkHref.value,
							class: "btn-back"
						}, {
							default: withCtx(() => [createTextVNode(toDisplayString(linkText.value), 1)]),
							_: 1
						}, 8, ["href"])
					])])];
				}),
...
_sfc_main$11.setup = (props, ctx) => {
	const ssrContext = useSSRContext();
	(ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Payment/Result.vue");
	return _sfc_setup$11 ? _sfc_setup$11(props, ctx) : void 0;
};
var Result_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$11, [["__scopeId", "data-v-5e9ad132"]]);
//#endregion
			...
			_push(ssrRenderComponent(AppLayout_default, _attrs, {
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						_push(`<div class="create-post-page" data-v-b898cdf3${_scopeId}><form data-v-b898cdf3${_scopeId}><div class="post-type-toggle" data-v-b898cdf3${_scopeId}><button type="button" class="${ssrRenderClass({ active: postType.value === "regular" })}" data-v-b898cdf3${_scopeId}> Обычный пост </button><button type="button" class="${ssrRenderClass({ active: postType.value === "vacancy" })}" data-v-b898cdf3${_scopeId}> Вакансия </button></div><div class="block" data-v-b898cdf3${_scopeId}><div class="${ssrRenderClass([{ "has-image": imagePreview.value }, "image-container"])}" data-v-b898cdf3${_scopeId}><input type="file" accept="image/*" style="${ssrRenderStyle({ "display": "none" })}" data-v-b898cdf3${_scopeId}>`);
						if (!imagePreview.value) _push(`<div class="${ssrRenderClass([{ dragging: isDragging.value }, "upload-area"])}" data-v-b898cdf3${_scopeId}><div class="upload-instructions" data-v-b898cdf3${_scopeId}><p data-v-b898cdf3${_scopeId}>Перетащите изображение сюда или кликните для выбора</p><button type="button" class="upload-button" data-v-b898cdf3${_scopeId}>+</button></div></div>`);
						else _push(`<img${ssrRenderAttr("src", imagePreview.value)} class="post-image" data-v-b898cdf3${_scopeId}>`);
						if (imagePreview.value) _push(`<div class="image-overlay" data-v-b898cdf3${_scopeId}><button type="button" class="change-image-btn" data-v-b898cdf3${_scopeId}> Изменить фото </button></div>`);
						else _push(`<!---->`);
						_push(`</div><div class="content-wrapper" data-v-b898cdf3${_scopeId}><div class="desc" data-v-b898cdf3${_scopeId}>`);
						if (postType.value === "regular") _push(`<!--[--><input type="text"${ssrRenderAttr("value", unref(form).title)} placeholder="Заголовок поста" required class="title-input" data-v-b898cdf3${_scopeId}><textarea placeholder="Описание поста" required class="description-textarea" data-v-b898cdf3${_scopeId}>${ssrInterpolate(unref(form).description)}</textarea><!--]-->`);
						else _push(`<!---->`);
						if (postType.value === "vacancy") {
							_push(`<div class="vacancy-fields" data-v-b898cdf3${_scopeId}><div class="form-row" data-v-b898cdf3${_scopeId}><div class="form-group" data-v-b898cdf3${_scopeId}><label for="position" data-v-b898cdf3${_scopeId}>Должность</label><input type="text"${ssrRenderAttr("value", unref(form).position)} id="position" placeholder="Например: PHP разработчик" data-v-b898cdf3${_scopeId}></div></div><div class="form-row two-cols" data-v-b898cdf3${_scopeId}><div class="form-group" data-v-b898cdf3${_scopeId}><label for="budget_min" data-v-b898cdf3${_scopeId}>Бюджет от</label><input type="number"${ssrRenderAttr("value", unref(form).budget_min)} id="budget_min" placeholder="1000" data-v-b898cdf3${_scopeId}></div><div class="form-group" data-v-b898cdf3${_scopeId}><label for="budget_max" data-v-b898cdf3${_scopeId}>Бюджет до</label><input type="number"${ssrRenderAttr("value", unref(form).budget_max)} id="budget_max" placeholder="5000" data-v-b898cdf3${_scopeId}></div></div><div class="form-row" data-v-b898cdf3${_scopeId}><div class="form-group" data-v-b898cdf3${_scopeId}><label for="deadline" data-v-b898cdf3${_scopeId}>Срок выполнения</label><input type="date"${ssrRenderAttr("value", unref(form).deadline)} id="deadline" data-v-b898cdf3${_scopeId}></div></div><div class="form-row" data-v-b898cdf3${_scopeId}><div class="form-group" data-v-b898cdf3${_scopeId}><label data-v-b898cdf3${_scopeId}>Требуемые навыки</label>`);
							_push(ssrRenderComponent(SkillsSelector_default, {
								skills: __props.skills,
								modelValue: unref(form).skills,
								"onUpdate:modelValue": ($event) => unref(form).skills = $event
							}, null, _parent, _scopeId));
							_push(`</div></div><div class="form-row" data-v-b898cdf3${_scopeId}><div class="form-group" data-v-b898cdf3${_scopeId}><label for="requirements" data-v-b898cdf3${_scopeId}>Требования</label><textarea id="requirements" placeholder="Опишите требования к исполнителю..." class="requirements-textarea" data-v-b898cdf3${_scopeId}>${ssrInterpolate(unref(form).requirements)}</textarea></div></div></div>`);
						} else _push(`<!---->`);
						_push(`<div class="form-actions" data-v-b898cdf3${_scopeId}><button type="submit" class="submit-button"${ssrIncludeBooleanAttr(unref(form).processing || !unref(form).image) ? " disabled" : ""} data-v-b898cdf3${_scopeId}>${ssrInterpolate(unref(form).processing ? "Публикация..." : postType.value === "vacancy" ? "Опубликовать вакансию" : "Опубликовать")}</button></div></div></div></div></form></div>`);
...
var Create_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$10, [["__scopeId", "data-v-b898cdf3"]]);
//#endregion
			...
			_push(ssrRenderComponent(AppLayout_default, _attrs, {
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						_push(`<div class="edit-post-page" data-v-a39f7ad5${_scopeId}><form data-v-a39f7ad5${_scopeId}><div class="block" data-v-a39f7ad5${_scopeId}><div class="image-container" data-v-a39f7ad5${_scopeId}><input type="file" accept="image/*" style="${ssrRenderStyle({ "display": "none" })}" data-v-a39f7ad5${_scopeId}>`);
						if (imagePreview.value) _push(`<img${ssrRenderAttr("src", imagePreview.value)} class="post-image" data-v-a39f7ad5${_scopeId}>`);
						else _push(`<div class="no-image" data-v-a39f7ad5${_scopeId}><span data-v-a39f7ad5${_scopeId}>Изображение отсутствует</span></div>`);
						if (imagePreview.value) _push(`<div class="image-overlay" data-v-a39f7ad5${_scopeId}><button type="button" class="change-image-btn" data-v-a39f7ad5${_scopeId}> Изменить фото </button></div>`);
						else _push(`<!---->`);
						_push(`</div><div class="content-wrapper" data-v-a39f7ad5${_scopeId}><div class="desc" data-v-a39f7ad5${_scopeId}>`);
						if (!isVacancy.value) _push(`<!--[--><input type="text"${ssrRenderAttr("value", unref(form).title)} placeholder="Заголовок поста" required class="title-input" data-v-a39f7ad5${_scopeId}><textarea placeholder="Описание поста" required class="description-textarea" data-v-a39f7ad5${_scopeId}>${ssrInterpolate(unref(form).description)}</textarea><!--]-->`);
						else {
							_push(`<div class="vacancy-fields" data-v-a39f7ad5${_scopeId}><div class="form-row" data-v-a39f7ad5${_scopeId}><div class="form-group" data-v-a39f7ad5${_scopeId}><label for="position" data-v-a39f7ad5${_scopeId}>Должность</label><input type="text"${ssrRenderAttr("value", unref(form).position)} id="position" placeholder="Например: PHP разработчик" data-v-a39f7ad5${_scopeId}></div></div><div class="form-row two-cols" data-v-a39f7ad5${_scopeId}><div class="form-group" data-v-a39f7ad5${_scopeId}><label for="budget_min" data-v-a39f7ad5${_scopeId}>Бюджет от</label><input type="number"${ssrRenderAttr("value", unref(form).budget_min)} id="budget_min" placeholder="1000" data-v-a39f7ad5${_scopeId}></div><div class="form-group" data-v-a39f7ad5${_scopeId}><label for="budget_max" data-v-a39f7ad5${_scopeId}>Бюджет до</label><input type="number"${ssrRenderAttr("value", unref(form).budget_max)} id="budget_max" placeholder="5000" data-v-a39f7ad5${_scopeId}></div></div><div class="form-row" data-v-a39f7ad5${_scopeId}><div class="form-group" data-v-a39f7ad5${_scopeId}><label for="deadline" data-v-a39f7ad5${_scopeId}>Срок выполнения</label><input type="date"${ssrRenderAttr("value", unref(form).deadline)} id="deadline" data-v-a39f7ad5${_scopeId}></div></div><div class="form-row" data-v-a39f7ad5${_scopeId}><div class="form-group" data-v-a39f7ad5${_scopeId}><div class="label-row" data-v-a39f7ad5${_scopeId}><label for="requirements" data-v-a39f7ad5${_scopeId}>Требования</label><span class="${ssrRenderClass([{ "limit-reached": isRequirementsLimitReached.value }, "char-counter"])}" data-v-a39f7ad5${_scopeId}>${ssrInterpolate(requirementsLength.value)}/${ssrInterpolate(MAX_REQUIREMENTS)}</span></div><textarea id="requirements" placeholder="Опишите требования к исполнителю..." rows="4"${ssrRenderAttr("maxlength", MAX_REQUIREMENTS)} class="${ssrRenderClass({ "limit-reached": isRequirementsLimitReached.value })}" data-v-a39f7ad5${_scopeId}>${ssrInterpolate(unref(form).requirements)}</textarea></div></div><div class="form-row" data-v-a39f7ad5${_scopeId}><div class="form-group" data-v-a39f7ad5${_scopeId}><label data-v-a39f7ad5${_scopeId}>Требуемые навыки</label>`);
							_push(ssrRenderComponent(SkillsSelector_default, {
								skills: __props.skills,
								modelValue: unref(form).skills,
								"onUpdate:modelValue": ($event) => unref(form).skills = $event
						...
						if (unref(form).errors.title) _push(`<div class="error" data-v-a39f7ad5${_scopeId}>${ssrInterpolate(unref(form).errors.title)}</div>`);
						else _push(`<!---->`);
						if (unref(form).errors.description) _push(`<div class="error" data-v-a39f7ad5${_scopeId}>${ssrInterpolate(unref(form).errors.description)}</div>`);
						else _push(`<!---->`);
						if (unref(form).errors.image) _push(`<div class="error" data-v-a39f7ad5${_scopeId}>${ssrInterpolate(unref(form).errors.image)}</div>`);
						else _push(`<!---->`);
						_push(`<div class="form-actions" data-v-a39f7ad5${_scopeId}>`);
						_push(ssrRenderComponent(unref(Link), {
						...
						_push(`<button type="submit" class="submit-button"${ssrIncludeBooleanAttr(unref(form).processing) ? " disabled" : ""} data-v-a39f7ad5${_scopeId}>${ssrInterpolate(unref(form).processing ? "Сохранение..." : "Сохранить")}</button></div></div></div></div></form></div>`);
...
var Edit_default$1 = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$9, [["__scopeId", "data-v-a39f7ad5"]]);
//#endregion
...
var _sfc_main$8 = /* @__PURE__ */ Object.assign({ layout: AppLayout_default }, {
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<div${ssrRenderAttrs(_attrs)} data-v-ad1c04ca>`);
			_push(ssrRenderComponent(unref(Head), { title: __props.post.title }, null, _parent));
			_push(`<div class="block" data-v-ad1c04ca><div class="image-container" data-v-ad1c04ca>`);
			if (__props.post.image_url) _push(`<img${ssrRenderAttr("src", __props.post.image_url)}${ssrRenderAttr("alt", __props.post.title)} class="post-image" data-v-ad1c04ca>`);
			else _push(`<div class="no-image" data-v-ad1c04ca><span data-v-ad1c04ca>Изображение отсутствует</span></div>`);
			_push(`</div><div class="content-wrapper" data-v-ad1c04ca>`);
			if (__props.post.is_hidden) _push(`<div class="hidden-warning" data-v-ad1c04ca> ⚠️ Этот пост скрыт администрацией и виден только вам </div>`);
			else _push(`<!---->`);
			_push(`<div class="desc" data-v-ad1c04ca><div class="header-actions" data-v-ad1c04ca>`);
			if (__props.post.is_vacancy) _push(`<h2 class="title" data-v-ad1c04ca>Вакансия: ${ssrInterpolate(__props.post.vacancy.position)}</h2>`);
			else _push(`<h2 class="title" data-v-ad1c04ca>${ssrInterpolate(__props.post.title)}</h2>`);
			if (canEdit.value || canReport.value) {
				_push(`<div class="menu-container" data-v-ad1c04ca><button class="menu-btn" type="button" data-v-ad1c04ca><img src="/images/dots.svg" alt="меню" data-v-ad1c04ca></button>`);
				if (menuOpen.value) {
					_push(`<div class="post-dropdown-menu" data-v-ad1c04ca><button class="menu-item" data-v-ad1c04ca><img src="/images/share.svg" alt="" data-v-ad1c04ca>Поделиться </button>`);
					if (__props.post.edit_url) _push(ssrRenderComponent(unref(Link), {
						href: __props.post.edit_url,
						class: "menu-item"
					}, {
						default: withCtx((_, _push, _parent, _scopeId) => {
							if (_push) _push(`<img src="/images/edit.svg" alt="" data-v-ad1c04ca${_scopeId}>Редактировать `);
							else return [createVNode("img", {
								src: "/images/edit.svg",
								alt: ""
					...
					if (__props.post.delete_url) _push(`<button class="menu-item delete" data-v-ad1c04ca><img src="/images/trash.svg" alt="" data-v-ad1c04ca> Удалить </button>`);
					else _push(`<!---->`);
					if (canReport.value) _push(`<button class="menu-item" data-v-ad1c04ca><img src="/images/flag.svg" alt="" data-v-ad1c04ca>Пожаловаться </button>`);
					else _push(`<!---->`);
					_push(`</div>`);
				} else _push(`<!---->`);
				_push(`</div>`);
			...
			_push(ssrRenderComponent(unref(Link), {
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						if (__props.post.user.avatar_url) _push(`<img${ssrRenderAttr("src", __props.post.user.avatar_url)} class="author-avatar"${ssrRenderAttr("alt", __props.post.user.name)} data-v-ad1c04ca${_scopeId}>`);
						else _push(`<img src="/images/User-avatar.png" class="author-avatar"${ssrRenderAttr("alt", __props.post.user.name)} data-v-ad1c04ca${_scopeId}>`);
			...
			_push(`<div class="post-actions" data-v-ad1c04ca><button type="button" class="${ssrRenderClass([{ liked: __props.post.is_liked }, "like-btn"])}" data-v-ad1c04ca>${ssrInterpolate(__props.post.is_liked ? "❤️" : "🤍")} ${ssrInterpolate(__props.post.likes_count)}</button></div>`);
			if (__props.post.is_vacancy) {
				_push(`<!--[--><div class="vacancy-info" data-v-ad1c04ca>`);
				if (__props.post.vacancy.budget_min || __props.post.vacancy.budget_max) _push(`<div class="vacancy-budget" data-v-ad1c04ca><span class="label" data-v-ad1c04ca>Бюджет:</span><span class="value" data-v-ad1c04ca>${ssrInterpolate(__props.post.vacancy.budget_min ? __props.post.vacancy.budget_min + " ₽" : "")} ${ssrInterpolate(__props.post.vacancy.budget_min && __props.post.vacancy.budget_max ? " - " : "")} ${ssrInterpolate(__props.post.vacancy.budget_max ? __props.post.vacancy.budget_max + " ₽" : "")}</span></div>`);
				else _push(`<!---->`);
				if (__props.post.vacancy.deadline) _push(`<div class="vacancy-deadline" data-v-ad1c04ca><span class="label" data-v-ad1c04ca>Срок:</span><span class="value" data-v-ad1c04ca>${ssrInterpolate(formatDeadline(__props.post.vacancy.deadline))}</span></div>`);
				else _push(`<!---->`);
				if (__props.post.vacancy.skills && __props.post.vacancy.skills.length > 0) {
					_push(`<div class="vacancy-skills" data-v-ad1c04ca><span class="label" data-v-ad1c04ca>Требуемые навыки:</span><div class="skills-list" data-v-ad1c04ca><!--[-->`);
					ssrRenderList(__props.post.vacancy.skills, (skill) => {
						_push(`<span class="${ssrRenderClass([unref(getSkillClass)(skill.name), "skill-tag"])}" data-v-ad1c04ca>${ssrInterpolate(skill.name)} <span class="skill-level" data-v-ad1c04ca>★ ${ssrInterpolate(skill.level)}</span></span>`);
					});
					_push(`<!--]--></div>`);
					if (__props.post.vacancy.requirements) _push(`<div class="vacancy-requirements" data-v-ad1c04ca><span class="label" data-v-ad1c04ca>Требования:</span><p class="requirements-text" data-v-ad1c04ca>${ssrInterpolate(__props.post.vacancy.requirements)}</p></div>`);
					else _push(`<!---->`);
					_push(`</div>`);
				} else _push(`<!---->`);
				_push(`</div>`);
				if (__props.post.vacancy && __props.post.vacancy.status === "open") {
					_push(`<div class="vacancy-actions" data-v-ad1c04ca>`);
					if (__props.post.vacancy.applications_count > 0) _push(`<div class="applications-count" data-v-ad1c04ca>${ssrInterpolate(__props.post.vacancy.applications_count)} ${ssrInterpolate(getApplicationsWord(__props.post.vacancy.applications_count))} на эту вакансию </div>`);
					else _push(`<!---->`);
					if (!isAuthor.value && __props.post.respond_url) _push(`<button class="respond-btn"${ssrIncludeBooleanAttr(__props.post.has_application) ? " disabled" : ""} data-v-ad1c04ca>${ssrInterpolate(__props.post.has_application ? "Вы уже откликнулись" : "Откликнуться")}</button>`);
					else _push(`<!---->`);
					_push(`</div>`);
				} else _push(`<!---->`);
				_push(`<!--]-->`);
			} else _push(`<p class="description" data-v-ad1c04ca>${ssrInterpolate(__props.post.description)}</p>`);
			_push(`<div class="meta" data-v-ad1c04ca><small data-v-ad1c04ca>${ssrInterpolate(formattedDate.value)}</small></div></div></div></div><div class="comments-section-wrapper" data-v-ad1c04ca>`);
			if (__props.post.is_vacancy && canEdit.value) _push(`<div class="tabs" data-v-ad1c04ca><button class="${ssrRenderClass([{ active: activeTab.value === "applications" }, "tab"])}" data-v-ad1c04ca> Список откликнувшихся (${ssrInterpolate(__props.post.vacancy.applications?.length || 0)}) </button><button class="${ssrRenderClass([{ active: activeTab.value === "comments" }, "tab"])}" data-v-ad1c04ca> Комментарии (${ssrInterpolate(__props.post.comments.length)}) </button></div>`);
			else _push(`<!---->`);
			_push(`<div class="comments-section" data-v-ad1c04ca>`);
			if (!__props.post.is_vacancy || !canEdit.value || activeTab.value === "comments") {
				_push(`<!--[-->`);
				if (_ctx.$page.props.auth.user) {
					_push(`<div class="comment-form" data-v-ad1c04ca><form data-v-ad1c04ca>`);
					if (commentErrors.value.text) _push(`<div class="error" data-v-ad1c04ca>${ssrInterpolate(commentErrors.value.text)}</div>`);
					else _push(`<!---->`);
					_push(`<textarea required placeholder="Напишите комментарий"${ssrIncludeBooleanAttr(unref(commentForm).processing) ? " disabled" : ""} data-v-ad1c04ca>${ssrInterpolate(unref(commentForm).text)}</textarea><button type="submit"${ssrIncludeBooleanAttr(unref(commentForm).processing) ? " disabled" : ""} data-v-ad1c04ca>${ssrInterpolate(unref(commentForm).processing ? "Отправка..." : "Добавить комментарий")}</button></form></div>`);
				} else {
					_push(`<div class="login-prompt" data-v-ad1c04ca><p data-v-ad1c04ca>Чтобы оставить комментарий, `);
					_push(ssrRenderComponent(unref(Link), { href: "/login" }, {
						default: withCtx((_, _push, _parent, _scopeId) => {
				...
				_push(`<h3 data-v-ad1c04ca>Комментарии (${ssrInterpolate(__props.post.comments.length)})</h3>`);
				if (__props.post.comments.length === 0) _push(`<div class="no-comments" data-v-ad1c04ca><p data-v-ad1c04ca>Комментариев пока нет. Будьте первым!</p></div>`);
				else {
					_push(`<div class="comments" data-v-ad1c04ca><!--[-->`);
					ssrRenderList(__props.post.comments, (comment) => {
						_push(`<div class="comment" data-v-ad1c04ca><div class="comment-header" data-v-ad1c04ca>`);
						_push(ssrRenderComponent(unref(Link), {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) {
									if (comment.user.avatar_url) _push(`<img${ssrRenderAttr("src", comment.user.avatar_url)} class="comment-avatar"${ssrRenderAttr("alt", comment.user.name)} data-v-ad1c04ca${_scopeId}>`);
									else _push(`<img src="/images/User-avatar.png" class="comment-avatar"${ssrRenderAttr("alt", comment.user.name)} data-v-ad1c04ca${_scopeId}>`);
									_push(`<span class="comment-author-name" data-v-ad1c04ca${_scopeId}>${ssrInterpolate(comment.user.name)}</span>`);
						...
						_push(`<small class="comment-date" data-v-ad1c04ca>${ssrInterpolate(formatDate(comment.created_at))}</small></div><div class="comment-body" data-v-ad1c04ca><p data-v-ad1c04ca>${ssrInterpolate(comment.text)}</p></div></div>`);
					});
					_push(`<!--]--></div>`);
				}
				_push(`<!--]-->`);
			} else if (activeTab.value === "applications") {
				_push(`<!--[--><h3 data-v-ad1c04ca>Список откликнувшихся (${ssrInterpolate(__props.post.vacancy.applications?.length || 0)})</h3>`);
				if (!__props.post.vacancy.applications || __props.post.vacancy.applications.length === 0) _push(`<div class="no-comments" data-v-ad1c04ca><p data-v-ad1c04ca>На эту вакансию пока никто не откликнулся.</p></div>`);
				else {
					_push(`<div class="comments" data-v-ad1c04ca><!--[-->`);
					ssrRenderList(__props.post.vacancy.applications, (application) => {
						...
						_push(ssrRenderComponent(unref(Link), {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) {
									if (application.user.avatar_url) _push(`<img${ssrRenderAttr("src", application.user.avatar_url)} class="comment-avatar"${ssrRenderAttr("alt", application.user.name)} data-v-ad1c04ca${_scopeId}>`);
									else _push(`<img src="/images/User-avatar.png" class="comment-avatar"${ssrRenderAttr("alt", application.user.name)} data-v-ad1c04ca${_scopeId}>`);
									_push(`<span class="comment-author-name" data-v-ad1c04ca${_scopeId}>${ssrInterpolate(application.user.name)}</span>`);
						...
						_push(`<div class="comment-header-right" data-v-ad1c04ca><small class="comment-date" data-v-ad1c04ca>${ssrInterpolate(formatDate(application.created_at))}</small></div></div><div class="comment-body" data-v-ad1c04ca><div data-v-ad1c04ca>`);
						if (application.cover_letter) _push(`<p data-v-ad1c04ca>${ssrInterpolate(application.cover_letter)}</p>`);
						else _push(`<!---->`);
						if (application.proposed_price) _push(`<p class="proposed-price" data-v-ad1c04ca>Предложенная цена: ${ssrInterpolate(application.proposed_price)} ₽</p>`);
						else _push(`<!---->`);
						_push(`</div>`);
			...
			if (showRespondModal.value) {
				_push(`<div class="modal-overlay" data-v-ad1c04ca><div class="modal-content" data-v-ad1c04ca><button class="modal-close" data-v-ad1c04ca>×</button><h2 data-v-ad1c04ca>Отклик на вакансию</h2><form data-v-ad1c04ca><div class="form-group" data-v-ad1c04ca><label for="cover_letter" data-v-ad1c04ca>Сопроводительное письмо *</label><textarea id="cover_letter" required placeholder="Расскажите о себе и почему вы подходите на эту вакансию..." rows="6" data-v-ad1c04ca>${ssrInterpolate(unref(respondForm).cover_letter)}</textarea>`);
				if (unref(respondForm).errors.cover_letter) _push(`<div class="error" data-v-ad1c04ca>${ssrInterpolate(unref(respondForm).errors.cover_letter)}</div>`);
				else _push(`<!---->`);
				_push(`</div><div class="form-group" data-v-ad1c04ca><label for="proposed_price" data-v-ad1c04ca>Предложенная цена (₽)</label><input type="number" id="proposed_price"${ssrRenderAttr("value", unref(respondForm).proposed_price)} min="1" max="9999999999" placeholder="Ваша цена" data-v-ad1c04ca>`);
				if (unref(respondForm).errors.proposed_price) _push(`<div class="error" data-v-ad1c04ca>${ssrInterpolate(unref(respondForm).errors.proposed_price)}</div>`);
				else _push(`<!---->`);
				_push(`</div><button type="submit" class="submit-btn"${ssrIncludeBooleanAttr(unref(respondForm).processing) ? " disabled" : ""} data-v-ad1c04ca>${ssrInterpolate(unref(respondForm).processing ? "Отправка..." : "Отправить отклик")}</button></form></div></div>`);
			} else _push(`<!---->`);
			if (showReportModal.value) {
				_push(`<div class="modal-overlay" data-v-ad1c04ca><div class="modal-content" data-v-ad1c04ca><button class="modal-close" data-v-ad1c04ca>×</button><h2 data-v-ad1c04ca>Пожаловаться на пост</h2><form data-v-ad1c04ca><div class="form-group" data-v-ad1c04ca><label for="report_reason" data-v-ad1c04ca>Причина жалобы *</label><textarea id="report_reason" required placeholder="Опишите причину жалобы..." rows="4" data-v-ad1c04ca>${ssrInterpolate(unref(reportForm).reason)}</textarea>`);
				if (reportErrors.value.reason) _push(`<div class="error" data-v-ad1c04ca>${ssrInterpolate(reportErrors.value.reason)}</div>`);
				else _push(`<!---->`);
				_push(`</div><button type="submit" class="submit-btn"${ssrIncludeBooleanAttr(unref(reportForm).processing) ? " disabled" : ""} data-v-ad1c04ca>${ssrInterpolate(unref(reportForm).processing ? "Отправка..." : "Отправить жалобу")}</button></form></div></div>`);
			} else _push(`<!---->`);
			if (showShareModal.value) {
				_push(`<div class="modal-overlay" data-v-ad1c04ca><div class="modal-content" data-v-ad1c04ca><button class="modal-close" data-v-ad1c04ca>×</button><h2 data-v-ad1c04ca>Поделиться постом</h2><form data-v-ad1c04ca><div class="form-group" data-v-ad1c04ca><label data-v-ad1c04ca>Выберите чаты для отправки *</label>`);
				if (sharedChats.value.length === 0) _push(`<div class="no-chats" data-v-ad1c04ca><p data-v-ad1c04ca>У вас нет чатов для отправки поста.</p></div>`);
				else {
					_push(`<div class="chat-list" data-v-ad1c04ca><!--[-->`);
					ssrRenderList(sharedChats.value, (chat) => {
						_push(`<div class="chat-item" data-v-ad1c04ca><label class="chat-label" data-v-ad1c04ca><input type="checkbox"${ssrRenderAttr("value", chat.id)}${ssrIncludeBooleanAttr(Array.isArray(unref(shareForm).users) ? ssrLooseContain(unref(shareForm).users, chat.id) : unref(shareForm).users) ? " checked" : ""} data-v-ad1c04ca><span class="chat-info" data-v-ad1c04ca>`);
						if (chat.other_user && chat.other_user.avatar_url) _push(`<img${ssrRenderAttr("src", chat.other_user.avatar_url)} class="chat-avatar"${ssrRenderAttr("alt", chat.other_user.name)} data-v-ad1c04ca>`);
						else _push(`<img src="/images/User-avatar.png" class="chat-avatar"${ssrRenderAttr("alt", chat.other_user ? chat.other_user.name : "Неизвестный пользователь")} data-v-ad1c04ca>`);
						_push(`<span class="chat-name" data-v-ad1c04ca>${ssrInterpolate(chat.other_user ? chat.other_user.name : "Неизвестный пользователь")}</span></span></label></div>`);
					});
					_push(`<!--]--></div>`);
				}
				if (shareErrors.value.users) _push(`<div class="error" data-v-ad1c04ca>${ssrInterpolate(shareErrors.value.users)}</div>`);
				else _push(`<!---->`);
				_push(`</div><div class="form-group" data-v-ad1c04ca><label for="share_message" data-v-ad1c04ca>Текст сообщения</label><textarea id="share_message" placeholder="Напишите сообщение к посту..." rows="4" data-v-ad1c04ca>${ssrInterpolate(unref(shareForm).message)}</textarea></div><button type="submit" class="submit-btn"${ssrIncludeBooleanAttr(unref(shareForm).processing) ? " disabled" : ""} data-v-ad1c04ca>${ssrInterpolate(unref(shareForm).processing ? "Отправка..." : "Отправить")}</button></form></div></div>`);
			} else _push(`<!---->`);
			_push(`</div>`);
		};
	}
...
var Show_default$1 = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$8, [["__scopeId", "data-v-ad1c04ca"]]);
//#endregion
			...
			_push(ssrRenderComponent(AppLayout_default, _attrs, {
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						_push(`<div class="likes-wrapper" data-v-12a1be3a${_scopeId}><div class="likeshead" data-v-12a1be3a${_scopeId}><h1 data-v-12a1be3a${_scopeId}>Лайки ${ssrInterpolate(__props.user.name)}</h1>`);
						_push(ssrRenderComponent(unref(Link), { href: "/profile/" + __props.user.id }, {
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) _push(`← Вернуться в профиль`);
								else return [createTextVNode("← Вернуться в профиль")];
						...
						_push(`</div>`);
						if (__props.likedPosts.length === 0) _push(`<h1 class="noposts" data-v-12a1be3a${_scopeId}> У ${ssrInterpolate(__props.user.name)} пока что нет понравившихся постов... </h1>`);
						else {
							_push(`<div class="posts" data-v-12a1be3a${_scopeId}><!--[-->`);
						...
						_push(`</div>`);
					} else return [createVNode(unref(Head), { title: `Понравившиеся посты ${__props.user.name}` }, null, 8, ["title"]), createVNode("div", { class: "likes-wrapper" }, [createVNode("div", { class: "likeshead" }, [createVNode("h1", null, "Лайки " + toDisplayString(__props.user.name), 1), createVNode(unref(Link), { href: "/profile/" + __props.user.id }, {
						default: withCtx(() => [createTextVNode("← Вернуться в профиль")]),
						_: 1
					}, 8, ["href"])]), __props.likedPosts.length === 0 ? (openBlock(), createBlock("h1", {
						key: 0,
						class: "noposts"
...
var LikedPosts_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$4, [["__scopeId", "data-v-12a1be3a"]]);
//#endregion
...
var _sfc_main$2 = {
	...
	setup(__props) {
		...
		const submitAboutMe = () => {
			if (!aboutMeForm.aboutme || aboutMeForm.aboutme.trim().length === 0) return;
			...
			_push(ssrRenderComponent(AppLayout_default, _attrs, {
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						_push(`<div class="Profileblock" data-v-a0c50232${_scopeId}><div class="container" data-v-a0c50232${_scopeId}><div class="avatar" data-v-a0c50232${_scopeId}><div class="profile-header" data-v-a0c50232${_scopeId}>`);
						if (__props.user.avatar_url) _push(`<img${ssrRenderAttr("src", __props.user.avatar_url)}${ssrRenderAttr("alt", "Аватарка " + __props.user.name)} data-v-a0c50232${_scopeId}>`);
						else _push(`<img src="/images/User-avatar.png"${ssrRenderAttr("alt", "Аватарка " + __props.user.name)} data-v-a0c50232${_scopeId}>`);
						_push(`</div><div class="desc" data-v-a0c50232${_scopeId}><h1 data-v-a0c50232${_scopeId}>${ssrInterpolate(__props.user.name)}</h1>`);
						if (__props.user.is_verified === "verified") _push(`<img src="/images/verified.svg" alt="Аккаунт верифицирован" data-v-a0c50232${_scopeId}>`);
						else _push(`<!---->`);
						_push(`</div>`);
						if (__props.user.rating) {
							_push(`<div class="rating-display" data-v-a0c50232${_scopeId}>`);
							_push(ssrRenderComponent(unref(Link), {
								...
								default: withCtx((_, _push, _parent, _scopeId) => {
									if (_push) {
										_push(`<div class="stars" data-v-a0c50232${_scopeId}><!--[-->`);
										ssrRenderList(5, (i) => {
											_push(`<!--[-->`);
											if (i <= Math.floor(__props.user.rating)) _push(`<img src="/images/star.svg" alt="star" class="star-icon" data-v-a0c50232${_scopeId}>`);
											else if (i - 1 < __props.user.rating && __props.user.rating % 1 >= .5) _push(`<img src="/images/star.svg" alt="half-star" class="star-icon half" data-v-a0c50232${_scopeId}>`);
											else _push(`<img src="/images/star-empty.svg" alt="star-empty" class="star-icon empty" data-v-a0c50232${_scopeId}>`);
											_push(`<!--]-->`);
										});
										_push(`<!--]--></div><span class="rating-value" data-v-a0c50232${_scopeId}>${ssrInterpolate(__props.user.rating)}</span>`);
						...
						if (__props.user.created_at) _push(`<p class="created-at" data-v-a0c50232${_scopeId}>Аккаунт создан ${ssrInterpolate(__props.user.created_at)}</p>`);
						else _push(`<!---->`);
						_push(`</div></div><div class="aboutme" data-v-a0c50232${_scopeId}><div class="aboutme-header" data-v-a0c50232${_scopeId}><h1 data-v-a0c50232${_scopeId}>Обо мне</h1>`);
						_push(ssrRenderComponent(unref(Link), { href: "/profile/" + __props.user.id + "/following" }, {
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) _push(` Подписки<br data-v-a0c50232${_scopeId}> ${ssrInterpolate(__props.user.following_count)}`);
								else return [
						...
						_push(ssrRenderComponent(unref(Link), { href: "/profile/" + __props.user.id + "/followers" }, {
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) _push(` Подписчики<br data-v-a0c50232${_scopeId}> ${ssrInterpolate(__props.user.followers_count)}`);
								else return [
						...
						if (isOwnProfile.value) _push(ssrRenderComponent(unref(Link), {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) _push(`<img src="/images/settings.svg" alt="Редактировать профиль" data-v-a0c50232${_scopeId}>`);
								else return [createVNode("img", {
									src: "/images/settings.svg",
						...
						if (isOwnProfile.value) {
							_push(`<div data-v-a0c50232${_scopeId}>`);
							if (!__props.user.aboutme) _push(`<div class="aboutme-form" data-v-a0c50232${_scopeId}><p data-v-a0c50232${_scopeId}>Расскажите о себе</p><form data-v-a0c50232${_scopeId}><textarea draggable="false" placeholder="Напишите что-нибудь о себе..." data-v-a0c50232${_scopeId}>${ssrInterpolate(unref(aboutMeForm).aboutme)}</textarea><button type="submit"${ssrIncludeBooleanAttr(unref(aboutMeForm).processing) ? " disabled" : ""} data-v-a0c50232${_scopeId}>Сохранить</button></form></div>`);
							else _push(`<div class="${ssrRenderClass([{ expanded: isExpanded.value }, "aboutme-content"])}" style="${ssrRenderStyle({ maxHeight: expandedHeight.value })}" data-v-a0c50232${_scopeId}><p data-v-a0c50232${_scopeId}>${ssrInterpolate(__props.user.aboutme)}</p></div>`);
							_push(`</div>`);
						} else _push(`<div class="aboutme-body" data-v-a0c50232${_scopeId}><div class="${ssrRenderClass([{ expanded: isExpanded.value }, "aboutme-content"])}" style="${ssrRenderStyle({ maxHeight: expandedHeight.value })}" data-v-a0c50232${_scopeId}><p class="truncated-text" data-v-a0c50232${_scopeId}>${ssrInterpolate(__props.user.aboutme || "Пользователь пока не добавил информацию о себе.")}</p></div></div>`);
						if (showExpandButton.value) _push(`<div class="expand" data-v-a0c50232${_scopeId}>${ssrInterpolate(isExpanded.value ? "Свернуть" : "Развернуть")}</div>`);
						else _push(`<!---->`);
						if (__props.user.skills && __props.user.skills.length > 0) {
							_push(`<div class="user-skills" data-v-a0c50232${_scopeId}><h3 data-v-a0c50232${_scopeId}>Навыки</h3><div class="skills-list" data-v-a0c50232${_scopeId}><!--[-->`);
							ssrRenderList(__props.user.skills, (skill) => {
								_push(`<div class="${ssrRenderClass([unref(getSkillClass)(skill.name), "skill-tag"])}" data-v-a0c50232${_scopeId}><span class="skill-name" data-v-a0c50232${_scopeId}>${ssrInterpolate(skill.name)}</span><span class="skill-level" data-v-a0c50232${_scopeId}>★ ${ssrInterpolate(skill.level)}</span></div>`);
							});
							_push(`<!--]--></div></div>`);
						} else _push(`<!---->`);
						if (!isOwnProfile.value && auth.value.user) {
							_push(`<div class="profile-actions" data-v-a0c50232${_scopeId}><form data-v-a0c50232${_scopeId}><button type="submit" data-v-a0c50232${_scopeId}>${ssrInterpolate(__props.user.is_subscribed ? "Отписаться" : "Подписаться")}</button></form>`);
							_push(ssrRenderComponent(unref(Link), { href: "/chats/start/" + __props.user.id }, {
								default: withCtx((_, _push, _parent, _scopeId) => {
									if (_push) _push(`<button data-v-a0c50232${_scopeId}>Написать сообщение</button>`);
						...
						_push(`</div></div><h2 data-v-a0c50232${_scopeId}>Посты ${ssrInterpolate(__props.user.name)}</h2>`);
						if (__props.posts.length > 0 || isOwnProfile.value) {
							_push(`<div class="posts" data-v-a0c50232${_scopeId}>`);
							if (isOwnProfile.value) {
								_push(`<div class="post add-post-block" data-v-a0c50232${_scopeId}>`);
								_push(ssrRenderComponent(unref(Link), {
									href: "/posts/create",
									class: "add-post-link"
								}, {
									default: withCtx((_, _push, _parent, _scopeId) => {
										if (_push) _push(`<p data-v-a0c50232${_scopeId}>Добавить новый пост</p><button class="add-post-button" data-v-a0c50232${_scopeId}>+</button>`);
							...
							_push(`<!--]--></div>`);
						} else _push(`<div class="noposts" data-v-a0c50232${_scopeId}><h1 data-v-a0c50232${_scopeId}>у ${ssrInterpolate(__props.user.name)} пока что нет постов...</h1></div>`);
						if (isOwnProfile.value && __props.closedVacancies && __props.closedVacancies.length > 0) {
							_push(`<div class="closed-vacancies" data-v-a0c50232${_scopeId}><h2 data-v-a0c50232${_scopeId}>Завершённые вакансии</h2><div class="posts" data-v-a0c50232${_scopeId}><!--[-->`);
...
var Show_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$2, [["__scopeId", "data-v-a0c50232"]]);
//#endregion
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(ssrRenderComponent(AppLayout_default, _attrs, {
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(ssrRenderComponent(unref(Head), { title: "Настройки" }, null, _parent, _scopeId));
						_push(`<div class="settings-container" data-v-9295f385${_scopeId}><div class="settings-header" data-v-9295f385${_scopeId}><h1 data-v-9295f385${_scopeId}>Настройки</h1></div><div class="settings-content" data-v-9295f385${_scopeId}><nav class="settings-nav" data-v-9295f385${_scopeId}>`);
						_push(ssrRenderComponent(unref(Link), {
						...
						_push(`</nav><div class="settings-panel" data-v-9295f385${_scopeId}>`);
						if (__props.section === "profile") {
							_push(`<div class="panel-profile" data-v-9295f385${_scopeId}><div class="edit-content" data-v-9295f385${_scopeId}><div class="avatar" data-v-9295f385${_scopeId}><div class="profile-header avatar-upload" data-v-9295f385${_scopeId}><input type="file" accept="image/*" style="${ssrRenderStyle({ "display": "none" })}" data-v-9295f385${_scopeId}>`);
							if (avatarPreview.value || __props.user.avatar) _push(`<img${ssrRenderAttr("src", avatarPreview.value || "/storage/" + __props.user.avatar)} class="avatar-preview" data-v-9295f385${_scopeId}>`);
							else _push(`<div class="no-avatar" data-v-9295f385${_scopeId}><span data-v-9295f385${_scopeId}>Нажмите для загрузки</span></div>`);
							if (avatarPreview.value || __props.user.avatar) _push(`<div class="avatar-overlay" data-v-9295f385${_scopeId}><button type="button" class="change-avatar-btn" data-v-9295f385${_scopeId}> Изменить фото </button></div>`);
							else _push(`<!---->`);
							_push(`</div>`);
							if (!__props.user.is_verified || __props.user.is_verified !== "verified") {
								_push(`<div class="verification-links" data-v-9295f385${_scopeId}>`);
								...
								if (__props.user.is_verified === "pending") _push(`<p class="verification-status" data-v-9295f385${_scopeId}> Заявка на верификацию на рассмотрении </p>`);
								else _push(`<!---->`);
								_push(`</div>`);
							} else _push(`<!---->`);
							_push(`</div><div class="desc" data-v-9295f385${_scopeId}><form enctype="multipart/form-data" data-v-9295f385${_scopeId}><div class="form-group" data-v-9295f385${_scopeId}><label for="name" data-v-9295f385${_scopeId}>Имя:</label><div style="${ssrRenderStyle({
								"display": "flex",
								"gap": "20px"
							})}" data-v-9295f385${_scopeId}><input type="text" name="name" id="name"${ssrRenderAttr("value", unref(form).name)} required data-v-9295f385${_scopeId}><button type="button" class="${ssrRenderClass([{ dark: unref(isDark) }, "theme-toggle-btn"])}" data-v-9295f385${_scopeId}><span class="theme-toggle-track" data-v-9295f385${_scopeId}><span class="theme-toggle-thumb" data-v-9295f385${_scopeId}>`);
							if (unref(isDark)) _push(`<span data-v-9295f385${_scopeId}>🌙</span>`);
							else _push(`<span data-v-9295f385${_scopeId}>☀️</span>`);
							_push(`</span></span><span class="theme-toggle-label" data-v-9295f385${_scopeId}>${ssrInterpolate(unref(isDark) ? "Тёмная" : "Светлая")}</span></button></div></div><div class="form-group" data-v-9295f385${_scopeId}><label for="aboutme" data-v-9295f385${_scopeId}>О себе:</label><textarea name="aboutme" id="aboutme"${ssrRenderAttr("maxlength", maxLength)} data-v-9295f385${_scopeId}>${ssrInterpolate(unref(form).aboutme)}</textarea><div class="${ssrRenderClass([{ warning: remainingChars.value <= warningThreshold }, "char-counter"])}" data-v-9295f385${_scopeId}>`);
							if (remainingChars.value <= warningThreshold) _push(`<span data-v-9295f385${_scopeId}> Осталось ${ssrInterpolate(remainingChars.value)} ${ssrInterpolate(pluralizeChars(remainingChars.value))}</span>`);
							else _push(`<span data-v-9295f385${_scopeId}>${ssrInterpolate(currentLength.value)} / ${ssrInterpolate(maxLength)}</span>`);
							_push(`</div></div><div class="form-group" data-v-9295f385${_scopeId}><label data-v-9295f385${_scopeId}>Ваши навыки:</label>`);
							_push(ssrRenderComponent(SkillsSelector_default, {
								skills: __props.skills,
								modelValue: unref(form).skills,
								"onUpdate:modelValue": ($event) => unref(form).skills = $event
							}, null, _parent, _scopeId));
							_push(`</div><div class="form-actions" data-v-9295f385${_scopeId}><button type="submit" class="btn-save"${ssrIncludeBooleanAttr(unref(form).processing) ? " disabled" : ""} data-v-9295f385${_scopeId}>${ssrInterpolate(unref(form).processing ? "Сохранение..." : "Сохранить изменения")}</button>`);
							_push(ssrRenderComponent(unref(Link), {
								href: "/profile/" + __props.user.id,
								class: "btn-cancel"
							}, {
						...
						} else if (__props.section === "privacy") _push(`<div class="panel-privacy" data-v-9295f385${_scopeId}><h2 data-v-9295f385${_scopeId}>Настройки приватности</h2><p class="coming-soon" data-v-9295f385${_scopeId}>Раздел в разработке</p></div>`);
						else if (__props.section === "files") {
							_push(`<div class="panel-files" data-v-9295f385${_scopeId}><h2 data-v-9295f385${_scopeId}>Ваши файлы</h2>`);
							if (__props.userFiles && __props.userFiles.length > 0) {
								_push(`<div class="files-list" data-v-9295f385${_scopeId}><!--[-->`);
								ssrRenderList(__props.userFiles, (file) => {
									_push(`<div class="file-item" data-v-9295f385${_scopeId}><div class="file-info" data-v-9295f385${_scopeId}><span class="file-icon" data-v-9295f385${_scopeId}>📄</span><span class="file-name" data-v-9295f385${_scopeId}>${ssrInterpolate(file.name)}</span></div><div class="file-actions" data-v-9295f385${_scopeId}><a${ssrRenderAttr("href", file.url)} target="_blank" class="file-view-btn" data-v-9295f385${_scopeId}>Просмотр</a></div></div>`);
								});
								_push(`<!--]--></div>`);
							} else _push(`<div class="no-files" data-v-9295f385${_scopeId}><p data-v-9295f385${_scopeId}>У вас пока нет загруженных файлов</p><p class="no-files-hint" data-v-9295f385${_scopeId}>Файлы можно загрузить при регистрации или редактировании профиля</p></div>`);
							_push(`</div>`);
						} else _push(`<!---->`);
						_push(`</div></div></div>`);
					} else return [createVNode(unref(Head), { title: "Настройки" }), createVNode("div", { class: "settings-container" }, [createVNode("div", { class: "settings-header" }, [createVNode("h1", null, "Настройки")]), createVNode("div", { class: "settings-content" }, [createVNode("nav", { class: "settings-nav" }, [
						createVNode(unref(Link), {
							href: "/settings/profile",
							class: ["settings-nav-item", { active: __props.section === "profile" }]
						}, {
...
var Index_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$1, [["__scopeId", "data-v-9295f385"]]);
//#endregion
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(ssrRenderComponent(AppLayout_default, _attrs, {
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(ssrRenderComponent(unref(Head), { title: "Уведомления" }, null, _parent, _scopeId));
						_push(`<div class="notifications-container" data-v-9af426b7${_scopeId}><div class="notifications-header" data-v-9af426b7${_scopeId}><h1 data-v-9af426b7${_scopeId}>Уведомления</h1>`);
						if (unreadCount.value > 0) _push(`<button class="mark-all-btn" data-v-9af426b7${_scopeId}> Отметить все как прочитанные </button>`);
						else _push(`<!---->`);
						_push(`</div>`);
						if (notifications.value.length === 0) _push(`<div class="empty-notifications" data-v-9af426b7${_scopeId}><p data-v-9af426b7${_scopeId}>У вас пока нет уведомлений</p></div>`);
						else {
							_push(`<div class="notifications-list" data-v-9af426b7${_scopeId}><!--[-->`);
							ssrRenderList(notifications.value, (notification) => {
								_push(`<div class="${ssrRenderClass([{ unread: !notification.is_read }, "notification-item"])}" data-v-9af426b7${_scopeId}><div class="notification-icon" data-v-9af426b7${_scopeId}>`);
								if (notification.type === "message") _push(`<span data-v-9af426b7${_scopeId}>💬</span>`);
								else if (notification.type === "post_warning") _push(`<span data-v-9af426b7${_scopeId}>⚠️</span>`);
								else if (notification.type === "post_hidden") _push(`<span data-v-9af426b7${_scopeId}>🚫</span>`);
								else _push(`<span data-v-9af426b7${_scopeId}>🔔</span>`);
								_push(`</div><div class="notification-content" data-v-9af426b7${_scopeId}><div class="notification-title" data-v-9af426b7${_scopeId}>${ssrInterpolate(notification.title)}</div><div class="notification-text" data-v-9af426b7${_scopeId}>${ssrInterpolate(notification.content)}</div><div class="notification-time" data-v-9af426b7${_scopeId}>${ssrInterpolate(notification.created_at)}</div></div>`);
								if (!notification.is_read) _push(`<div class="unread-dot" data-v-9af426b7${_scopeId}></div>`);
								else _push(`<!---->`);
								_push(`</div>`);
							});
							_push(`<!--]--></div>`);
						...
						_push(`</div>`);
					} else return [createVNode(unref(Head), { title: "Уведомления" }), createVNode("div", { class: "notifications-container" }, [createVNode("div", { class: "notifications-header" }, [createVNode("h1", null, "Уведомления"), unreadCount.value > 0 ? (openBlock(), createBlock("button", {
						key: 0,
...
var Notifications_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main, [["__scopeId", "data-v-9af426b7"]]);
//#endregion
...
createServer((page) => createInertiaApp({
	...
	resolve: (name) => {
		return (/* @__PURE__ */ Object.assign({
			...
			"./Pages/Payment/Result.vue": Result_exports,
