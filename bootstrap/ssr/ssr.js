			...
			_push(ssrRenderComponent(AppLayout_default, _attrs, {
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						_push(`<div class="chat-container" data-v-99495e5c${_scopeId}><div class="chat-list" data-v-99495e5c${_scopeId}>`);
						if (!isSearching.value) _push(`<div class="chat-list-header" data-v-99495e5c${_scopeId}><h2 data-v-99495e5c${_scopeId}>Чаты</h2><button type="button" class="search-btn" data-v-99495e5c${_scopeId}><img src="/images/search.svg" alt="Поиск" data-v-99495e5c${_scopeId}></button></div>`);
						else _push(`<div class="search-header" data-v-99495e5c${_scopeId}><input${ssrRenderAttr("value", searchQuery.value)} type="text"${ssrRenderAttr("placeholder", isGlobalSearch.value ? "Поиск чатов и сообщений..." : "Поиск в чате...")} class="search-input" data-v-99495e5c${_scopeId}><button type="button" class="search-close" data-v-99495e5c${_scopeId}><img src="/images/close.svg" alt="Закрыть" data-v-99495e5c${_scopeId}></button></div>`);
						if (!isSearching.value) {
							...
							ssrRenderList(__props.chats, (chat) => {
								...
								}, "chat-item"])}" tabindex="0" data-v-99495e5c${_scopeId}>`);
								if (chat.other_user) {
									_push(`<div class="chat-user-info" data-v-99495e5c${_scopeId}><div class="avatar-wrapper" data-v-99495e5c${_scopeId}><img${ssrRenderAttr("src", chat.other_user.avatar_url)} class="chat-avatar" data-v-99495e5c${_scopeId}>`);
									if (isUserOnline(chat.other_user.id)) _push(`<span class="online-indicator" data-v-99495e5c${_scopeId}></span>`);
									else _push(`<!---->`);
									_push(`</div><div data-v-99495e5c${_scopeId}><h3 data-v-99495e5c${_scopeId}>${ssrInterpolate(chat.other_user.name)}</h3>`);
									if (chat.latest_message) _push(`<p class="${ssrRenderClass([{ unread: chat.unread_count > 0 }, "chat-preview"])}" data-v-99495e5c${_scopeId}>${ssrInterpolate(getChatPreview(chat.latest_message))}</p>`);
									else _push(`<!---->`);
									_push(`</div></div>`);
								} else _push(`<!---->`);
								_push(`<div class="chat-meta" data-v-99495e5c${_scopeId}>`);
								if (chat.unread_count > 0) _push(`<span class="unread-badge" data-v-99495e5c${_scopeId}>${ssrInterpolate(chat.unread_count > 99 ? "99+" : chat.unread_count)}</span>`);
								else _push(`<!---->`);
								_push(`</div></div>`);
							});
							_push(`<!--]-->`);
						...
						if (isSearching.value) {
							_push(`<div class="search-results" data-v-99495e5c${_scopeId}>`);
							if (searchResults.value.length === 0) _push(`<div class="search-no-results" data-v-99495e5c${_scopeId}> Ничего не найдено </div>`);
							else _push(`<!---->`);
							_push(`<!--[-->`);
							ssrRenderList(searchResults.value, (result) => {
								_push(`<div class="search-result-item" data-v-99495e5c${_scopeId}><img${ssrRenderAttr("src", result.user.avatar_url)} class="chat-avatar" data-v-99495e5c${_scopeId}><div class="search-result-content" data-v-99495e5c${_scopeId}><div class="search-result-name" data-v-99495e5c${_scopeId}>${ssrInterpolate(result.user.name)}</div>`);
								if (result.type === "chat") _push(`<div class="search-result-type" data-v-99495e5c${_scopeId}>Чат</div>`);
								else _push(`<div class="search-result-text" data-v-99495e5c${_scopeId}>${highlight(result.content) ?? ""}</div>`);
								_push(`</div></div>`);
							});
							_push(`<!--]--></div>`);
						} else _push(`<!---->`);
						...
						}, "chat-area"])}" style="${ssrRenderStyle(slideOffset.value > 0 ? { transform: `translateX(${slideOffset.value}px)` } : {})}" data-v-99495e5c${_scopeId}>`);
						if (__props.activeChat) {
							_push(`<!--[--><div class="chat-header" data-v-99495e5c${_scopeId}><button type="button" class="back" data-v-99495e5c${_scopeId}><img src="/images/arrow-left.svg" alt="назад" data-v-99495e5c${_scopeId}></button><div class="chat-header-mid" data-v-99495e5c${_scopeId}>`);
							if (otherUsers.value.length > 0) _push(ssrRenderComponent(unref(Link), {
								...
								default: withCtx((_, _push, _parent, _scopeId) => {
									if (_push) {
										_push(`<div class="avatar-wrapper" data-v-99495e5c${_scopeId}><img${ssrRenderAttr("src", otherUsers.value[0].avatar_url)} class="chat-avatar" data-v-99495e5c${_scopeId}>`);
										if (isUserOnline(otherUsers.value[0].id)) _push(`<span class="online-indicator" data-v-99495e5c${_scopeId}></span>`);
										else _push(`<span class="offline-indicator" data-v-99495e5c${_scopeId}></span>`);
										_push(`</div><h2 data-v-99495e5c${_scopeId}>${ssrInterpolate(otherUsers.value[0].name)}</h2>`);
							...
							if (vacancyPostId.value) _push(`<span class="vacancy-link" data-v-99495e5c${_scopeId}>${ssrInterpolate(isVacancyAuthor.value ? "откликнулся на" : "автор вакансии")}</span>`);
							else _push(`<!---->`);
							_push(ssrRenderComponent(unref(Link), {
								...
								default: withCtx((_, _push, _parent, _scopeId) => {
									if (_push) _push(`<h2 data-v-99495e5c${_scopeId}>${ssrInterpolate(vacancyPosition.value)}</h2>`);
									else return [createVNode("h2", null, toDisplayString(vacancyPosition.value), 1)];
								}),
								_: 1
							}, _parent, _scopeId));
							_push(`</div><img class="chat-options" src="/images/dots.svg" alt="опции" data-v-99495e5c${_scopeId}></div>`);
							if (isSearching.value && !isGlobalSearch.value && __props.activeChat) _push(`<div class="search-navigation" data-v-99495e5c${_scopeId}><button type="button" class="search-nav-btn"${ssrIncludeBooleanAttr(currentMatchIndex.value <= 0) ? " disabled" : ""} data-v-99495e5c${_scopeId}><img src="/images/arrow-up.svg" alt="вверх" data-v-99495e5c${_scopeId}></button><span class="search-nav-counter" data-v-99495e5c${_scopeId}>${ssrInterpolate(searchResults.value.length > 0 ? currentMatchIndex.value + 1 : 0)} / ${ssrInterpolate(searchResults.value.length)}</span><button type="button" class="search-nav-btn"${ssrIncludeBooleanAttr(currentMatchIndex.value >= searchResults.value.length - 1) ? " disabled" : ""} data-v-99495e5c${_scopeId}><img src="/images/arrow-up.svg" alt="вниз" style="${ssrRenderStyle({ "transform": "rotate(180deg)" })}" data-v-99495e5c${_scopeId}></button></div>`);
							else _push(`<!---->`);
							...
							})}" data-v-99495e5c${_scopeId}><div class="options-menu-item" data-v-99495e5c${_scopeId}>Файлы чата</div><div class="options-menu-item" data-v-99495e5c${_scopeId}>Добавить участника в чат</div><div class="options-menu-item" data-v-99495e5c${_scopeId}>Поиск по чату</div><div class="options-menu-item delete" data-v-99495e5c${_scopeId}>Удалить чат</div></div>`);
							else _push(`<!---->`);
							if (showApplicationBlock.value) {
								_push(`<div class="${ssrRenderClass([{ closed: isApplicationBlockClosed.value }, "application-block"])}" data-v-99495e5c${_scopeId}><div class="application-toggle" data-v-99495e5c${_scopeId}><button type="button" class="application-toggle-btn" data-v-99495e5c${_scopeId}><img src="/images/arrow-up.svg" alt="Toggle" class="${ssrRenderClass([{ flipped: isApplicationBlockClosed.value }, "toggle-arrow"])}" data-v-99495e5c${_scopeId}></button></div><div class="application-card" style="${ssrRenderStyle(!isApplicationBlockClosed.value ? null : { display: "none" })}" data-v-99495e5c${_scopeId}><img${ssrRenderAttr("src", __props.activeChat.application.user.avatar_url)} class="application-avatar" data-v-99495e5c${_scopeId}><div class="name" data-v-99495e5c${_scopeId}><h3 data-v-99495e5c${_scopeId}>${ssrInterpolate(__props.activeChat.application.user.name)}</h3><span class="${ssrRenderClass([{ online: isUserOnline(otherUsers.value[0].id) }, "user-status"])}" data-v-99495e5c${_scopeId}>${ssrInterpolate(isUserOnline(otherUsers.value[0].id) ? "онлайн" : "оффлайн")}</span></div><p class="account-age" data-v-99495e5c${_scopeId}>Аккаунт создан ${ssrInterpolate(formatAccountAge(__props.activeChat.application.user.created_at))}</p>`);
								if (__props.activeChat.application.user.rating) _push(`<div class="application-rating" data-v-99495e5c${_scopeId}><span data-v-99495e5c${_scopeId}>Рейтинг: ${ssrInterpolate(__props.activeChat.application.user.rating)}</span></div>`);
								else _push(`<!---->`);
								_push(`<div class="application-cover-letter" data-v-99495e5c${_scopeId}><h4 data-v-99495e5c${_scopeId}>Сопроводительное письмо:</h4><p data-v-99495e5c${_scopeId}>${ssrInterpolate(__props.activeChat.application.cover_letter)}</p></div>`);
								if (__props.activeChat.application.proposed_price) {
									_push(`<div class="application-price-row" data-v-99495e5c${_scopeId}><div class="application-price" data-v-99495e5c${_scopeId}><span class="label" data-v-99495e5c${_scopeId}>Предложенная цена:</span><span class="value" data-v-99495e5c${_scopeId}>${ssrInterpolate(__props.activeChat.application.proposed_price)} ₽</span></div>`);
									if (isVacancyAuthor.value && __props.activeChat.application.status === "pending") _push(`<button type="button" class="price-edit-btn" data-v-99495e5c${_scopeId}><img src="/images/edit.svg" alt="Изменить цену" data-v-99495e5c${_scopeId}></button>`);
									else _push(`<!---->`);
									_push(`</div>`);
								} else _push(`<!---->`);
								if (__props.activeChat.application.status === "completed") _push(`<div class="application-status" data-v-99495e5c${_scopeId}><span class="status-badge completed" data-v-99495e5c${_scopeId}>✅ Сделка завершена</span></div>`);
								else _push(`<!---->`);
								if (__props.activeChat.application.status === "cancelled") _push(`<div class="application-status" data-v-99495e5c${_scopeId}><span class="status-badge cancelled" data-v-99495e5c${_scopeId}>❌ Сделка отменена</span></div>`);
								else _push(`<!---->`);
								if (__props.activeChat.application.status === "disputed" || __props.activeChat.application.dispute && __props.activeChat.application.dispute.status === "open") _push(`<div class="application-status" data-v-99495e5c${_scopeId}><span class="status-badge dispute" data-v-99495e5c${_scopeId}>⚠️ Открыт спор</span></div>`);
								else _push(`<!---->`);
								if (isVacancyAuthor.value) {
									_push(`<div class="application-actions" data-v-99495e5c${_scopeId}>`);
									if (__props.activeChat.application.status === "pending") _push(`<!--[--><form data-v-99495e5c${_scopeId}><button type="submit" class="accept-btn" data-v-99495e5c${_scopeId}>Принять отклик</button></form><form data-v-99495e5c${_scopeId}><button type="submit" class="reject-btn" data-v-99495e5c${_scopeId}>Отклонить</button></form><!--]-->`);
									else if (__props.activeChat.application.status === "in_progress") {
										_push(`<!--[-->`);
										if (__props.activeChat.application.executor_marked_completed_at) _push(`<form data-v-99495e5c${_scopeId}><button type="submit" class="accept-btn" data-v-99495e5c${_scopeId}>Подтвердить завершение</button></form>`);
										else _push(`<!---->`);
										if (!__props.activeChat.application.executor_marked_completed_at) _push(`<button type="button" class="withdraw-btn" data-v-99495e5c${_scopeId}> Отменить </button>`);
										else _push(`<!---->`);
										_push(`<!--]-->`);
									} else if (__props.activeChat.application.status === "accepted") _push(`<button type="button" class="withdraw-btn" data-v-99495e5c${_scopeId}> Отменить </button>`);
									else _push(`<!---->`);
									_push(`</div>`);
								} else _push(`<!---->`);
								if (!isVacancyAuthor.value) {
									_push(`<div class="application-actions" data-v-99495e5c${_scopeId}>`);
									if (__props.activeChat.application.status === "in_progress" && !__props.activeChat.application.executor_marked_completed_at) _push(`<!--[--><form data-v-99495e5c${_scopeId}><button type="submit" class="accept-btn" data-v-99495e5c${_scopeId}>Отметить как выполненное</button></form><button type="button" class="withdraw-btn" data-v-99495e5c${_scopeId}> Отменить </button><!--]-->`);
									else _push(`<!---->`);
									if (__props.activeChat.application.status === "in_progress" && __props.activeChat.application.executor_marked_completed_at) _push(`<!--[--><button type="button" class="withdraw-btn" data-v-99495e5c${_scopeId}> Отменить </button><button type="button" class="dispute-btn" data-v-99495e5c${_scopeId}> Открыть спор </button><!--]-->`);
									else _push(`<!---->`);
									if (__props.activeChat.application.status === "accepted") _push(`<button type="button" class="dispute-btn" data-v-99495e5c${_scopeId}> Открыть спор </button>`);
									else _push(`<!---->`);
									_push(`</div>`);
								} else _push(`<!---->`);
								_push(`</div></div>`);
							} else _push(`<!---->`);
							_push(`<div class="chat-messages" data-v-99495e5c${_scopeId}><div class="chat-messages-inner" data-v-99495e5c${_scopeId}><div${ssrRenderAttrs({
								name: "messages",
							...
							ssrRenderList(localMessages.value, (message, index) => {
								...
								}, "message-container"])}" data-v-99495e5c${_scopeId}><img${ssrRenderAttr("src", message.user.avatar_url)} class="chat-avatar" data-v-99495e5c${_scopeId}><div class="${ssrRenderClass([{
									"my-message": message.is_mine,
									"shared-post": isOnlyPostUrl(message.content)
								}, "message"])}" data-v-99495e5c${_scopeId}>`);
								if (message.image_url) _push(`<img${ssrRenderAttr("src", message.image_url)} alt="Изображение" class="message-image" data-v-99495e5c${_scopeId}>`);
								else _push(`<!---->`);
								if (message.video_url) _push(`<video${ssrRenderAttr("src", message.video_url)} class="message-video" controls data-v-99495e5c${_scopeId}></video>`);
								else _push(`<!---->`);
								_push(`<div class="message-content" data-v-99495e5c${_scopeId}>`);
								if (message.content && !isOnlyPostUrl(message.content)) _push(`<span data-v-99495e5c${_scopeId}>${renderContent(message.content) ?? ""}</span>`);
								else _push(`<!---->`);
								_push(`<!--[-->`);
								ssrRenderList(getPostPreviewsFromContent(message.content), (preview) => {
									_push(`<div class="${ssrRenderClass([{ "shared-post-card": isOnlyPostUrl(message.content) }, "post-preview-card"])}" data-v-99495e5c${_scopeId}>`);
									if (preview.image_url) _push(`<img${ssrRenderAttr("src", preview.image_url)} class="post-preview-img" alt="" data-v-99495e5c${_scopeId}>`);
									else _push(`<!---->`);
									_push(`<div class="post-preview-body" data-v-99495e5c${_scopeId}><div class="post-preview-title" data-v-99495e5c${_scopeId}>${ssrInterpolate(preview.title)}</div>`);
									if (preview.description) _push(`<div class="post-preview-desc" data-v-99495e5c${_scopeId}>${ssrInterpolate(preview.description.slice(0, 80))}${ssrInterpolate(preview.description.length > 80 ? "…" : "")}</div>`);
									else _push(`<!---->`);
									_push(`</div></div>`);
								});
								_push(`<!--]-->`);
								if (message.file_url) {
									_push(`<div class="file-attachment" data-v-99495e5c${_scopeId}><button type="button" class="file-download-circle"${ssrRenderAttr("title", isFileDownloaded(message) ? "Скачано" : "Скачать")} data-v-99495e5c${_scopeId}>`);
									if (!isFileDownloaded(message)) _push(`<span data-v-99495e5c${_scopeId}><img src="/images/download.svg" alt="Скачать" data-v-99495e5c${_scopeId}></span>`);
									else _push(`<span data-v-99495e5c${_scopeId}><img src="/images/document.svg" alt="Файл" data-v-99495e5c${_scopeId}></span>`);
									_push(`</button><div class="file-meta" data-v-99495e5c${_scopeId}><div class="file-name" data-v-99495e5c${_scopeId}>${ssrInterpolate(message.file_name || "Файл")}</div>`);
									if (message.file_size) _push(`<div class="file-size" data-v-99495e5c${_scopeId}>${ssrInterpolate(formatSize(message.file_size))}</div>`);
									else _push(`<!---->`);
									_push(`</div></div>`);
								} else _push(`<!---->`);
								if (message.is_price_proposal && message.price_proposal_status === "pending" && !message.is_mine) _push(`<div class="price-proposal-actions" data-v-99495e5c${_scopeId}><form class="price-action-form" data-v-99495e5c${_scopeId}><button type="submit" class="accept-price-btn" data-v-99495e5c${_scopeId}>Принять</button></form><button type="button" class="change-price-btn" data-v-99495e5c${_scopeId}>Изменить</button></div>`);
								else _push(`<!---->`);
								_push(`</div>`);
								if (message.reply_to) _push(`<div class="reply-quote" data-v-99495e5c${_scopeId}><div class="reply-quote-author" data-v-99495e5c${_scopeId}>${ssrInterpolate(message.reply_to.user.name)}</div><div class="reply-quote-text" data-v-99495e5c${_scopeId}>${ssrInterpolate(message.reply_to.content?.slice(0, 100))}</div></div>`);
								else _push(`<!---->`);
								_push(`<div class="message-time" data-v-99495e5c${_scopeId}><span data-v-99495e5c${_scopeId}>${ssrInterpolate(message.time)}</span>`);
								if (getMessageStatus(message)) {
									_push(`<span class="${ssrRenderClass([getMessageStatus(message), "message-status"])}" data-v-99495e5c${_scopeId}>`);
									if (getMessageStatus(message) === "sending") _push(`<img src="/images/loading.svg" alt="Отправляется" class="status-icon spinning" data-v-99495e5c${_scopeId}>`);
									else if (getMessageStatus(message) === "sent") _push(`<img src="/images/check-mark.svg" alt="Отправлено" class="status-icon" data-v-99495e5c${_scopeId}>`);
										...
										"width": "16px",
										"height": "16px"
									})}" data-v-99495e5c${_scopeId}>`);
									else if (getMessageStatus(message) === "failed") _push(`<img src="/images/exclamation-circle.svg" alt="Не отправлено" class="status-icon" data-v-99495e5c${_scopeId}>`);
									else _push(`<!---->`);
									_push(`</span>`);
								} else _push(`<!---->`);
								_push(`</div></div></div>`);
							...
							if (showSkeleton.value) {
								_push(`<div class="${ssrRenderClass([{ fading: isSkeletonFading.value }, "chat-skeleton"])}" data-v-99495e5c${_scopeId}><!--[-->`);
								ssrRenderList(skeletonItems.value, (item, index) => {
									_push(`<div class="${ssrRenderClass([{ right: item.side === "right" }, "skeleton-message"])}" data-v-99495e5c${_scopeId}><div class="skeleton-avatar" data-v-99495e5c${_scopeId}></div><div class="skeleton-bubble" data-v-99495e5c${_scopeId}><div class="skeleton-line" style="${ssrRenderStyle({ width: item.lines[0] })}" data-v-99495e5c${_scopeId}></div><div class="skeleton-line short" style="${ssrRenderStyle({ width: item.lines[1] })}" data-v-99495e5c${_scopeId}></div>`);
									if (item.hasThirdLine) _push(`<div class="skeleton-line tiny" style="${ssrRenderStyle({ width: item.lines[2] })}" data-v-99495e5c${_scopeId}></div>`);
									else _push(`<!---->`);
									_push(`</div></div>`);
								});
								_push(`<!--]--></div>`);
							} else _push(`<!---->`);
							_push(`</div></div><form class="message-form" enctype="multipart/form-data" data-v-99495e5c${_scopeId}>`);
							if (editingMessage.value) _push(`<div class="editing-indicator" data-v-99495e5c${_scopeId}><span data-v-99495e5c${_scopeId}>Редактирование сообщения</span><button type="button" class="cancel-edit-btn" data-v-99495e5c${_scopeId}>✕</button></div>`);
							else _push(`<!---->`);
							if (replyingTo.value) _push(`<div class="reply-indicator" data-v-99495e5c${_scopeId}><div class="reply-preview" data-v-99495e5c${_scopeId}><span class="reply-name" data-v-99495e5c${_scopeId}>${ssrInterpolate(replyingTo.value.user.name)}</span><span class="reply-text" data-v-99495e5c${_scopeId}>${ssrInterpolate(replyingTo.value.content?.slice(0, 100))}</span></div><button type="button" class="cancel-reply-btn" data-v-99495e5c${_scopeId}>✕</button></div>`);
							else _push(`<!---->`);
							if (photoPreviewUrl.value || videoPreviewUrl.value || documentPreviewName.value) {
								_push(`<div class="image-preview-container" style="${ssrRenderStyle({ "display": "flex" })}" data-v-99495e5c${_scopeId}>`);
								if (photoPreviewUrl.value) _push(`<img${ssrRenderAttr("src", photoPreviewUrl.value)} alt="Превью" class="image-preview" data-v-99495e5c${_scopeId}>`);
								else _push(`<!---->`);
								if (videoPreviewUrl.value) _push(`<video${ssrRenderAttr("src", videoPreviewUrl.value)} class="video-preview" controls data-v-99495e5c${_scopeId}></video>`);
								else _push(`<!---->`);
								if (documentPreviewName.value) _push(`<div class="file-preview" data-v-99495e5c${_scopeId}> 📎 ${ssrInterpolate(documentPreviewName.value)}</div>`);
								else _push(`<!---->`);
								_push(`<div class="preview-actions" data-v-99495e5c${_scopeId}><button type="button" class="select-other-btn" data-v-99495e5c${_scopeId}> Выбрать другое </button>`);
								if (!editingMessage.value) _push(`<button type="button" class="cancel-preview-btn" data-v-99495e5c${_scopeId}> Отмена </button>`);
								else _push(`<!---->`);
								_push(`</div></div>`);
							} else _push(`<!---->`);
							_push(`<div class="message-input-container" data-v-99495e5c${_scopeId}>`);
							if (!editingMessage.value) _push(`<div class="add" data-v-99495e5c${_scopeId}><img src="/images/clip.svg" alt="Добавить вложение" data-v-99495e5c${_scopeId}><div class="add-select" data-v-99495e5c${_scopeId}><label data-v-99495e5c${_scopeId}> Фото <input type="file" name="photo" accept="image/*" data-v-99495e5c${_scopeId}></label><label data-v-99495e5c${_scopeId}> Видео <input type="file" name="video" accept="video/*" data-v-99495e5c${_scopeId}></label><label data-v-99495e5c${_scopeId}> Документ <input type="file" name="document" data-v-99495e5c${_scopeId}></label></div></div>`);
							else _push(`<!---->`);
							_push(`<textarea${ssrRenderAttr("placeholder", editingMessage.value ? "Редактируйте сообщение..." : "Введите сообщение...")} data-v-99495e5c${_scopeId}>${ssrInterpolate(unref(form).content)}</textarea><button type="submit"${ssrIncludeBooleanAttr(unref(form).processing || !canSend.value) ? " disabled" : ""} data-v-99495e5c${_scopeId}>${ssrInterpolate(editingMessage.value ? "Сохранить" : "Отправить")}</button></div></form><!--]-->`);
						} else _push(`<div class="chat-placeholder" data-v-99495e5c${_scopeId}><p data-v-99495e5c${_scopeId}>Выберите чат для начала общения</p></div>`);
						_push(`</div>`);
						if (showChatFiles.value) {
							_push(`<div class="chat-files-panel" data-v-99495e5c${_scopeId}><div class="chat-files-header" data-v-99495e5c${_scopeId}><h3 data-v-99495e5c${_scopeId}>Файлы чата</h3><button type="button" class="chat-files-close" data-v-99495e5c${_scopeId}><img src="/images/close.svg" alt="Закрыть" data-v-99495e5c${_scopeId}></button></div><div class="chat-files-tabs" data-v-99495e5c${_scopeId}><button type="button" class="${ssrRenderClass([{ active: chatFilesTab.value === "media" }, "chat-files-tab"])}" data-v-99495e5c${_scopeId}> Медиа </button><button type="button" class="${ssrRenderClass([{ active: chatFilesTab.value === "files" }, "chat-files-tab"])}" data-v-99495e5c${_scopeId}> Файлы </button><button type="button" class="${ssrRenderClass([{ active: chatFilesTab.value === "links" }, "chat-files-tab"])}" data-v-99495e5c${_scopeId}> Ссылки </button></div><div class="chat-files-content" data-v-99495e5c${_scopeId}>`);
							if (chatFilesTab.value === "media") {
								_push(`<div class="chat-files-media" data-v-99495e5c${_scopeId}>`);
								if (chatMediaFiles.value.length === 0) _push(`<div class="chat-files-empty" data-v-99495e5c${_scopeId}> Нет медиафайлов </div>`);
								else {
									_push(`<div class="chat-files-grid" data-v-99495e5c${_scopeId}><!--[-->`);
									ssrRenderList(chatMediaFiles.value, (media) => {
										_push(`<div class="chat-files-media-item" data-v-99495e5c${_scopeId}>`);
										if (media.type === "image") _push(`<img${ssrRenderAttr("src", media.url)} alt="Медиа" data-v-99495e5c${_scopeId}>`);
										else _push(`<video${ssrRenderAttr("src", media.url)} data-v-99495e5c${_scopeId}></video>`);
										if (media.type === "video") _push(`<div class="play-icon" data-v-99495e5c${_scopeId}>▶</div>`);
										else _push(`<!---->`);
										_push(`</div>`);
									});
									_push(`<!--]--></div>`);
							...
							if (chatFilesTab.value === "files") {
								_push(`<div class="chat-files-list" data-v-99495e5c${_scopeId}>`);
								if (chatDocFiles.value.length === 0) _push(`<div class="chat-files-empty" data-v-99495e5c${_scopeId}> Нет файлов </div>`);
								else {
									_push(`<div data-v-99495e5c${_scopeId}><!--[-->`);
									ssrRenderList(chatDocFiles.value, (file) => {
										_push(`<div class="chat-files-item" data-v-99495e5c${_scopeId}><button type="button" class="file-download-circle" data-v-99495e5c${_scopeId}><img src="/images/download.svg" alt="Скачать" data-v-99495e5c${_scopeId}></button><div class="file-info" data-v-99495e5c${_scopeId}><div class="file-name" data-v-99495e5c${_scopeId}>${ssrInterpolate(file.file_name)}</div><div class="file-size" data-v-99495e5c${_scopeId}>${ssrInterpolate(formatSize(file.file_size))}</div></div></div>`);
									});
									_push(`<!--]--></div>`);
								}
								_push(`</div>`);
							...
							if (chatFilesTab.value === "links") {
								_push(`<div class="chat-files-list" data-v-99495e5c${_scopeId}>`);
								if (chatLinks.value.length === 0) _push(`<div class="chat-files-empty" data-v-99495e5c${_scopeId}> Нет ссылок </div>`);
								else {
									_push(`<div data-v-99495e5c${_scopeId}><!--[-->`);
									ssrRenderList(chatLinks.value, (link) => {
										_push(`<div class="chat-files-link" data-v-99495e5c${_scopeId}><span class="link-text" data-v-99495e5c${_scopeId}>${ssrInterpolate(link.content)}</span><span class="link-time" data-v-99495e5c${_scopeId}>${ssrInterpolate(link.time)}</span></div>`);
									});
									_push(`<!--]--></div>`);
								}
								_push(`</div>`);
						...
						_push(`</div>`);
						if (modalOpen.value && modalImage.value) _push(`<div class="modal-overlay" style="${ssrRenderStyle({ "display": "flex" })}" data-v-99495e5c${_scopeId}><div class="modal-content" data-v-99495e5c${_scopeId}><button class="modal-close" type="button" data-v-99495e5c${_scopeId}> × </button><img${ssrRenderAttr("src", modalImage.value)} alt="Предпросмотр" data-v-99495e5c${_scopeId}></div></div>`);
						else _push(`<!---->`);
						if (modalOpen.value && modalVideo.value) _push(`<div class="modal-overlay" style="${ssrRenderStyle({ "display": "flex" })}" data-v-99495e5c${_scopeId}><div class="modal-content modal-video-content" data-v-99495e5c${_scopeId}><button class="modal-close" type="button" data-v-99495e5c${_scopeId}> × </button><video${ssrRenderAttr("src", modalVideo.value)} controls autoplay class="modal-video" data-v-99495e5c${_scopeId}></video></div></div>`);
						else _push(`<!---->`);
						if (contextMenu.value.show) {
							...
							if (!contextMenu.value.message?.is_mine) _push(`<div class="context-menu-item" data-v-99495e5c${_scopeId}> Ответить </div>`);
							else _push(`<!---->`);
							if (contextMenu.value.message?.is_mine) _push(`<div class="context-menu-item" data-v-99495e5c${_scopeId}> Редактировать </div>`);
							else _push(`<!---->`);
							if (contextMenu.value.message?.is_mine) _push(`<div class="context-menu-item" data-v-99495e5c${_scopeId}> Удалить у меня </div>`);
							else _push(`<!---->`);
							if (contextMenu.value.message?.is_mine) _push(`<div class="context-menu-item delete" data-v-99495e5c${_scopeId}> Удалить у всех </div>`);
							else _push(`<!---->`);
							_push(`</div>`);
						} else _push(`<!---->`);
						if (selectedMessages.value.length > 0) {
							_push(`<div class="selection-toolbar" data-v-99495e5c${_scopeId}><span data-v-99495e5c${_scopeId}>${ssrInterpolate(selectedMessages.value.length)} выбрано</span>`);
							if (canDeleteSelected.value) _push(`<button type="button" class="selection-delete-btn" data-v-99495e5c${_scopeId}> Удалить </button>`);
							else _push(`<!---->`);
							_push(`<button type="button" class="selection-clear-btn" data-v-99495e5c${_scopeId}> Отмена </button></div>`);
						} else _push(`<!---->`);
						if (showPriceModal.value) _push(`<div class="modal-overlay" style="${ssrRenderStyle({ "display": "flex" })}" data-v-99495e5c${_scopeId}><div class="price-modal" data-v-99495e5c${_scopeId}><div class="price-modal-header" data-v-99495e5c${_scopeId}><h3 data-v-99495e5c${_scopeId}>Предложить новую цену</h3><button type="button" class="modal-close" data-v-99495e5c${_scopeId}><img src="/images/close.svg" alt="Закрыть" data-v-99495e5c${_scopeId}></button></div><form data-v-99495e5c${_scopeId}><div class="price-modal-body" data-v-99495e5c${_scopeId}><label for="new-price" data-v-99495e5c${_scopeId}>Новая цена (₽):</label><input id="new-price"${ssrRenderAttr("value", priceForm.value.proposed_price)} type="number" min="0" max="9999999999" placeholder="Введите сумму" required data-v-99495e5c${_scopeId}></div><div class="price-modal-footer" data-v-99495e5c${_scopeId}><button type="button" class="cancel-btn" data-v-99495e5c${_scopeId}>Отмена</button><button type="submit" class="submit-btn" data-v-99495e5c${_scopeId}>Предложить</button></div></form></div></div>`);
						else _push(`<!---->`);
						if (priceChangeModal.value.show) _push(`<div class="modal-overlay" style="${ssrRenderStyle({ "display": "flex" })}" data-v-99495e5c${_scopeId}><div class="price-modal" data-v-99495e5c${_scopeId}><div class="price-modal-header" data-v-99495e5c${_scopeId}><h3 data-v-99495e5c${_scopeId}>Предложить новую цену</h3><button type="button" class="modal-close" data-v-99495e5c${_scopeId}><img src="/images/close.svg" alt="Закрыть" data-v-99495e5c${_scopeId}></button></div><form data-v-99495e5c${_scopeId}><div class="price-modal-body" data-v-99495e5c${_scopeId}><p class="price-modal-info" data-v-99495e5c${_scopeId}>Текущее предложение: ${ssrInterpolate(priceChangeModal.value.message?.proposed_price)} ₽</p><label for="new-price-change" data-v-99495e5c${_scopeId}>Новая цена (₽):</label><input id="new-price-change"${ssrRenderAttr("value", priceChangeModal.value.newPrice)} type="number" min="0" max="9999999999" placeholder="Введите сумму" required data-v-99495e5c${_scopeId}></div><div class="price-modal-footer" data-v-99495e5c${_scopeId}><button type="button" class="cancel-btn" data-v-99495e5c${_scopeId}>Отмена</button><button type="submit" class="submit-btn" data-v-99495e5c${_scopeId}>Предложить</button></div></form></div></div>`);
						else _push(`<!---->`);
						if (openDisputeModal.value) _push(`<div class="modal-overlay" style="${ssrRenderStyle({ "display": "flex" })}" data-v-99495e5c${_scopeId}><div class="price-modal" data-v-99495e5c${_scopeId}><div class="price-modal-header" data-v-99495e5c${_scopeId}><h3 data-v-99495e5c${_scopeId}>Открыть спор</h3><button type="button" class="modal-close" data-v-99495e5c${_scopeId}><img src="/images/close.svg" alt="Закрыть" data-v-99495e5c${_scopeId}></button></div><form data-v-99495e5c${_scopeId}><div class="price-modal-body" data-v-99495e5c${_scopeId}><label for="dispute-reason" data-v-99495e5c${_scopeId}>Причина спора:</label><textarea id="dispute-reason" rows="5" minlength="10" maxlength="5000" placeholder="Опишите причину спора (минимум 10 символов)" required data-v-99495e5c${_scopeId}>${ssrInterpolate(disputeForm.value.reason)}</textarea></div><div class="price-modal-footer" data-v-99495e5c${_scopeId}><button type="button" class="cancel-btn" data-v-99495e5c${_scopeId}>Отмена</button><button type="submit" class="submit-btn" data-v-99495e5c${_scopeId}>Отправить</button></div></form></div></div>`);
						else _push(`<!---->`);
						if (openCancelModal.value) _push(`<div class="modal-overlay" style="${ssrRenderStyle({ "display": "flex" })}" data-v-99495e5c${_scopeId}><div class="price-modal" data-v-99495e5c${_scopeId}><div class="price-modal-header" data-v-99495e5c${_scopeId}><h3 data-v-99495e5c${_scopeId}>Отмена сделки</h3><button type="button" class="modal-close" data-v-99495e5c${_scopeId}><img src="/images/close.svg" alt="Закрыть" data-v-99495e5c${_scopeId}></button></div><form data-v-99495e5c${_scopeId}><div class="price-modal-body" data-v-99495e5c${_scopeId}><label for="cancel-reason" data-v-99495e5c${_scopeId}>Причина отмены:</label><textarea id="cancel-reason" rows="5" minlength="5" maxlength="5000" placeholder="Опишите причину отмены (минимум 5 символов)" required data-v-99495e5c${_scopeId}>${ssrInterpolate(cancelForm.value.reason)}</textarea></div><div class="price-modal-footer" data-v-99495e5c${_scopeId}><button type="button" class="cancel-btn" data-v-99495e5c${_scopeId}>Назад</button><button type="submit" class="reject-btn" data-v-99495e5c${_scopeId}>Подтвердить отмену</button></div></form></div></div>`);
						else _push(`<!---->`);
					} else return [
...
var Chats_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$15, [["__scopeId", "data-v-99495e5c"]]);
//#endregion
